...
dotnet add package couchbase.lite.enterprise -v $cbl_version-b$(printf "%04f" $cbl_build)
dotnet add package couchbase.lite.VectorSearch -v $vs_version-b$(printf "%04f" $vs_build)
dotnet restore
