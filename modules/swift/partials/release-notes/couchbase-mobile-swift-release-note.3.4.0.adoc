...
* https://jira.issues.couchbase.com/browse/CBL-8395[CBL-8395 -- Default conflict resolution does not compare revision IDs when two revisions have the same generation]
...
* https://jira.issues.couchbase.com/browse/CBL-8575[CBL-8575 -- MultipeerReplicator peer-info methods may block when using Bluetooth]
