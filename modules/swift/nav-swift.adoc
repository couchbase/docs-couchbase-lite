...
.xref:swift:quickstart.adoc[Swift]
  ...
  * Queries
    ...
    ** xref:swift:query-n1ql-mobile.adoc[N1QL for Mobile]
    ** xref:swift:query-n1ql-mobile-server-diffs.adoc[N1QL Server Differences]
    ** xref:swift:query-n1ql-mobile-querybuilder-diffs.adoc[N1QL Querybuilder Differences]
  ...
  * https://docs.couchbase.com/mobile/{major}.{minor}.{base}-{releasetag}/couchbase-lite-swift-ee/index.html[API{nbsp}References]
