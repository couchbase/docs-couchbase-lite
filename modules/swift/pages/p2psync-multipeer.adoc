...
TIP: You can also configure these settings through Xcode's Info configuration UI under "*Bonjour Services*" and "*Privacy – Local Network Usage Description*."


=== Supported Platforms

We recommend using a recent release of iOS, see xref:swift:supported-os.adoc[Supported Platforms] for details.
...
You can also enable Bluetooth Low Energy (BLE) as an additional transport.
...
// transports defaults to [.wifi] — no change needed
----
