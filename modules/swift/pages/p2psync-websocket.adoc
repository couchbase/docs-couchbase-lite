...
Here you can see configuration involves a xref:swift:p2psync-websocket-using-passive.adoc[Passive Peer] and an xref:swift:p2psync-websocket-using-active.adoc[Active Peer] and a user-friendly Listener configuration in <<simple-configuration>>.
...
[IMPORTANT]
====
`channels` is a Sync Gateway construct and is not supported in Peer-to-Peer or Database-to-Database replication.
If your Sync Gateway Access Control and Data Validation Function assigns documents to channels, that channel information has no effect when replicating directly between two Couchbase Lite databases.
====
...
The Listener automatically selects a port to use or a user-specified port.
It also listens on all available networks, unless you specify a specific network.
...
When a Listener is stopped, then all connected replicators are notified by a WebSocket error.
Your application should distinguish between transient and permanent connectivity errors.

[#passive-peers]
==== Passive peers
A Passive Peer losing connectivity with an Active Peer cleans up any associated endpoint connections to that Peer.
...
[source, swift]
----
include::swift:example$code_snippets/SampleCodeTest.swift[tags="listener-simple", indent=0]
----
...
[source, swift]
----
include::swift:example$code_snippets/SampleCodeTest.swift[tags="replicator-simple", indent=0]
----
...
API Reference: https://docs.couchbase.com/mobile/{major}.{minor}.{maintenance-swift}{empty}/couchbase-lite-swift/Classes/URLEndpointListener.html[URLEndpointListener]
...
API Reference:  https://docs.couchbase.com/mobile/{major}.{minor}.{maintenance-swift}{empty}/couchbase-lite-swift/Structs/URLEndpointListenerConfiguration.html#/s:18CouchbaseLiteSwift32URLEndpointListenerConfigurationC10disableTLSSbvp[disableTLS]
--
...
--
// tag::config-tls-id[]
Use https://docs.couchbase.com/mobile/{major}.{minor}.{maintenance-swift}{empty}/couchbase-lite-swift/Structs/URLEndpointListenerConfiguration.html[URLEndpointListenerConfiguration]'s
https://docs.couchbase.com/mobile/{major}.{minor}.{maintenance-swift}{empty}/couchbase-lite-swift/Structs/URLEndpointListenerConfiguration.html#/s:18CouchbaseLiteSwift32URLEndpointListenerConfigurationC11tlsIdentityAA11TLSIdentityCSgvp[tlsIdentity] method to configure the TLS Identity used in TLS communication.
...
API Reference:  https://docs.couchbase.com/mobile/{major}.{minor}.{maintenance-swift}{empty}/couchbase-lite-swift/Structs/URLEndpointListenerConfiguration.html#/s:18CouchbaseLiteSwift32URLEndpointListenerConfigurationC11tlsIdentityAA11TLSIdentityCSgvp[tlsIdentity]
...
API Reference:  https://docs.couchbase.com/mobile/{major}.{minor}.{maintenance-swift}{empty}/couchbase-lite-swift/Structs/URLEndpointListenerConfiguration.html#/s:18CouchbaseLiteSwift32URLEndpointListenerConfigurationC13authenticatorAA0E13Authenticator_pSgvp[authenticator]
--
...
API Reference: https://docs.couchbase.com/mobile/{major}.{minor}.{maintenance-swift}{empty}/couchbase-lite-swift/Structs/URLEndpointListenerConfiguration.html[URLEndpointListenerConfiguration]
--
...
* Android KeyStore security has evolved over time to provide more secure support.
Please check this document for more info: https://source.android.com/security/keystore[Hardware-backed Keystore].

|Reference
|https://developer.android.com/training/articles/keystore[Android Keystore system]
// end::android[]
|===
--
...
|Reference
|https://docs.oracle.com/javase/7/docs/api/java/security/KeyStore.html[Class KeyStore]
// end::jvm[]
|===
--
...
* X509Store Reference: https://docs.microsoft.com/en-us/dotnet/api/system.security.cryptography.x509certificates.x509store?view=netcore-3.1[X509Store Class]
...
|Reference
a|* RSACryptoServiceProvider: https://docs.microsoft.com/en-us/dotnet/standard/security/how-to-store-asymmetric-keys-in-a-key-container[Store asymmetric keys in a key container]
* X509Store Reference -- https://docs.microsoft.com/en-us/dotnet/api/system.security.cryptography.x509certificates.x509store?view=netcore-3.1[X509Store Class]
// end::Xamarin[]
// end::net[]
