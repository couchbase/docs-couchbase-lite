...
[discrete#swift:p2psync-websocket:::introduction]
=== Introduction
...
[discrete#swift:p2psync-websocket:::overview]
=== Overview
...
Here you can see configuration involves a xref:swift:p2psync-websocket-using-passive.adoc[Passive Peer] and an xref:swift:p2psync-websocket-using-active.adoc[Active Peer] and a user-friendly Listener configuration in <<swift:p2psync-websocket:::simple-configuration>>
...
[discrete#swift:p2psync-websocket:::features]
=== Features
...
[discrete#swift:p2psync-websocket:::security]
==== Security
...
[discrete#swift:p2psync-websocket:::error-handling]
==== Error Handling
...
[discrete#swift:p2psync-websocket:::passive-peers]
===== Passive peers
...
[discrete#swift:p2psync-websocket:::active-peers]
===== Active peers
...
[discrete#swift:p2psync-websocket:::delta-sync]
==== Delta Sync
...
[discrete#swift:p2psync-websocket:::conflict-resolution]
==== Conflict Resolution
...
[discrete#swift:p2psync-websocket:::constraints]
=== Constraints
* Requires at least iOS 10 (dependency on keychains)


[discrete#swift:p2psync-websocket:::simple-configuration]
=== Basic Setup
You can configure a Peer-to-Peer synchronization with just a short amount of code as shown here in <<swift:p2psync-websocket:::ex-simple-listener>> and <<swift:p2psync-websocket:::ex-simple-replicator>>.

.Simple Listener
[#ex-simple-listener]


[#swift:p2psync-websocket:::ex-simple-listener]
====
...
[#swift:p2psync-websocket:::ex-simple-replicator]
====
...
[discrete#swift:p2psync-websocket:::api-highlights]
=== API Highlights

[discrete#swift:p2psync-websocket:::urlendpointlistener]
==== URLEndpointListener
...
API Reference: https://docs.couchbase.com/mobile/{version-maintenance-ios}/couchbase-lite-swift/Classes/URLEndpointListener.html[URLEndpointListener]

[discrete#swift:p2psync-websocket:::urlendpointlistenerconfiguration]
...
API Reference:  https://docs.couchbase.com/mobile/{version-maintenance-ios}/couchbase-lite-swift/Structs/URLEndpointListenerConfiguration.html#/s:18CouchbaseLiteSwift32URLEndpointListenerConfigurationC10disableTLSSbvp[disableTLS]
--
...
--
// tag::config-tls-id[]
Use https://docs.couchbase.com/mobile/{version-maintenance-ios}/couchbase-lite-swift/Structs/URLEndpointListenerConfiguration.html[URLEndpointListenerConfiguration]'s
https://docs.couchbase.com/mobile/{version-maintenance-ios}/couchbase-lite-swift/Structs/URLEndpointListenerConfiguration.html#/s:18CouchbaseLiteSwift32URLEndpointListenerConfigurationC11tlsIdentityAA11TLSIdentityCSgvp[tlsIdentity] method to configure the TLS Identity used in TLS communication.
...
API Reference:  https://docs.couchbase.com/mobile/{version-maintenance-ios}/couchbase-lite-swift/Structs/URLEndpointListenerConfiguration.html#/s:18CouchbaseLiteSwift32URLEndpointListenerConfigurationC11tlsIdentityAA11TLSIdentityCSgvp[tlsIdentity]
...
API Reference:  https://docs.couchbase.com/mobile/{version-maintenance-ios}/couchbase-lite-swift/Structs/URLEndpointListenerConfiguration.html#/s:18CouchbaseLiteSwift32URLEndpointListenerConfigurationC13authenticatorAA0E13Authenticator_pSgvp[authenticator]
--
...
API Reference: https://docs.couchbase.com/mobile/{version-maintenance-ios}/couchbase-lite-swift/Structs/URLEndpointListenerConfiguration.html[URLEndpointListenerConfiguration]
--

[discrete#swift:p2psync-websocket:::security-2]
=== Security

[discrete#swift:p2psync-websocket:::authentication]
==== Authentication

Peer-to-Peer sync supports <<swift:p2psync-websocket:::using-basic-authentication,Basic Authentication>> and <<swift:p2psync-websocket:::using-tls,TLS Authentication>>.
...
[discrete#swift:p2psync-websocket:::using-secure-storage]
...
<<swift:p2psync-websocket:::secure-storage-details>> summarizes the secure storage used to store keys and certificates for Swift.

.Secure storage details
[#swift:p2psync-websocket:::secure-storage-details,cols="1,4"]
|===
...
[discrete#swift:p2psync-websocket:::related-content]
=== Related Content
++++
...
[discrete.colum#swift:p2psync-websocket:::-2n]
==== {empty}
.Concepts
...
[discrete.colum#swift:p2psync-websocket:::-3n]
==== {empty}
.Community Resources ...
