...
To get started coding Couchbase Lite for Swift apps, create or open an existing _Xcode_ project, and install the required _Couchbase Lite_ version ({version-maintenance} for example), using one of the <<lbl-install-tabs>> methods shown.
