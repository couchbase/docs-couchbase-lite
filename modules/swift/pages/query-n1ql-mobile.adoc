...
[#swift:query-n1ql-mobile:::introduction]
== Introduction
...
[#swift:query-n1ql-mobile:::running]
== Running
...
[#swift:query-n1ql-mobile:::query-format]
== Query Format
...
| <<swift:query-n1ql-mobile:::lbl-unnest>>
...
[#swift:query-n1ql-mobile:::arguments]
=== Arguments
...
[#swift:query-n1ql-mobile:::select-wildcard]
==== Select Wildcard
...
[#swift:query-n1ql-mobile:::example]
=== Example
...
[#swift:query-n1ql-mobile:::datasource]
=== Datasource
...
[#swift:query-n1ql-mobile:::arguments-2]
=== Arguments
...
[#swift:query-n1ql-mobile:::example-2]
=== Example
...
[#swift:query-n1ql-mobile:::purpose-3]
=== Purpose
...
[#swift:query-n1ql-mobile:::syntax-3]
=== Syntax
...
[#swift:query-n1ql-mobile:::arguments-3]
=== Arguments
...
[#swift:query-n1ql-mobile:::example-3]
=== Example
...
[#swift:query-n1ql-mobile:::purpose-4]
=== Purpose
...
You can also use a new type of index, the xref:swift:indexing.adoc#array-indexing[Array Index], to allow querying with `UNNEST` more efficiently.

NOTE: Couchbase Lite currently supports inner `UNNEST` only.

[#swift:query-n1ql-mobile:::syntax-4]
=== Syntax
...
[#swift:query-n1ql-mobile:::examples]
=== Examples

For examples of using Array Indexes in conjunction with `UNNEST`, see xref:swift:indexing.adoc#array-indexing[Array Index].

We are also accessing the current database using the shorthand notation *`_`* -- see the <<swift:query-n1ql-mobile:::lbl-from>> clause for more on data source selection and <<swift:query-n1ql-mobile:::lbl-query-params>> for more on parameterized queries.
...
[#swift:query-n1ql-mobile:::purpose-5]
=== Purpose
...
[#swift:query-n1ql-mobile:::syntax-5]
=== Syntax
...
[#swift:query-n1ql-mobile:::arguments-4]
=== Arguments
...
[#swift:query-n1ql-mobile:::examples-2]
=== Examples
...
[#swift:query-n1ql-mobile:::arguments-5]
=== Arguments
...
[#swift:query-n1ql-mobile:::examples-3]
=== Examples
...
[#swift:query-n1ql-mobile:::purpose-7]
=== Purpose
Sort query results based on a given expression result.

[#swift:query-n1ql-mobile:::syntax-7]
=== Syntax
...
[#swift:query-n1ql-mobile:::arguments-6]
=== Arguments
...
[#swift:query-n1ql-mobile:::examples-4]
=== Examples
...
[#swift:query-n1ql-mobile:::purpose-9]
=== Purpose
Specifies the number of results to be skipped by the query.

[#swift:query-n1ql-mobile:::syntax-9]
=== Syntax
...
[#swift:query-n1ql-mobile:::arguments-8]
=== Arguments
...
[#swift:query-n1ql-mobile:::examples-6]
=== Examples
...
[#swift:query-n1ql-mobile:::lbl-literals]
== Expressions
In this section::
...
[#swift:query-n1ql-mobile:::lbl-exp-literals]
=== Literals
...
[#swift:query-n1ql-mobile:::lbl-lit-bool]
==== Boolean

[#swift:query-n1ql-mobile:::purpose-10]
==== Purpose
Represents a true or false value.

[#swift:query-n1ql-mobile:::syntax-10]
==== Syntax

`TRUE | FALSE`

[#swift:query-n1ql-mobile:::example-4]
==== Example
...
[#swift:query-n1ql-mobile:::lbl-lit-numbers]
==== Numeric

[#swift:query-n1ql-mobile:::purpose-11]
==== Purpose
Represents a numeric value.
Numbers may be signed or unsigned digits.
They have optional fractional and exponent components.

[#swift:query-n1ql-mobile:::syntax-11]
==== Syntax
...
[#swift:query-n1ql-mobile:::example-5]
==== Example
...
[#swift:query-n1ql-mobile:::lbl-lit-string]
==== String

[#swift:query-n1ql-mobile:::purpose-12]
==== Purpose
The string literal represents a string or sequence of characters.


[#swift:query-n1ql-mobile:::syntax-12]
==== Syntax
...
[#swift:query-n1ql-mobile:::example-6]
==== Example
[source,sql]
----
...
[#swift:query-n1ql-mobile:::lbl-lit-null]
==== NULL

[#swift:query-n1ql-mobile:::purpose-13]
==== Purpose
The literal NULL represents an empty value.

[#swift:query-n1ql-mobile:::syntax-13]
==== Syntax
...
[#swift:query-n1ql-mobile:::example-7]
==== Example
[source,sql]
----
...
[#swift:query-n1ql-mobile:::lbl-lit-missing]
==== MISSING

[#swift:query-n1ql-mobile:::purpose-14]
==== Purpose
The MISSING literal represents a missing name-value pair in a document.

[#swift:query-n1ql-mobile:::syntax-14]
==== Syntax
...
[#swift:query-n1ql-mobile:::example-8]
==== Example
[source,sql]
----
...
[#swift:query-n1ql-mobile:::lbl-lit-array]
==== Array

[#swift:query-n1ql-mobile:::purpose-15]
==== Purpose
Represents an Array

[#swift:query-n1ql-mobile:::syntax-15]
==== Syntax
...
[#swift:query-n1ql-mobile:::example-9]
==== Example
[source,sql]
----
SELECT [“a”, “b”, “c”] FROM _
...
[#swift:query-n1ql-mobile:::lbl-lit-dict]
==== Dictionary

[#swift:query-n1ql-mobile:::purpose-16]
==== Purpose
Represents a dictionary literal

[#swift:query-n1ql-mobile:::syntax-16]
==== Syntax
...
[#swift:query-n1ql-mobile:::example-10]
==== Example
[source,sql]
----
...
[#swift:query-n1ql-mobile:::lbl-exp-ident]
=== Identifiers

[#swift:query-n1ql-mobile:::purpose-17]
==== Purpose
...
[#swift:query-n1ql-mobile:::syntax-17]
==== Syntax
...
[#swift:query-n1ql-mobile:::example-11]
==== Example
...
[#swift:query-n1ql-mobile:::lbl-exp-prop]
=== Property Expressions

[#swift:query-n1ql-mobile:::purpose-18]
==== Purpose
The property expression is used to reference a property in a document

[#swift:query-n1ql-mobile:::syntax-18]
==== Syntax
...
[#swift:query-n1ql-mobile:::example-12]
==== Example
...
[#swift:query-n1ql-mobile:::lbl-exp-any]
=== Any and Every Expressions

[#swift:query-n1ql-mobile:::purpose-19]
==== Purpose
Evaluates expressions over items in an array object.


[#swift:query-n1ql-mobile:::syntax-19]
==== Syntax
...
[#swift:query-n1ql-mobile:::example-13]
==== Example
...
[#swift:query-n1ql-mobile:::lbl-exp-param]
=== Parameter Expressions

[#swift:query-n1ql-mobile:::purpose-20]
==== Purpose
...
[#swift:query-n1ql-mobile:::syntax-20]
==== Syntax
...
[#swift:query-n1ql-mobile:::examples-7]
==== Examples
...
[#swift:query-n1ql-mobile:::lbl-operators]
== Operators
In this section::
...
[#swift:query-n1ql-mobile:::lbl-ops-binary]
=== Binary Operators
...
[#swift:query-n1ql-mobile:::lbl-ops-maths]
==== Maths
...
[#swift:query-n1ql-mobile:::lbl-comp-ops]
==== Comparison Operators

[#swift:query-n1ql-mobile:::purpose-22]
==== Purpose
The _comparison operators_ are used in the WHERE statement to specify the condition on which to match documents.

.Comparison Operators
[#tbl-ops-comp]
[ops-comp#swift:query-n1ql-mobile:::tbl-ops-comp, cols="^1m,2,2m", options="header"]
|===
...
[#tbl-ops-isnot]
[ops-comp#swift:query-n1ql-mobile:::tbl-ops-isnot, cols="^1,^1,^1,^1", options="header"]
|===
...
[#swift:query-n1ql-mobile:::lbl-ops-logical]
==== Logical Operators

[#swift:query-n1ql-mobile:::purpose-23]
==== Purpose
...
.Logical Operators
[#tbl-ops-logical]
[ops-comp#swift:query-n1ql-mobile:::tbl-ops-logical, cols="^1m,2,2m", options="header"]
|===
...
[#swift:query-n1ql-mobile:::purpose-24]
==== Purpose
...
[#swift:query-n1ql-mobile:::lbl-ops-unary]
=== Unary Operators

[#swift:query-n1ql-mobile:::purpose-25]
==== Purpose
...
[#swift:query-n1ql-mobile:::syntax-21]
==== Syntax
...
[#swift:query-n1ql-mobile:::lbl-ops-coll]
=== COLLATE Operators

[#swift:query-n1ql-mobile:::purpose-26]
==== Purpose
Collate operators specify how the string comparison is conducted.

[#swift:query-n1ql-mobile:::usage]
==== Usage
...
[#swift:query-n1ql-mobile:::syntax-22]
==== Syntax
...
[#swift:query-n1ql-mobile:::arguments-9]
==== Arguments
...
[#swift:query-n1ql-mobile:::example-15]
==== Example
...
[#swift:query-n1ql-mobile:::example-16]
==== Example
...
[#swift:query-n1ql-mobile:::lbl-functions]
== Functions
In this section::
...
[#swift:query-n1ql-mobile:::purpose-28]
=== Purpose

Functions are also expressions.

[#swift:query-n1ql-mobile:::syntax-24]
=== Syntax
...
[#swift:query-n1ql-mobile:::lbl-func-agg]
...
[#swift:query-n1ql-mobile:::lbl-func-array]
=== Array Functions
...
[#swift:query-n1ql-mobile:::lbl-func-cond]
...
[#swift:query-n1ql-mobile:::lbl-func-date]
...
[#swift:query-n1ql-mobile:::lbl-func-fts]
...
[#swift:query-n1ql-mobile:::lbl-func-maths]
=== Maths Functions
...
[#swift:query-n1ql-mobile:::lbl-func-meta]
=== Metadata Functions
...
[#swift:query-n1ql-mobile:::lbl-func-pattern]
...
[#swift:query-n1ql-mobile:::lbl-func-string]
=== String Functions
...
[#swift:query-n1ql-mobile:::lbl-func-typecheck]
...
[#swift:query-n1ql-mobile:::querybuilder-differences]
...
[#swift:query-n1ql-mobile:::lbl-query-params]
== Query Parameters
...
[#swift:query-n1ql-mobile:::related-content]
== Related Content
++++
...
[.column#swift:query-n1ql-mobile:::-2]
====== {empty}
.Learn more . . .
...
[.column#swift:query-n1ql-mobile:::-3]
====== {empty}
.Dive Deeper . . .
