= Remote Database Sync using Sync Gateway
:page-layout: article
:description: Couchbase Lite Database Sync -- Synchronizing data changes between local and remote datbases using Sync Gateway
