...
[#swift:working-with-vector-search:::use-vector-search]
==== Use Vector Search
...
[#swift:working-with-vector-search:::create-a-vector-index]
...
[#swift:working-with-vector-search:::vector-index-configuration]
...
[#swift:working-with-vector-search:::generating-vectors]
==== Generating Vectors
...
[#swift:working-with-vector-search:::create-a-vector-index-with-embeddings]
...
[#swift:working-with-vector-search:::create-vector-index-embeddings-from-a-predictive-model]
...
[#swift:working-with-vector-search:::create-a-lazy-vector-index]
...
[#swift:working-with-vector-search:::updating-the-lazy-index]
...
[#swift:working-with-vector-search:::vector-search-sql-support]
...
[#swift:working-with-vector-search:::use-hybrid-vector-search]
...
[#swift:working-with-vector-search:::hybrid-vector-search-with-full-text-match]
...
[#swift:working-with-vector-search:::prediction-with-hybrid-vector-search]
...
[#swift:working-with-vector-search:::approx_vector_distancevector-expr-target-vector-metric-nprobes-accurate]
...
[#swift:working-with-vector-search:::use-approx_vector_distance]
...
[#swift:working-with-vector-search:::prediction-with-approx_vector_distance]
...
[#swift:working-with-vector-search:::see-also]
==== See Also
