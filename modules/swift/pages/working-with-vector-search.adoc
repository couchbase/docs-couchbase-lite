...
include::swift:example$code_snippets/VectorSearch.swift[tags=vs-create-custom-config]
...
include::swift:example$code_snippets/VectorSearch.swift[tags=vs-create-index]
...
include::swift:example$code_snippets/VectorSearch.swift[tags=vs-create-predictive-index]
...
include::swift:example$code_snippets/VectorSearch.swift[tags=vs-lazy-index-config]
...
include::swift:example$code_snippets/VectorSearch.swift[tags=vs-create-lazy-index-embedding]
...
IMPORTANT: Similar to the xref:swift:fts.adoc[Full Text Search] `match()` function, the `APPROX_VECTOR_DISTANCE()` function and Hybrid Vector Search cannot use the `OR` expression with the other expressions in the related `WHERE` clause.
...
include::swift:example$code_snippets/VectorSearch.swift[tags=vs-hybrid-ftmatch]
...
include::swift:example$code_snippets/VectorSearch.swift[tags=vs-hybrid-prediction]
...
include::swift:example$code_snippets/VectorSearch.swift[tags=vs-apvd-where]
...
include::swift:example$code_snippets/VectorSearch.swift[tags=vs-apvd-prediction]
