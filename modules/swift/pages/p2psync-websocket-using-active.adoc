...
[{tabs}]
======
[#swift:p2psync-websocket-using-active:::tabs-1-ca-cert]
CA Cert::
+
--
...
[#swift:p2psync-websocket-using-active:::tabs-1-self-signed-cert]
Self Signed Cert::
+
--
...
[#swift:p2psync-websocket-using-active:::tabs-1-pinned-certificate]
Pinned Certificate::
+
--
...
[{tabs}]
======
[#swift:p2psync-websocket-using-active:::tabs-2-adding-a-change-listener]
...
--
+
[#swift:p2psync-websocket-using-active:::tabs-2-using-replicator-status]
...
[{tabs}]
=====
[#swift:p2psync-websocket-using-active:::tabs-3-local-wins]
Local Wins::
+
--
...
[#swift:p2psync-websocket-using-active:::tabs-3-remote-wins]
Remote Wins::
+
--
...
[#swift:p2psync-websocket-using-active:::tabs-3-merge]
Merge::
+
--
...
[.column]
// [.content]
[discrete#swift:p2psync-websocket-using-active:::-3]
====== {empty}
.Community Resources ...
//* Community
