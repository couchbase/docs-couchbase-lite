...
====
xref:p2psync-multipeer.adoc[Multipeer P2P Replicator] is available for Android, offering:
...
----
// include::swift:example$code_snippets/SampleCodeTest.swift[tag=p2p-act-rep-config-cacert-pinned-callouts, indent=0]
--
...
[source, swift]
----
include::swift:example$code_snippets/SampleCodeTest.swift[tags=p2p-act-rep-add-change-listener;!p2p-act-rep-add-change-listener-label,indent=0]
----
--
+
...
[source, swift]
----
include::swift:example$code_snippets/SampleCodeTest.swift[tags=p2p-act-rep-status,indent=0]
----
--
======
