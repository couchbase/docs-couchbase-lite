...
[#swift:p2psync-websocket-using-active:::introduction]
== Introduction
...
[#swift:p2psync-websocket-using-active:::configuration-summary]
...
[#swift:p2psync-websocket-using-active:::api-references]
== API References
...
[#swift:p2psync-websocket-using-active:::device-discovery]
== Device Discovery
...
[#swift:p2psync-websocket-using-active:::configure-replicator]
...
[#swift:p2psync-websocket-using-active:::certificate-authentication]
...
[#swift:p2psync-websocket-using-active:::initialize-replicator]
...
[#swift:p2psync-websocket-using-active:::lbl-repl-mon]
== Monitor Sync
...
[#swift:p2psync-websocket-using-active:::lbl-repl-states]
=== Replication States
...
[#swift:p2psync-websocket-using-active:::replication-status-and-app-life-cycle]
...
[#swift:p2psync-websocket-using-active:::lbl-repl-stop]
== Stop Sync
...
[#swift:p2psync-websocket-using-active:::conflict-resolution]
== Conflict Resolution
...
[#swift:p2psync-websocket-using-active:::delta-sync]
== Delta Sync
If delta sync is enabled on the listener, then replication will use delta sync.


[#swift:p2psync-websocket-using-active:::related-content]
== Related Content
++++
...
[.column#swift:p2psync-websocket-using-active:::-2]
=== {empty}
.Concepts
...
[.column#swift:p2psync-websocket-using-active:::-3]
=== {empty}
.Community Resources ...
