...
[#swift:troubleshooting-queries:::query-explain]
== Query Explain


[#swift:troubleshooting-queries:::using]
=== Using
...
[#swift:troubleshooting-queries:::output]
=== Output
...
[#swift:troubleshooting-queries:::the-query-plan]
== The Query Plan


[#swift:troubleshooting-queries:::format]
=== Format
...
[#swift:troubleshooting-queries:::ret-method]
=== Retrieval Method
...
[#swift:troubleshooting-queries:::order-group]
=== Order and Group
...
[#swift:troubleshooting-queries:::queries-and-indexes]
== Queries and Indexes
...
[#swift:troubleshooting-queries:::working-with-the-query-optimizer]
...
[#swift:troubleshooting-queries:::use-like-based-queries]
...
[source#swift:troubleshooting-queries:::like-wild-pfx-qry, swift]
----
let query = QueryBuilder
    .select(SelectResult.all())
    .from(DataSource.collection(collection))
...
[#swift:troubleshooting-queries:::use-functions-wisely]
...
[source#swift:troubleshooting-queries:::use-like-based-queries, swift]
----
let query = QueryBuilder
    .select(SelectResult.all())
    .from(DataSource.collection(collection))
...
[#swift:troubleshooting-queries:::optimization-considerations]
...
[#swift:troubleshooting-queries:::related-content]
== Related Content
++++
...
[.column#swift:troubleshooting-queries:::-2]
====== {empty}
.Learn more . . .
...
[.column#swift:troubleshooting-queries:::-3]
====== {empty}
.Dive Deeper . . .
