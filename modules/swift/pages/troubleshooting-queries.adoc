...
==== Output
The output from `https://docs.couchbase.com/mobile/{version-maintenance-ios}/couchbase-lite-swift/Classes/Query.html#/s:18CouchbaseLiteSwift5QueryC7explainSSyKF[explain()]` remains the same whether invoked by an app, or `cblite` -- see <<swift:troubleshooting-queries:::qe-output>> for an example of how it looks.
