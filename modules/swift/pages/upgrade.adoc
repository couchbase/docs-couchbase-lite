...
[#swift:upgrade:::api-changes]
=== API Changes

[#swift:upgrade:::removed-apis]
==== Removed APIs

[#swift:upgrade:::resetcheckpoint]
===== ResetCheckpoint
...
[#swift:upgrade:::database-setloglevel]
...
[#swift:upgrade:::database-compact]
===== Database.compact
.Alternative
...
[#swift:upgrade:::isnullormissing-and-notnullormissing]
...
[#swift:upgrade:::updated-api]
==== Updated API

[#swift:upgrade:::configuration]
===== Configuration
...
[#swift:upgrade:::encrypted-databases]
=== Encrypted Databases
...
[#swift:upgrade:::handling-of-existing-conflicts]
...
[#swift:upgrade:::handling-of-existing-attachments]
...
[#swift:upgrade:::replication-compatibility]
...
[#swift:upgrade:::downgrading-couchbase-lite]
== Downgrading Couchbase Lite

[#swift:upgrade:::downgrading-between-major-releases]
...
[#swift:upgrade:::downgrading-between-minor-releases]
...
[#swift:upgrade:::downgrading-between-patch-releases]
