...
== Index
[.pane__frame--blue]
xref:swift:refer-glossary.adoc#a[]  |  xref:B>>  |  <<swift:refer-glossary.adoc#c[]  |  xref:swift:refer-glossary.adoc#d[]  |  xref:E>>  |  <<F>>  |  <<G>>  |  <<H>>  |  <<swift:refer-glossary.adoc#i[]  |  xref:J>>  |  <<K>>  |  <<swift:refer-glossary.adoc#l[]  |  xref:M>>  |  <<swift:refer-glossary.adoc#n[]  |  xref:O>>  |  <<swift:refer-glossary.adoc#p[]  |  xref:Q>>  |  <<swift:refer-glossary.adoc#r[]  |  xref:swift:refer-glossary.adoc#s[]  |  xref:swift:refer-glossary.adoc#t[]  |  <<U>>  |  <<V>>  |  <<W>>  |  <<X>>  |  <<Y>>  |  <<Z>>
...
* _Related Term(s)_: xref:swift:refer-glossary.adoc#passive-peer[] xref:swift:refer-glossary.adoc#peer-to-peer-sync[]
* _Read More_: xref:swift:landing-p2psync.adoc[Peer-to-Peer Sync]
...
[[swift:refer-glossary:::checkpoint]]Checkpoint::
...
Back to xref:swift:refer-glossary.adoc#index[]
...
// tag::cbl-delta-sync[]
// tag::cbl-delta-sync-def[]
* _Related Term(s)_: xref:swift:refer-glossary.adoc#passive-replicator[Passive replicator]
* _Read More_: xref:swift:replication.adoc#delta-sync[Delta Sync]
// tag::cbl-delta-sync-full[]
...
* _Related Term(s)_: xref:swift:refer-glossary.adoc#active-peer[], xref:swift:refer-glossary.adoc#peer-to-peer-sync[]
* _Read More_: xref:swift:landing-p2psync.adoc[Peer-to-Peer Sync]
// end::cbl-passive-peer[]
...
* _Related Term(s)_: xref:swift:refer-glossary.adoc#active-peer[] xref:swift:refer-glossary.adoc#passive-peer[]
* _Read More_: xref:swift:landing-p2psync.adoc[Peer-to-Peer Sync]
...
* _Related Term(s)_: xref:swift:refer-glossary.adoc#active-peer[] xref:swift:refer-glossary.adoc#passive-peer[]
* _Read More_: xref:swift:p2psync-websocket.adoc[Peer-to-Peer]
