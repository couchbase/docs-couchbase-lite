...
. Replace the boiler-plate code with the code shown in xref:swift:gs-build.adoc#ex-starter-code[]
. Build and run the 'app' +
You should see -- xref:swift:gs-build.adoc#img-starter-code[] -- the document ID and property printed to the 'console log', indicating that a document was created successfully persisted to the database, updated and queried.
