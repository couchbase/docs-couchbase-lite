...
[#maint-latest]
[#swift:vs-releasenotes:::maint-3-2-0]
== 3.2.0 -- August 2024

Version 3.2.0 for Swift delivers the following features and enhancements:

[#swift:vs-releasenotes:::couchbase-lite-release-notes]
== Couchbase Lite Release Notes

[#swift:vs-releasenotes:::downgrade-support]
=== Downgrade Support

Downgrades from 3.2.x to any other version of Couchbase Lite are not supported.

[#swift:vs-releasenotes:::enhancements]
=== Enhancements
...
[#swift:vs-releasenotes:::issues-and-resolutions]
...
[#swift:vs-releasenotes:::known-issues]
=== Known Issues

None for this release

[#swift:vs-releasenotes:::deprecations]
=== Deprecations
...
[#swift:vs-releasenotes:::couchbase-lite-beta-1-release-notes]
== Couchbase Lite Beta 1 Release Notes

[#swift:vs-releasenotes:::enhancements-2]
=== Enhancements
...
[#swift:vs-releasenotes:::issues-and-resolutions-2]
=== Issues and Resolutions
...
[#swift:vs-releasenotes:::known-issues-2]
=== Known Issues

None for this release

[#swift:vs-releasenotes:::deprecations-2]
=== Deprecations
