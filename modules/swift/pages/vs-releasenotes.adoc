...
[#maint-latest]
[discrete#swift:vs-releasenotes:::maint-3-2-0]
=== 3.2.0 -- August 2024

Version 3.2.0 for Swift delivers the following features and enhancements:

[discrete#swift:vs-releasenotes:::couchbase-lite-release-notes]
=== Couchbase Lite Release Notes

[discrete#swift:vs-releasenotes:::enhancements]
==== Enhancements
...
[discrete#swift:vs-releasenotes:::issues-and-resolutions]
...
[discrete#swift:vs-releasenotes:::known-issues]
==== Known Issues

None for this release

[discrete#swift:vs-releasenotes:::deprecations]
==== Deprecations
...
[discrete#swift:vs-releasenotes:::couchbase-lite-beta-1-release-notes]
=== Couchbase Lite Beta 1 Release Notes

[discrete#swift:vs-releasenotes:::enhancements-2]
==== Enhancements
...
[discrete#swift:vs-releasenotes:::issues-and-resolutions-2]
==== Issues and Resolutions
...
[discrete#swift:vs-releasenotes:::known-issues-2]
==== Known Issues

None for this release

[discrete#swift:vs-releasenotes:::deprecations-2]
==== Deprecations
