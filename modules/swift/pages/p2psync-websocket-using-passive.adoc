...
[#swift:p2psync-websocket-using-passive:::introduction]
== Introduction
...
[#swift:p2psync-websocket-using-passive:::configuration-summary]
...
[#swift:p2psync-websocket-using-passive:::api-references]
== API References
...
[#swift:p2psync-websocket-using-passive:::device-discovery]
== Device Discovery
...
[#swift:p2psync-websocket-using-passive:::initialize-the-listener-configuration]
...
[#swift:p2psync-websocket-using-passive:::lbl-set-network-and-port]
== Set Port and Network Interface


[#swift:p2psync-websocket-using-passive:::port-number]
=== Port number
...
[#swift:p2psync-websocket-using-passive:::network-interface]
=== Network Interface
...
[#swift:p2psync-websocket-using-passive:::delta-sync]
== Delta Sync
...
[#swift:p2psync-websocket-using-passive:::lbl-tls-security]
== TLS Security


[#swift:p2psync-websocket-using-passive:::enable-or-disable-tls]
...
[#swift:p2psync-websocket-using-passive:::configure-tls-identity-for-listener]
...
[#swift:p2psync-websocket-using-passive:::lbl-authenticating-the-client]
...
[#swift:p2psync-websocket-using-passive:::use-basic-authentication]
...
[#swift:p2psync-websocket-using-passive:::using-client-certificate-authentication]
...
[#swift:p2psync-websocket-using-passive:::delete-tls-identity]
=== Delete Entry
...
[#swift:p2psync-websocket-using-passive:::the-impact-of-tls-settings]
...
[#swift:p2psync-websocket-using-passive:::monitor-listener]
== Monitor Listener
...
[#swift:p2psync-websocket-using-passive:::stop-listener]
== Stop Listener
...
[#swift:p2psync-websocket-using-passive:::related-content]
== Related Content
++++
...
[.column#swift:p2psync-websocket-using-passive:::-2]
=== {empty}
.Concepts
...
[.column#swift:p2psync-websocket-using-passive:::-3]
=== {empty}
.Community Resources ...
