...
[#swift:scopes-collections-manage:::default-scopes-and-collections]
...
[#swift:scopes-collections-manage:::create-a-scope-and-collection]
...
[#swift:scopes-collections-manage:::index-a-collection]
== Index a Collection
...
[#swift:scopes-collections-manage:::drop-a-collection]
== Drop a Collection
...
[#swift:scopes-collections-manage:::list-scopes-and-collections]
