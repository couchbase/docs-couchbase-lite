...
NOTE: You may encounter a `Target Integrity Error` when building for iOS Simulator -- see xref:{cbl-pg-prereqs}#lbl-tgtinterr[Dealing with Target Integrity Error]
