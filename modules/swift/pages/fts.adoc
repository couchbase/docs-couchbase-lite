...
[#swift:fts:::querybuilder]
=== QueryBuilder

[#swift:fts:::create-index-2]
==== Create Index
...
[#swift:fts:::pattern-matching-formats]
...
[#swift:fts:::overriding-the-property-name]
...
[#swift:fts:::and-or-not-query-operators]
