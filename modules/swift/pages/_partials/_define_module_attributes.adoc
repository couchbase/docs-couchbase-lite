...
:url-issues: https://github.com/couchbase/couchbase-lite--ios/issues
...
// API Reference Links
//
:url-api-references: {url-api-references-pfx}{major}.{minor}.{maintenance-ios}/couchbase-lite-swift
//
...
// :url-api-struct-databasecfg: {url-api-references-databasecfg}{sep}s:18CouchbaseLiteSwift21DatabaseConfiguration
:url-api-method-databasecfg: {url-api-references-databasecfg}{sep}s:18CouchbaseLiteSwift21DatabaseConfiguration[DatabaseConfiguration]
:url-api-method-databasecfg-setdir: {url-api-references-databasecfg}{sep}s:18CouchbaseLiteSwift21DatabaseConfigurationC9directorySSvp[DatabaseConfiguration.directory()]
:url-api-method-databasecfg-encryption: {url-api-references-databasecfg}{sep}s:18CouchbaseLiteSwift21DatabaseConfigurationV13encryptionKeyAA010EncryptionG0OSgvp[DatabaseConfiguration.encryptionKey()]
...
:url-api-method-query-explain: {url-api-classes-query-pfx}{sep}s:18CouchbaseLiteSwift5QueryC7explainSSyKF[explain()]
:url-api-method-query-execute: {url-api-classes-query-pfx}{sep}s:18CouchbaseLiteSwift5QueryC7executeAA9ResultSetCyKF[execute()]
...
:url-api-method-expression-like: {url-api-method-expression-pfx}{sep}s:18CouchbaseLiteSwift18ExpressionProtocolP4likeyAaB_pAaB_pF[like(_:)]
:url-api-method-expression-collate: {url-api-method-expression-pfx}{sep}s:18CouchbaseLiteSwift18ExpressionProtocolP7collateyAaB_pAA09CollationE0_pF[Collate()]
...
:url-api-method-function-lower: {url-api-classes-function-pfx}{sep}s:18CouchbaseLiteSwift8FunctionC5loweryAA18ExpressionProtocol_pAaE_pFZ[lower()]
:url-api-method-function-count: {url-api-classes-function-pfx}{sep}s:18CouchbaseLiteSwift8FunctionC5countyAA18ExpressionProtocol_pAaE_pFZ[count()]
...
// :url-api-properties-replicator-status-pfx: {url-api-references-replicator-status}{sep}s:18CouchbaseLiteSwift10ReplicatorC6Status

:url-api-properties-replicator-status: {url-api-references-replicator-status}{sep}s:18CouchbaseLiteSwift10ReplicatorC6Status[Status]
:url-api-enum-replicator-activity: {url-api-references-replicator-status}{sep}s:18CouchbaseLiteSwift10ReplicatorC6StatusV8activityAC13ActivityLevelOvp[Activity]
:url-api-enum-replicator-progress: {url-api-references-replicator-status}{sep}s:18CouchbaseLiteSwift10ReplicatorC6StatusV8progressAC8ProgressVvp[Progress]
:url-api-enum-replicator-error: {url-api-references-replicator-status}{sep}s:18CouchbaseLiteSwift10ReplicatorC6StatusV5errors5Error_pSgvp[Error]
...
:url-api-prop-replicator-config-autopurge: {url-api-references-replicator-config}{sep}s:18CouchbaseLiteSwift23ReplicatorConfigurationV15enableAutoPurgeSbvp[enableAutoPurge]

:url-api-prop-replicator-config-setPinnedServerCertificate: {url-api-references-replicator-config}{sep}s:18CouchbaseLiteSwift23ReplicatorConfigurationC23pinnedServerCertificateSo03SecH3RefaSgvp[setPinnedServerCertificate()]

// Begin Replicator Retry Config
:url-api-prop-replicator-config-setHeartbeat: {url-api-references-replicator-config}{sep}s:18CouchbaseLiteSwift23ReplicatorConfigurationC9heartbeatSdvp[heartbeat()]
:url-api-prop-replicator-config-getHeartbeat: {url-api-prop-replicator-config-setHeartbeat}
:url-api-prop-replicator-config-setMaxAttempts: {url-api-references-replicator-config}{sep}s:18CouchbaseLiteSwift23ReplicatorConfigurationC10maxAttemptsSivp[maxAttempts()]
:url-api-prop-replicator-config-getMaxAttempts: {url-api-prop-replicator-config-setMaxAttempts}
:url-api-prop-replicator-config-setMaxAttemptWaitTime: {url-api-references-replicator-config}{sep}s:18CouchbaseLiteSwift23ReplicatorConfigurationC16maxAttemptWaitTimeSdvp[maxAttemptWaitTime()]
...
:url-api-prop-replicator-config-network-interface: {url-api-references-replicator-config}{sep}s:18CouchbaseLiteSwift23ReplicatorConfigurationV16networkInterfaceSSSgvp[networkInterface]
...
// :url-api-class-collection-operators: {url-api-references-classes}{api-pfx}ArrayFunction.html[Collection operators]
// :url-api-class-arrayfunction: {url-api-references-classes}{api-pfx}ArrayFunction.html[ArrayFunction]
...
:url-api-class-log-prop-file: {url-api-references-class-log}{sep}s:18CouchbaseLiteSwift3LogC4fileAA10FileLoggerCvp[log.file]
:url-api-class-log-prop-custom: {url-api-references-class-log}{sep}s:18CouchbaseLiteSwift3LogC6customAA6Logger_pSgvp[log.custom]
...
:url-api-class-log-console-getcons: {url-api-references-class-log}{sep}s:18CouchbaseLiteSwift3LogC7consoleAA13ConsoleLoggerCvp[log.console]
:url-api-class-log-console-getcons-setlvl: {url-api-references-class-log-cons}{sep}s:18CouchbaseLiteSwift13ConsoleLoggerC5levelAA8LogLevelOvp[log.console.level]
:url-api-class-log-console-getcons-setdmn: {url-api-references-class-log-cons}{sep}s:18CouchbaseLiteSwift13ConsoleLoggerC7domainsAA10LogDomainsVvp[log.console.domains]
...
:url-api-class-log-custom-getcust: {url-api-references-class-log}{sep}s:18CouchbaseLiteSwift3LogC6customAA6Logger_pSgvp[log.custom]
:url-api-class-log-custom-setcust: {url-api-references-class-log}{sep}s:18CouchbaseLiteSwift3LogC6customAA6Logger_pSgvp[log.custom]
:url-api-class-log-custom-getcust-setlvl: {url-api-references-class-log-cust}{sep}s:18CouchbaseLiteSwift6LoggerP5levelAA8LogLevelOvp[log.custom.setLevel()]
:url-api-class-log-custom-getfile-logmsg: {url-api-references-class-log-cust}{sep}s:18CouchbaseLiteSwift6LoggerP3log5level6domain7messageyAA8LogLevelO_AA0I6DomainOSStF[log(level:,domain:, message:)]
...
:url-api-class-log-file-getfile: {url-api-references-class-log}{sep}s:18CouchbaseLiteSwift3LogC4fileAA10FileLoggerCvp[log.file]
:url-api-class-log-file-getfile-setcfg: {url-api-references-class-log-file}{sep}s:18CouchbaseLiteSwift10FileLoggerC6configAA03LogD13ConfigurationCSgvp[log.file.config: LogConfiguration(directory:)]
:url-api-class-log-file-getfile-setlvl: {url-api-references-class-log-file}{sep}s:18CouchbaseLiteSwift10FileLoggerC5levelAA8LogLevelOvp[log.file.level: LogLevel]

:url-api-class-log-file-getfile-logmsg: {url-api-references-class-log}{sep}s:18CouchbaseLiteSwift[log(level: LogLevel, domain: LogDomain, message: String)]
...
:url-api-class-log-config-props: {url-api-references-class-log-config}{sep}s:18CouchbaseLiteSwift
