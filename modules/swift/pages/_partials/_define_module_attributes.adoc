...
//
:version-maintenance: {version}.{maintenance-swift}{tag}
:version-maintenance-hyphenated: {major}-{minor}-{maintenance-swift}{tag}

// VECTOR SEARCH attributes
:vs-version-maintenance: {vs-version}.{vs-maintenance-swift}{tag}
:vs-version-maintenance-hyphenated: {vs-major}-{vs-minor}-{vs-maintenance-swift}{tag}
//
