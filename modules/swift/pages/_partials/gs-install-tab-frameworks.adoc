...
** Community -- https://packages.couchbase.com/releases/couchbase-lite-ios/3.0.0-beta01/couchbase-lite-swift_xc_community_3.0.0-beta01.zip[couchbase-lite-swift_xc_community_{this-release}.zip]

** Enterprise -- https://packages.couchbase.com/releases/couchbase-lite-ios/3.0.0-beta01/couchbase-lite-swift_xc_enterprise_3.0.0-beta01.zip[couchbase-lite-swift_xc_enterprise_3.0.0-beta01.zip]
