...
:url-ce-old: https://github.com/couchbase/couchbase-lite-ios.git
:url-ce-new: https://github.com/couchbase/couchbase-lite-swift.git
...
[IMPORTANT]
--
Couchbase Lite Community Edition Swift Package has been moved to a new repository in 4.0.
For previous versions, use: {url-ce-old}
--

<.> Insert appropriate Couchbase Lite URL: +
For Community Edition use: {url-ce-new} +
