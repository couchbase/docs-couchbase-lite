...
xref:swift:indexing.adoc#ex-create-index[] creates a new index for the `type` and `name` properties, shown in this data model:
...
For details, see xref:swift:fts.adoc[].
