...
[discrete#swift:prebuilt-database:::overview]
== Overview
...
[discrete#swift:prebuilt-database:::crt-db]
...
[discrete#swift:prebuilt-database:::bundle-db]
...
[discrete#swift:prebuilt-database:::database-encryption]
== Database Encryption
...
https://docs.couchbase.com/mobile/{version-maintenance-ios}/couchbase-lite-swift/Classes/Database.html#/s:18CouchbaseLiteSwift8DatabaseeC4copy8fromPath02toD010withConfigySS_SSAA0D13ConfigurationCSgtKFZ[Database.copy()]
...
. Use https://docs.couchbase.com/mobile/{version-maintenance-ios}/couchbase-lite-swift/Classes/Database.html#/s:18CouchbaseLiteSwift8DatabaseC19changeEncryptionKeyyyAA0fG0OSgKF[Database.changeEncryptionKey()] on the database copy to set the required encryption key. +
NOTE: To remove encryption on the copy, provide a null encryption-key


[discrete#swift:prebuilt-database:::deploy-db]
...
+
Use the API's https://docs.couchbase.com/mobile/{version-maintenance-ios}/couchbase-lite-swift/Classes/Database.html#/s:18CouchbaseLiteSwift8DatabaseeC4copy8fromPath02toD010withConfigySS_SSAA0D13ConfigurationCSgtKFZ[Database.copy()] method -- see: <<swift:prebuilt-database:::lbl-code>>; this ensures that a UUID is generated for each copy
+
...
[discrete#swift:prebuilt-database:::related-content]
== Related Content
++++
...
[discrete.colum#swift:prebuilt-database:::-2n]
=== {empty}
.Learn more . . .
...
[discrete.colum#swift:prebuilt-database:::-3n]
=== {empty}
.Dive Deeper . . .
