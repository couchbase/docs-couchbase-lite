...
[#swift:prebuilt-database:::overview]
== Overview
...
****
. Create a new Couchbase Lite database with the required dataset -- see <<swift:prebuilt-database:::crt-db>>
. Incorporate the pre-built database with your app bundle as an asset/resource -- see <<swift:prebuilt-database:::bundle-db>>
...
Initiate a sync to update the data -- see <<swift:prebuilt-database:::deploy-db>>
****


[#swift:prebuilt-database:::crt-db]
...
* You can write a simple CBL app to just initiate the required pull sync -- see: xref:swift:replication.adoc[Remote Sync Gateway]
...
[#swift:prebuilt-database:::bundle-db]
...
[#swift:prebuilt-database:::database-encryption]
== Database Encryption
...
[#swift:prebuilt-database:::deploy-db]
...
[#swift:prebuilt-database:::lbl-code]
====
...
[#swift:prebuilt-database:::related-content]
== Related Content
++++
...
[.column#swift:prebuilt-database:::-2]
=== {empty}
.Learn more . . .
...
[.column#swift:prebuilt-database:::-3]
=== {empty}
.Dive Deeper . . .
