...
For information about the now deprecated earlier version of the Logging API, see xref:3.1@couchbase-lite:swift:troubleshooting-logs.adoc[].
...
* xref:swift:new-logging-api.adoc#lbl-file-logsink[]
+
Each log level writes to a separate file and there is a single retention policy for all files

* xref:swift:new-logging-api.adoc#lbl-console-logsink[]
+
--
...
* xref:swift:new-logging-api.adoc#lbl-custom-logsink[]
+
