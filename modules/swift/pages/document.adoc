...
[#swift:document:::overview]
== Overview


[#swift:document:::document-structure]
=== Document Structure
...
[#swift:document:::constructing-a-document]
...
[#swift:document:::create-a-document]
=== Create a Document
...
[#swift:document:::create-a-dictionary]
=== Create a Dictionary
...
[#swift:document:::create-an-array]
=== Create an Array
...
[#swift:document:::populate-a-document]
=== Populate a Document
...
[#swift:document:::save-a-document]
=== Save a Document
...
[#swift:document:::close-the-database]
=== Close the Database
...
[#swift:document:::working-with-data]
== Working with Data


[#swift:document:::checking-a-documents-properties]
...
[#swift:document:::using-dictionaries]
=== Using Dictionaries
...
[#swift:document:::using-blobs]
=== Using Blobs

For more on working with blobs, see xref:swift:blob.adoc[Blobs]


[#swift:document:::document-initializers]
...
[#swift:document:::document-conversion]
== Document Conversion
...
[#swift:document:::batch-operations]
== Batch operations
...
[#swift:document:::document-change-events]
...
[#swift:document:::document-expiration]
== Document Expiration
...
[#swift:document:::lbl-doc-constraints]
...
[#swift:document:::related-content]
== Related Content
++++
