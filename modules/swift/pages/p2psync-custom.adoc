...
`messageEndpointListener` is the instance of the `MessageEndpointListener` that was created in the first step (xref:swift:p2psync-custom.adoc#peer-discovery[Peer Discovery])
