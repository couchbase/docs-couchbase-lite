...
[#swift:p2psync-custom:::peer-discovery]
== Peer Discovery
...
[#swift:p2psync-custom:::active-peer]
=== Active Peer

The first step is to initialize the Couchbase Lite database.

[#swift:p2psync-custom:::passive-peer]
=== Passive Peer
...
// include::swift:example$code_snippets/SampleCodeTest.swift[tag=listener,indent=0]
[source]
----
...
[#swift:p2psync-custom:::peer-selection-and-connection-setup]
...
[#swift:p2psync-custom:::replication-setup]
== Replication Setup


image::ROOT:connection.png[]

[#swift:p2psync-custom:::active-peer-2]
=== Active Peer
...
// include::swift:example$code_snippets/SampleCodeTest.swift[tag=message-endpoint,indent=0]
[source]
----
...
// include::swift:example$code_snippets/SampleCodeTest.swift[tag=message-endpoint-replicator,indent=0]
[source]
----
...
// include::swift:example$code_snippets/SampleCodeTest.swift[tag=create-connection,indent=0]
...
// include::swift:example$code_snippets/SampleCodeTest.swift[tag=active-peer-open,indent=0]
[source]
----
...
[#swift:p2psync-custom:::passive-peer-2]
=== Passive Peer
...
// include::swift:example$code_snippets/SampleCodeTest.swift[tag=advertizer-accept,indent=0]
[source]
----
...
// include::swift:example$code_snippets/SampleCodeTest.swift[tag=passive-peer-open,indent=0]
[source]
----
/* implementation of MessageEndpointConnection */
func open(connection: ReplicatorConnection, completion: @escaping (Bool, MessagingError?) -> Void) {
...
[#swift:p2psync-custom:::pushpull-replication]
...
[#swift:p2psync-custom:::active-peer-3]
=== Active Peer
...
// include::swift:example$code_snippets/SampleCodeTest.swift[tag=active-peer-send,indent=0]
[source]
----
/* implementation of MessageEndpointConnection */
...
// include::swift:example$code_snippets/SampleCodeTest.swift[tag=active-peer-receive,indent=0]
[source]
----
...
[#swift:p2psync-custom:::passive-peer-3]
=== Passive Peer
...
// include::swift:example$code_snippets/SampleCodeTest.swift[tag=passive-peer-send,indent=0]
[source]
----
/* implementation of MessageEndpointConnection */
func send(message: Message, completion: @escaping (Bool, MessagingError?) -> Void) {
...
// include::swift:example$code_snippets/SampleCodeTest.swift[tag=passive-peer-receive,indent=0]
[source]
----
let message = Message.fromData(data)
replicatorConnection?.receive(message: message)
...
[#swift:p2psync-custom:::connection-teardown]
== Connection Teardown
...
[#swift:p2psync-custom:::initiated-by-active-peer]
=== Initiated by Active Peer

image::ROOT:dis-active.png[]

[#swift:p2psync-custom:::active-peer-4]
=== Active Peer

When an active Peer disconnects, it must call the `ReplicatorConnection.close` method.

// include::swift:example$code_snippets/SampleCodeTest.swift[tag=active-replicator-close,indent=0]
[source]
----
...
// include::swift:example$code_snippets/SampleCodeTest.swift[tag=active-peer-close,indent=0]
[source]
----
/* implementation of MessageEndpointConnection */
...
[#swift:p2psync-custom:::passive-peer-4]
=== Passive Peer
...
// include::swift:example$code_snippets/SampleCodeTest.swift[tag=passive-replicator-close,indent=0]
[source]
----
replicatorConnection?.close(error: nil)
----
...
// include::swift:example$code_snippets/SampleCodeTest.swift[tag=passive-peer-close,indent=0]
[source]
----
/* implementation of MessageEndpointConnection */
func close(error: Error?, completion: @escaping () -> Void) {
...
[#swift:p2psync-custom:::initiated-by-passive-peer]
=== Initiated by Passive Peer

image::ROOT:dis-passive.png[]

[#swift:p2psync-custom:::passive-peer-5]
=== Passive Peer

When the passive disconnects, it must class the `MessageEndpointListener.closeAll` method.

// include::swift:example$code_snippets/SampleCodeTest.swift[tag=passive-stop-listener,indent=0]
[source]
----
...
[#swift:p2psync-custom:::active-peer-5]
=== Active Peer
...
[#swift:p2psync-custom:::related-content]
== Related Content
++++
