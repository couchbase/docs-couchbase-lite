.xref:csharp:quickstart.adoc[.Net]
  ...
  * Queries
    ...
    ** xref:csharp:query-n1ql-mobile.adoc[{sqlpp_cbm} for Mobile]
    ** xref:csharp:query-n1ql-mobile-server-diffs.adoc[{sqlpp_cbm} Mobile - Server Differences]
    ** xref:csharp:query-n1ql-mobile-querybuilder-diffs.adoc[{sqlpp_cbm} Querybuilder Differences]
