...
[#csharp:troubleshooting-queries:::query-explain]
== Query Explain


[#csharp:troubleshooting-queries:::using]
=== Using
...
[#csharp:troubleshooting-queries:::output]
=== Output
...
[#csharp:troubleshooting-queries:::the-query-plan]
== The Query Plan


[#csharp:troubleshooting-queries:::format]
=== Format
...
[#csharp:troubleshooting-queries:::ret-method]
=== Retrieval Method
...
[#csharp:troubleshooting-queries:::order-group]
=== Order and Group
...
[#csharp:troubleshooting-queries:::queries-and-indexes]
== Queries and Indexes
...
[#csharp:troubleshooting-queries:::working-with-the-query-optimizer]
...
[#csharp:troubleshooting-queries:::use-like-based-queries]
...
[source#csharp:troubleshooting-queries:::like-wild-pfx-qry, C#]
----
using var query =
  QueryBuilder
    .Select(SelectResult.All())
...
[#csharp:troubleshooting-queries:::use-functions-wisely]
...
[source#csharp:troubleshooting-queries:::use-like-based-queries, C#]
----
using var query =
  QueryBuilder
    .Select(SelectResult.All())
...
[#csharp:troubleshooting-queries:::optimization-considerations]
...
[#csharp:troubleshooting-queries:::related-content]
== Related Content
++++
...
[.column#csharp:troubleshooting-queries:::-2]
====== {empty}
.Learn more . . .
...
[.column#csharp:troubleshooting-queries:::-3]
====== {empty}
.Dive Deeper . . .
