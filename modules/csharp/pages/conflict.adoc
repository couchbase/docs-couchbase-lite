...
[#csharp:conflict:::causes-of-conflicts]
== Causes of Conflicts
...
[#csharp:conflict:::lbl-conflicts-when-replicating]
...
[#csharp:conflict:::automatic-conflict-resolution]
...
[#csharp:conflict:::custom-conflict-resolution]
...
[#csharp:conflict:::conflict-resolver]
=== Conflict Resolver
...
+
--
// include::csharp:example$code_snippets/Program.cs[tag=local-win-conflict-resolver,indent=0]
[source, C#]
----
...
+
--
// include::csharp:example$code_snippets/Program.cs[tag=remote-win-conflict-resolver,indent=0]
[source, C#]
----
...
// include::csharp:example$code_snippets/Program.cs[tag=merge-conflict-resolver,indent=0]
[source, C#]
----
...
[#csharp:conflict:::important-guidelines-and-best-practices]
...
[#csharp:conflict:::configure-the-replicator]
...
[#csharp:conflict:::conflicts-when-saving]
...
[#csharp:conflict:::automatic-conflict-resolution-2]
=== Automatic Conflict Resolution
...
[#csharp:conflict:::custom-conflict-handlers]
...
[#csharp:conflict:::related-content]
== Related Content
++++
...
= https://docs.couchbase.com/mobile/3.2.1/couchbase-lite-net/index.html[API&#160;References]
