...
[#csharp:p2psync-websocket-using-passive:::introduction]
== Introduction
...
[#csharp:p2psync-websocket-using-passive:::configuration-summary]
...
[#csharp:p2psync-websocket-using-passive:::api-references]
== API References
...
[#csharp:p2psync-websocket-using-passive:::device-discovery]
== Device Discovery
...
[#csharp:p2psync-websocket-using-passive:::initialize-the-listener-configuration]
...
[#csharp:p2psync-websocket-using-passive:::lbl-set-network-and-port]
== Set Port and Network Interface


[#csharp:p2psync-websocket-using-passive:::port-number]
=== Port number
...
[#csharp:p2psync-websocket-using-passive:::network-interface]
=== Network Interface
...
[#csharp:p2psync-websocket-using-passive:::delta-sync]
== Delta Sync
...
[#csharp:p2psync-websocket-using-passive:::lbl-tls-security]
== TLS Security


[#csharp:p2psync-websocket-using-passive:::enable-or-disable-tls]
...
[#csharp:p2psync-websocket-using-passive:::configure-tls-identity-for-listener]
...
[#csharp:p2psync-websocket-using-passive:::lbl-authenticating-the-client]
...
[#csharp:p2psync-websocket-using-passive:::use-basic-authentication]
...
[#csharp:p2psync-websocket-using-passive:::using-client-certificate-authentication]
...
[#csharp:p2psync-websocket-using-passive:::delete-tls-identity]
=== Delete Entry
...
[#csharp:p2psync-websocket-using-passive:::the-impact-of-tls-settings]
...
[#csharp:p2psync-websocket-using-passive:::monitor-listener]
== Monitor Listener
...
[#csharp:p2psync-websocket-using-passive:::stop-listener]
== Stop Listener
...
[#csharp:p2psync-websocket-using-passive:::related-content]
== Related Content
++++
...
[.column#csharp:p2psync-websocket-using-passive:::-2]
=== {empty}
.Concepts
...
[.column#csharp:p2psync-websocket-using-passive:::-3]
=== {empty}
.Community Resources ...
