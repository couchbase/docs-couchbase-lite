...
// include::csharp:example$code_snippets/VectorSearch.cs[tags=vs-lazy-index-config]
[source, csharp]
----
...
// include::csharp:example$code_snippets/VectorSearch.cs[tags=vs-create-lazy-index-embedding]
[source, csharp]
----
...
// include::csharp:example$code_snippets/VectorSearch.cs[tags=vs-hybrid-valid, vs-hybrid-invalid;]
[source, csharp]
----
...
// include::csharp:example$code_snippets/VectorSearch.cs[tags=vs-hybrid-limitation]
[source, csharp]
----
...
// include::csharp:example$code_snippets/VectorSearch.cs[tags=vs-hybrid-ftmatch]
[source, csharp]
----
