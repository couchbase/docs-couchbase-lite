...
include::csharp:example$code_snippets/VectorSearch.cs[tags=vs-hybrid-prediction]
...
include::csharp:example$code_snippets/VectorSearch.cs[tags=vs-apvd-where]
...
include::csharp:example$code_snippets/VectorSearch.cs[tags=vs-apvd-prediction]
