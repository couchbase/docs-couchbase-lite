...
+
Use the API's https://docs.couchbase.com/mobile/{major}.{minor}.{maintenance-net}{empty}/couchbase-lite-net/api/Couchbase.Lite.Database.html#lbl-code>>; this ensures that a UUID is generated for each copy
+
