...
[discrete#csharp:query-n1ql-mobile:::introduction]
==== Introduction
...
[discrete#csharp:query-n1ql-mobile:::running]
==== Running
...
[discrete#csharp:query-n1ql-mobile:::query-format]
==== Query Format
...
[discrete#csharp:query-n1ql-mobile:::lbl-select]
==== SELECT statement

[discrete#csharp:query-n1ql-mobile:::purpose]
===== Purpose
Projects the result returned by the query, identifying the columns it will contain.

[discrete#csharp:query-n1ql-mobile:::syntax]
===== Syntax
...
[discrete#csharp:query-n1ql-mobile:::arguments]
===== Arguments
...
[discrete#csharp:query-n1ql-mobile:::select-wildcard]
====== Select Wildcard
...
[discrete#csharp:query-n1ql-mobile:::example]
===== Example
...
[discrete#csharp:query-n1ql-mobile:::lbl-from]
==== FROM

[discrete#csharp:query-n1ql-mobile:::purpose-2]
===== Purpose
Specifies the data source, or sources, and optionally applies an alias ( `AS`).
It is mandatory.

[discrete#csharp:query-n1ql-mobile:::syntax-2]
===== Syntax
...
[discrete#csharp:query-n1ql-mobile:::datasource]
===== Datasource
...
[discrete#csharp:query-n1ql-mobile:::arguments-2]
===== Arguments
...
[discrete#csharp:query-n1ql-mobile:::example-2]
===== Example
...
[discrete#csharp:query-n1ql-mobile:::lbl-join]
==== JOIN statement

[discrete#csharp:query-n1ql-mobile:::purpose-3]
===== Purpose
...
[discrete#csharp:query-n1ql-mobile:::syntax-3]
===== Syntax
...
[discrete#csharp:query-n1ql-mobile:::arguments-3]
===== Arguments
...
[discrete#csharp:query-n1ql-mobile:::example-3]
===== Example
...
[discrete#csharp:query-n1ql-mobile:::lbl-where]
==== WHERE statement

[discrete#csharp:query-n1ql-mobile:::purpose-4]
===== Purpose
...
[discrete#csharp:query-n1ql-mobile:::syntax-4]
===== Syntax
...
[discrete#csharp:query-n1ql-mobile:::arguments-4]
===== Arguments
...
[discrete#csharp:query-n1ql-mobile:::examples]
===== Examples
...
[discrete#csharp:query-n1ql-mobile:::lbl-group]
==== GROUP BY statement

[discrete#csharp:query-n1ql-mobile:::purpose-5]
===== Purpose
Use `group by` to arrange values in groups of one or more properties.

[discrete#csharp:query-n1ql-mobile:::syntax-5]
===== Syntax
...
[discrete#csharp:query-n1ql-mobile:::arguments-5]
===== Arguments
...
[discrete#csharp:query-n1ql-mobile:::examples-2]
===== Examples
...
[discrete#csharp:query-n1ql-mobile:::lbl-order]
==== ORDER BY statement

[discrete#csharp:query-n1ql-mobile:::purpose-6]
===== Purpose
Sort query results based on a given expression result.

[discrete#csharp:query-n1ql-mobile:::syntax-6]
===== Syntax
...
[discrete#csharp:query-n1ql-mobile:::arguments-6]
===== Arguments
...
[discrete#csharp:query-n1ql-mobile:::examples-3]
===== Examples
...
[discrete#csharp:query-n1ql-mobile:::lbl-limit]
==== LIMIT statement

[discrete#csharp:query-n1ql-mobile:::purpose-7]
===== Purpose
Specifies the maximum number of results to be returned by the query.

[discrete#csharp:query-n1ql-mobile:::syntax-7]
===== Syntax
...
[discrete#csharp:query-n1ql-mobile:::lbl-offset]
==== OFFSET statement

[discrete#csharp:query-n1ql-mobile:::purpose-8]
===== Purpose
Specifies the number of results to be skipped by the query.

[discrete#csharp:query-n1ql-mobile:::syntax-8]
===== Syntax
...
[discrete#csharp:query-n1ql-mobile:::arguments-8]
===== Arguments
...
[discrete#csharp:query-n1ql-mobile:::examples-5]
===== Examples
...
[discrete#csharp:query-n1ql-mobile:::lbl-literals]
==== Expressions
In this section::
...
[discrete#csharp:query-n1ql-mobile:::lbl-exp-literals]
===== Literals
...
[discrete#csharp:query-n1ql-mobile:::lbl-lit-bool]
====== Boolean

[discrete#csharp:query-n1ql-mobile:::purpose-9]
====== Purpose
Represents a true or false value.

[discrete#csharp:query-n1ql-mobile:::syntax-9]
====== Syntax

`TRUE | FALSE`

[discrete#csharp:query-n1ql-mobile:::example-4]
====== Example
...
[discrete#csharp:query-n1ql-mobile:::lbl-lit-numbers]
====== Numeric

[discrete#csharp:query-n1ql-mobile:::purpose-10]
====== Purpose
Represents a numeric value.
Numbers may be signed or unsigned digits.
They have optional fractional and exponent components.

[discrete#csharp:query-n1ql-mobile:::syntax-10]
====== Syntax
...
[discrete#csharp:query-n1ql-mobile:::example-5]
====== Example
...
[discrete#csharp:query-n1ql-mobile:::lbl-lit-string]
====== String

[discrete#csharp:query-n1ql-mobile:::purpose-11]
====== Purpose
The string literal represents a string or sequence of characters.


[discrete#csharp:query-n1ql-mobile:::syntax-11]
====== Syntax
...
[discrete#csharp:query-n1ql-mobile:::example-6]
====== Example
[source,sql]
----
...
[discrete#csharp:query-n1ql-mobile:::lbl-lit-null]
====== NULL

[discrete#csharp:query-n1ql-mobile:::purpose-12]
====== Purpose
The literal NULL represents an empty value.

[discrete#csharp:query-n1ql-mobile:::syntax-12]
====== Syntax
...
[discrete#csharp:query-n1ql-mobile:::example-7]
====== Example
[source,sql]
----
...
[discrete#csharp:query-n1ql-mobile:::lbl-lit-missing]
====== MISSING

[discrete#csharp:query-n1ql-mobile:::purpose-13]
====== Purpose
The MISSING literal represents a missing name-value pair in a document.

[discrete#csharp:query-n1ql-mobile:::syntax-13]
====== Syntax
...
[discrete#csharp:query-n1ql-mobile:::example-8]
====== Example
[source,sql]
----
...
[discrete#csharp:query-n1ql-mobile:::lbl-lit-array]
====== Array

[discrete#csharp:query-n1ql-mobile:::purpose-14]
====== Purpose
Represents an Array

[discrete#csharp:query-n1ql-mobile:::syntax-14]
====== Syntax
...
[discrete#csharp:query-n1ql-mobile:::example-9]
====== Example
[source,sql]
----
SELECT [“a”, “b”, “c”] FROM _
...
[discrete#csharp:query-n1ql-mobile:::lbl-lit-dict]
====== Dictionary

[discrete#csharp:query-n1ql-mobile:::purpose-15]
====== Purpose
Represents a dictionary literal

[discrete#csharp:query-n1ql-mobile:::syntax-15]
====== Syntax
...
[discrete#csharp:query-n1ql-mobile:::example-10]
====== Example
[source,sql]
----
...
[discrete#csharp:query-n1ql-mobile:::lbl-exp-ident]
===== Identifiers

[discrete#csharp:query-n1ql-mobile:::purpose-16]
====== Purpose
...
[discrete#csharp:query-n1ql-mobile:::syntax-16]
====== Syntax
...
[discrete#csharp:query-n1ql-mobile:::example-11]
====== Example
...
[discrete#csharp:query-n1ql-mobile:::lbl-exp-prop]
===== Property Expressions

[discrete#csharp:query-n1ql-mobile:::purpose-17]
====== Purpose
The property expression is used to reference a property in a document

[discrete#csharp:query-n1ql-mobile:::syntax-17]
====== Syntax
...
[discrete#csharp:query-n1ql-mobile:::example-12]
====== Example
...
[discrete#csharp:query-n1ql-mobile:::lbl-exp-any]
===== Any and Every Expressions

[discrete#csharp:query-n1ql-mobile:::purpose-18]
====== Purpose
Evaluates expressions over items in an array object.


[discrete#csharp:query-n1ql-mobile:::syntax-18]
====== Syntax
...
[discrete#csharp:query-n1ql-mobile:::example-13]
====== Example
...
[discrete#csharp:query-n1ql-mobile:::lbl-exp-param]
===== Parameter Expressions

[discrete#csharp:query-n1ql-mobile:::purpose-19]
====== Purpose
...
[discrete#csharp:query-n1ql-mobile:::syntax-19]
====== Syntax
...
[discrete#csharp:query-n1ql-mobile:::examples-6]
====== Examples
...
[discrete#csharp:query-n1ql-mobile:::lbl-exp-paren]
===== Parenthesis Expressions

[discrete#csharp:query-n1ql-mobile:::purpose-20]
====== Purpose

Use parentheses to group expressions together to make them more readable or to establish operator precedences.

[discrete#csharp:query-n1ql-mobile:::example-14]
====== Example
...
[discrete#csharp:query-n1ql-mobile:::lbl-operators]
==== Operators
In this section::
...
//3321
[discrete#csharp:query-n1ql-mobile:::lbl-ops-binary]
===== Binary Operators
...
[discrete#csharp:query-n1ql-mobile:::lbl-ops-maths]
====== Maths
...
[discrete#csharp:query-n1ql-mobile:::lbl-comp-ops]
====== Comparison Operators

[discrete#csharp:query-n1ql-mobile:::purpose-21]
====== Purpose
...
[discrete#csharp:query-n1ql-mobile:::lbl-ops-logical]
====== Logical Operators

[discrete#csharp:query-n1ql-mobile:::purpose-22]
====== Purpose
...
[discrete#csharp:query-n1ql-mobile:::lbl-ops-string]
====== String Operator

[discrete#csharp:query-n1ql-mobile:::purpose-23]
====== Purpose
...
[discrete#csharp:query-n1ql-mobile:::lbl-ops-unary]
===== Unary Operators

[discrete#csharp:query-n1ql-mobile:::purpose-24]
====== Purpose
...
[discrete#csharp:query-n1ql-mobile:::syntax-20]
====== Syntax
...
[discrete#csharp:query-n1ql-mobile:::lbl-ops-coll]
===== COLLATE Operators

[discrete#csharp:query-n1ql-mobile:::purpose-25]
====== Purpose
Collate operators specify how the string comparison is conducted.

[discrete#csharp:query-n1ql-mobile:::usage]
====== Usage
...
[discrete#csharp:query-n1ql-mobile:::syntax-21]
====== Syntax
...
[discrete#csharp:query-n1ql-mobile:::arguments-9]
====== Arguments
...
[discrete#csharp:query-n1ql-mobile:::example-15]
====== Example
...
[discrete#csharp:query-n1ql-mobile:::lbl-ops-cond]
===== CONDITIONAL Operator

[discrete#csharp:query-n1ql-mobile:::purpose-26]
====== Purpose

The Conditional (or `CASE`) operator evaluates conditional logic in a similar way to the IF/ELSE operator.

[discrete#csharp:query-n1ql-mobile:::syntax-22]
====== Syntax
...
[discrete#csharp:query-n1ql-mobile:::example-16]
====== Example
...
[discrete#csharp:query-n1ql-mobile:::lbl-functions]
==== Functions
In this section::
...
[discrete#csharp:query-n1ql-mobile:::purpose-27]
===== Purpose

Functions are also expressions.

[discrete#csharp:query-n1ql-mobile:::syntax-23]
===== Syntax
...
[discrete#csharp:query-n1ql-mobile:::lbl-func-agg]
...
[discrete#csharp:query-n1ql-mobile:::lbl-func-array]
===== Array Functions
...
[discrete#csharp:query-n1ql-mobile:::lbl-func-cond]
...
[discrete#csharp:query-n1ql-mobile:::lbl-func-date]
...
[discrete#csharp:query-n1ql-mobile:::lbl-func-fts]
...
[discrete#csharp:query-n1ql-mobile:::lbl-func-maths]
===== Maths Functions
...
[discrete#csharp:query-n1ql-mobile:::lbl-func-meta]
===== Metadata Functions
...
[discrete#csharp:query-n1ql-mobile:::lbl-func-pattern]
...
[discrete#csharp:query-n1ql-mobile:::lbl-func-string]
===== String Functions
...
[discrete#csharp:query-n1ql-mobile:::lbl-func-typecheck]
...
[discrete#csharp:query-n1ql-mobile:::lbl-func-typeconv]
...
[discrete#csharp:query-n1ql-mobile:::querybuilder-differences]
...
[discrete#csharp:query-n1ql-mobile:::lbl-query-params]
==== Query Parameters
...
[discrete#csharp:query-n1ql-mobile:::related-content]
==== Related Content
++++
...
[.column]
// [.content]
[discrete#csharp:query-n1ql-mobile:::-3]
===== {empty}
.Dive Deeper . . .
//* Community
