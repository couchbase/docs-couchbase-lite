...
| <<csharp:query-n1ql-mobile:::lbl-unnest>>
...
We are also accessing the current database using the shorthand notation *`_`* -- see the <<csharp:query-n1ql-mobile:::lbl-from>> clause for more on data source selection and <<csharp:query-n1ql-mobile:::lbl-query-params>> for more on parameterized queries.
...
[#csharp:query-n1ql-mobile:::examples-7]
==== Examples
...
.Comparison Operators
[#tbl-ops-comp]
[ops-comp#csharp:query-n1ql-mobile:::tbl-ops-comp, cols="^1m,2,2m", options="header"]
|===
...
[#tbl-ops-isnot]
[ops-comp#csharp:query-n1ql-mobile:::tbl-ops-isnot, cols="^1,^1,^1,^1", options="header"]
|===
...
.Logical Operators
[#tbl-ops-logical]
[ops-comp#csharp:query-n1ql-mobile:::tbl-ops-logical, cols="^1m,2,2m", options="header"]
|===
...
[#csharp:query-n1ql-mobile:::purpose-28]
=== Purpose

Functions are also expressions.

[#csharp:query-n1ql-mobile:::syntax-24]
=== Syntax
...
[.column#csharp:query-n1ql-mobile:::-2]
====== {empty}
.Learn more . . .
...
[.column#csharp:query-n1ql-mobile:::-3]
====== {empty}
.Dive Deeper . . .
