...
[#maint-vs-latest]
[#csharp:vs-releasenotes:::vs-maint-1-0-0-beta-2]
=== 1.0.0 Beta 2 -- May 2024

Version 1.0.0 Beta 2 for C#.Net delivers the following features and enhancements:

[#csharp:vs-releasenotes:::enhancements]
==== Enhancements

None for this release

[#csharp:vs-releasenotes:::issues-and-resolutions]
==== Issues and Resolutions

None for this release

[#csharp:vs-releasenotes:::known-issues]
=====  Known Issues
...
[#csharp:vs-releasenotes:::deprecations]
==== Deprecations
