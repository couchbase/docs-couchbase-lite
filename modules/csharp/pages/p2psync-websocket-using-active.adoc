...
[#csharp:p2psync-websocket-using-active:::introduction]
== Introduction
...
[#csharp:p2psync-websocket-using-active:::configuration-summary]
...
[#csharp:p2psync-websocket-using-active:::api-references]
== API References
...
[#csharp:p2psync-websocket-using-active:::device-discovery]
== Device Discovery
...
[#csharp:p2psync-websocket-using-active:::configure-replicator]
...
[#csharp:p2psync-websocket-using-active:::certificate-authentication]
...
[#csharp:p2psync-websocket-using-active:::initialize-replicator]
...
[#csharp:p2psync-websocket-using-active:::lbl-repl-mon]
== Monitor Sync
...
[#csharp:p2psync-websocket-using-active:::lbl-repl-states]
=== Replication States
...
[#csharp:p2psync-websocket-using-active:::replication-status-and-app-life-cycle]
...
[#csharp:p2psync-websocket-using-active:::lbl-repl-stop]
== Stop Sync
...
[#csharp:p2psync-websocket-using-active:::conflict-resolution]
== Conflict Resolution
...
[#csharp:p2psync-websocket-using-active:::delta-sync]
== Delta Sync
If delta sync is enabled on the listener, then replication will use delta sync.


[#csharp:p2psync-websocket-using-active:::related-content]
== Related Content
++++
...
[.column#csharp:p2psync-websocket-using-active:::-2]
=== {empty}
.Concepts
...
[.column#csharp:p2psync-websocket-using-active:::-3]
=== {empty}
.Community Resources ...
