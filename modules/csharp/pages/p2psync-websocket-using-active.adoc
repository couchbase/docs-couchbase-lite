...
[{tabs}]
======
[#csharp:p2psync-websocket-using-active:::tabs-1-ca-cert]
CA Cert::
+
--
...
[#csharp:p2psync-websocket-using-active:::tabs-1-self-signed-cert]
Self Signed Cert::
+
--
...
[#csharp:p2psync-websocket-using-active:::tabs-1-pinned-certificate]
Pinned Certificate::
+
--
...
[{tabs}]
======
[#csharp:p2psync-websocket-using-active:::tabs-2-adding-a-change-listener]
...
--
+
[#csharp:p2psync-websocket-using-active:::tabs-2-using-replicator-status]
...
[{tabs}]
=====
[#csharp:p2psync-websocket-using-active:::tabs-3-local-wins]
Local Wins::
+
--
...
[#csharp:p2psync-websocket-using-active:::tabs-3-remote-wins]
Remote Wins::
+
--
...
[#csharp:p2psync-websocket-using-active:::tabs-3-merge]
Merge::
+
--
...
[.column]
// [.content]
[discrete#csharp:p2psync-websocket-using-active:::-3]
====== {empty}
.Community Resources ...
//* Community
