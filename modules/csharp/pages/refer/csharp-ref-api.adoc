...
Sync Gateway users can be created through the xref:sync-gateway:ROOT:refer/admin-rest-api.adoc#/user/post\__db___user_[`+POST /{tkn-db}/_user+`] endpoint on the Admin REST API.
