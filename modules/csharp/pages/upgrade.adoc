...
This content introduces the changes made to the pass:q,a[Couchbase{nbsp}Lite] for C#.Net API for release {major}.{minor}.{base}{empty}.

Starting from this release pass:q,a[Couchbase{nbsp}Lite] for C#.Net requires _Visual Studio 2019+_ and uses .Net Core 3.1 (updating from .Net Core 2.0).
