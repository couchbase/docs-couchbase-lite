...
This content introduces the changes made to the pass:q,a[pass:q,a[Couchbase{nbsp}Lite]] for C#.Net API for release {version-full}.
...
https://docs.couchbase.com/mobile/{version-full}/couchbase-lite-net/api/Couchbase.Lite.Query.Function.html#Couchbase_Lite_Query_Function_Atan2_Couchbase_Lite_Query_IExpression_Couchbase_Lite_Query_IExpression_[ATAN2(y, x)];
...
Use
https://docs.couchbase.com/mobile/{version-full}/couchbase-lite-net/api/Couchbase.Lite.Logging.Log.html#Couchbase_Lite_Logging_Log_Console[
...
Use the method
https://docs.couchbase.com/mobile/{version-full}/couchbase-lite-net/api/Couchbase.Lite.Database.html#Couchbase_Lite_Database_PerformMaintenance_Couchbase_Lite_MaintenanceType_[Database.PerformMaintenance()] and the enum
https://docs.couchbase.com/mobile/{version-full}/couchbase-lite-net/api/Couchbase.Lite.MaintenanceType.html[MaintenanceType]
instead
...
https://docs.couchbase.com/mobile/{version-full}/couchbase-lite-net/api/Couchbase.Lite.Query.FullTextFunction.html#Couchbase_Lite_Query_FullTextFunction_Match_System_String_System_String_[FullTextFunction.match(indexName:)]
...
----
<.> Here we use https://docs.couchbase.com/mobile/{version-full}/couchbase-lite-net/api/Couchbase.Lite.Query.FullTextFunction.htmlFullTextFunction.match(indexName:)[FullTextFunction.match(indexName:)]
to build the query
...
You should plan to switch to using the alternative
https://docs.couchbase.com/mobile/{version-full}/couchbase-lite-net/api/Couchbase.Lite.Query.IExpression.html#Couchbase_Lite_Query_IExpression_IsNotValued[IsNotValued()]
...
You should plan to switch to using the alternative
https://docs.couchbase.com/mobile/{version-full}/couchbase-lite-net/api/Couchbase.Lite.Query.IExpression.html#Couchbase_Lite_Query_IExpression_IsValued[isValued()]
at the earliest opportunity.
