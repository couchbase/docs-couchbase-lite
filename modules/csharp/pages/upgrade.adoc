...
[#csharp:upgrade:::downgrading-couchbase-lite]
== Downgrading Couchbase Lite

[#csharp:upgrade:::downgrading-between-major-releases]
...
[#csharp:upgrade:::downgrading-between-minor-releases]
...
[#csharp:upgrade:::downgrading-between-patch-releases]
