...
`Couchbase.Lite.Support.WinUI.Activate()`
...
* For Non-Android applications - `Extension.Load(new VectorSearchExtension());`

* For Android applications - `Extension.Load(new VectorSearchExtension(Context));`
