...
. Within your Android app, include a call to the relevant `Activate()` function inside of the class that is included in the support assembly, passing in a `context` argument (typically the `ApplicationContext` property on your app class).
****
