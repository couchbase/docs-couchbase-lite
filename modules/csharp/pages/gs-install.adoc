...
.Quick Steps
****
For experienced developers, this is all you need to add _Couchbase Lite for C#.Net {major-net}.{minor-net}.{maintenance-net}_ to your application projects.

. Create or open an existing Visual Studio project

. Install either of the following packages from Nuget.
+
* Community Edition -- `Couchbase.Lite` package for {major-net}.{minor-net}.{maintenance-net}

* Enterprise Edition -- `Couchbase.Lite.Enterprise` package for {major-net}.{minor-net}.{maintenance-net}

** Vector Search Extension -- `Couchbase.Lite.VectorSearch` package for {vs-major}.{vs-minor}.
