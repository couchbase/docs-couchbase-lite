...
[#csharp:gs-install:::installing-vector-search]
...
[#csharp:gs-install:::vector-search-package-reference]
...
[#csharp:gs-install:::activating-on-android-platform-only]
...
[#csharp:gs-install:::activating-with-maui]
...
[#csharp:gs-install:::activating-vector-search]
...
[#csharp:gs-install:::related-content]
== Related Content
++++
