...
:page-aliases: start/csharp-gs-install.adoc, start/csharp-gs-get-started.adoc, get-started-install.adoc, gs-get-started.adoc, start/csharp-gs-prereqs.adoc, gs-prereqs.adoc
:page-layout: article
:page-status:
:page-edition:
:page-role:
