...
To install _Couchbase Lite for .NET {this-release}_, create or open an existing Visual Studio project and use one of the following methods.

. Install either of the following packages from Nuget.
+
.Couchbase Lite Community Edition
Install the `Couchbase.Lite` package for {this-release}
+
.Couchbase Lite Enterprise Edition
Install the `Couchbase.Lite.Enterprise` package for {this-release}
+
