...
[#csharp:document:::document-structure]
=== Document Structure
...
[#csharp:document:::constructing-a-document]
...
[#csharp:document:::create-a-document]
=== Create a Document
...
[#csharp:document:::create-a-dictionary]
=== Create a Dictionary
...
[#csharp:document:::create-an-array]
=== Create an Array
...
[#csharp:document:::populate-a-document]
=== Populate a Document
...
[#csharp:document:::save-a-document]
=== Save a Document
...
[#csharp:document:::close-the-database]
=== Close the Database
...
[#csharp:document:::working-with-data]
== Working with Data


[#csharp:document:::checking-a-documents-properties]
...
[#csharp:document:::date-accessors]
=== Date accessors
...
[#csharp:document:::using-dictionaries]
=== Using Dictionaries
...
[#csharp:document:::using-blobs]
=== Using Blobs

For more on working with blobs, see xref:csharp:blob.adoc[Blobs]


[#csharp:document:::document-initializers]
...
[#csharp:document:::batch-operations]
== Batch operations
...
[#csharp:document:::document-change-events]
...
[#csharp:document:::document-expiration]
== Document Expiration
...
[#csharp:document:::lbl-doc-constraints]
...
[#csharp:document:::related-content]
== Related Content
++++
