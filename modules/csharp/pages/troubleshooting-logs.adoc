...
* xref:csharp:troubleshooting-logs.adoc#lbl-file-logs[]
+
Here logs are written to xref:csharp:troubleshooting-logs.adoc#log-file-outputs[separate log files] filtered by log level, with each log level supporting individual retention policies.

* xref:csharp:troubleshooting-logs.adoc#lbl-console-logs[]
+
--
...
* xref:csharp:troubleshooting-logs.adoc#lbl-custom-logs[]
+
--
...
To change default settings use database's https://docs.couchbase.com/mobile/{major}.{minor}.{maintenance-net}{empty}/couchbase-lite-net/api/Couchbase.Lite.Logging.Log.html[Log] method to set the required values -- see xref:csharp:troubleshooting-logs.adoc#eg-cons-log[]
...
[#lbl-file-logs]
== File based logging
File based logging is disabled by default --  see: xref:csharp:troubleshooting-logs.adoc#eg-file-log[] for how to enable it.
...
+
Use this format and a decoder, such as *cbl-log*, to view them -- see: xref:csharp:troubleshooting-logs.adoc#decoding-binary-logs[].
* Plaintext
...
To do this, apps must implement the https://docs.couchbase.com/mobile/{major}.{minor}.{maintenance-net}{empty}/couchbase-lite-net/api/Couchbase.Lite.Logging.ILogger.html[ILogger] interface -- see xref:csharp:troubleshooting-logs.adoc#eg-impl-log[] -- and enable custom logging using https://docs.couchbase.com/mobile/{major}.{minor}.{maintenance-net}{empty}/couchbase-lite-net/api/Couchbase.Lite.Logging.Log.html#Couchbase_Lite_Logging_Log_Custom[log.setCustom()] -- see xref:csharp:troubleshooting-logs.adoc#eg-cust-log[].
...
This example show how to enable the custom logger from xref:csharp:troubleshooting-logs.adoc#eg-impl-log[].
...
You can use the *cbl-log* tool to decode binary log files -- see xref:csharp:troubleshooting-logs.adoc#eg-cbl-log[].
