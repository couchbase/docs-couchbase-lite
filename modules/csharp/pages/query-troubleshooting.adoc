...
[#csharp:query-troubleshooting:::query-explain]
== Query Explain


[#csharp:query-troubleshooting:::using]
=== Using
...
[#csharp:query-troubleshooting:::output]
=== Output
...
[#csharp:query-troubleshooting:::the-query-plan]
== The Query Plan


[#csharp:query-troubleshooting:::format]
=== Format
...
[#csharp:query-troubleshooting:::ret-method]
=== Retrieval Method
...
[#csharp:query-troubleshooting:::order-group]
=== Order and Group
...
[#csharp:query-troubleshooting:::queries-and-indexes]
== Queries and Indexes
...
[#csharp:query-troubleshooting:::working-with-the-query-optimizer]
...
[#csharp:query-troubleshooting:::use-like-based-queries]
...
[source#csharp:query-troubleshooting:::like-wild-pfx-qry, C#]
----
using var query =
  QueryBuilder
    .Select(SelectResult.All())
...
[#csharp:query-troubleshooting:::use-functions-wisely]
...
[source#csharp:query-troubleshooting:::use-like-based-queries, C#]
----
using var query =
  QueryBuilder
    .Select(SelectResult.All())
...
[#csharp:query-troubleshooting:::optimization-considerations]
...
[#csharp:query-troubleshooting:::related-content]
== Related Content
++++
...
[.column#csharp:query-troubleshooting:::-2]
====== {empty}
.Learn more . . .
...
[.column#csharp:query-troubleshooting:::-3]
====== {empty}
.Dive Deeper . . .
