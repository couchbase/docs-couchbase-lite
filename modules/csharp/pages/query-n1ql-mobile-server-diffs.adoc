...
[#csharp:query-n1ql-mobile-server-diffs:::boolean-logic-rules]
=== Boolean Logic Rules
...
[#csharp:query-n1ql-mobile-server-diffs:::logical-operations]
==== Logical Operations
...
[#csharp:query-n1ql-mobile-server-diffs:::crud-operations]
=== CRUD Operations
{sqlpp} for Mobile only supports Read or Query operations.

{sqlpp} for Server fully supports CRUD operation.

[#csharp:query-n1ql-mobile-server-diffs:::functions]
=== Functions

[#csharp:query-n1ql-mobile-server-diffs:::division-operator]
==== Division Operator
...
[#csharp:query-n1ql-mobile-server-diffs:::round-function]
==== Round Function
[,cols="1a,1a", options="header"]
|===
^| {sqlpp} for Server ^| {sqlpp} for Mobile
...
[#csharp:query-n1ql-mobile-server-diffs:::related-content]
=== Related Content
++++
