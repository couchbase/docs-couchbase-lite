...
This content introduces the changes made to the Couchbase Lite for {param-title} API for release {version-full}.

Starting from this release Couchbase Lite for {param-title} requires _Visual Studio 2019+_ and uses .Net Core 3.1 (updating from .Net Core 2.0).
