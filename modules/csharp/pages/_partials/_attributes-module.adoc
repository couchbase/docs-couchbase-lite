...
:url-api-methods-expression-pfx: {url-api-classes-query-pfx}IExpression.html#Couchbase_Lite_Query_IExpression_
// :url-api-methods-expression-like: {url-api-methods-expression-pfx}Like_Couchbase_Lite_Query_IExpression_
:url-api-methods-expression-like: {url-api-methods-expression-pfx}Like_Couchbase_Lite_Query_IExpression_[Like()]
:url-api-methods-expression-collate: {url-api-methods-expression-pfx}Collate_Couchbase_Lite_Query_ICollation_[Collate()]
:url-api-classes-query-expression: {url-api-methods-expression-pfx}[IExpression]
:url-api-classes-query-expression-comparators: {url-api-methods-expression-pfx}[Expression Comparators]
:url-api-methods-expression-: {url-api-methods-expression-pfx}[Expression]

:url-api-methods-arrayfunction-pfx: {url-api-classes-query-pfx}ArrayFunction.html
:url-api-classes-query-arrayfunction: {url-api-methods-arrayfunction-pfx}[ArrayFunction]
:url-api-classes-query-arrayfunction-collection-ops: {url-api-methods-arrayfunction-pfx}[ArrayFunction Collection Operators]
