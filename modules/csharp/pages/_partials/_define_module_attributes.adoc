...
:url-issues: https://github.com/couchbase/couchbase-lite--csharp/issues
...
// :url-api-references2: {url-api-references-csharp}/api/Couchbase.Lite.
// :url-api-references-di: {url-api-references-csharp}/api/Couchbase.Lite.DI
// :url-api-references-entquery: {url-api-references-csharp}/api/Couchbase.Lite.Enterprise.Query
// :url-api-references-logging: {url-api-references-csharp}/api/Couchbase.Lite.Logging
// :url-api-references-log: {url-api-references-csharp}/api/Couchbase.Lite.Logging.Log.html
// :url-api-references-p2p: {url-api-references-csharp}/api/Couchbase.Lite.P2P
:url-api-references-query: {url-api-references-csharp}/api/Couchbase.Lite.Query
...
// :url-api-references-sync: {url-api-references-csharp}/api/Couchbase.Lite.Sync
:url-api-references-classes: {url-api-references-csharp}/api/Couchbase.Lite.
:url-api-references-enums: {url-api-references-csharp}/api/Couchbase.Lite.
// :url-api-references-classes-p2p: {url-api-references-csharp}/api/Couchbase.Lite.P2P.
// :url-api-references-classes-sync: {url-api-references-csharp}/api/Couchbase.Lite.Sync.
...
// :url-api-class-collection: {url-api-references-classes}{api-pfx}Collection.html[Collection]
// :url-api-method-collection: {url-api-references-classes}{api-pfx}Collection.html{sep}Couchbase_Lite_Collection_

// :url-api-method-collection-getdocument: {url-api-references-classes}{api-pfx}Collection.html{sep}Couchbase_Lite_Collection_GetDocument_System_String_[Collection.GetDocument()]
// :url-api-method-collection-save: {url-api-references-classes}{api-pfx}Collection.html{sep}Couchbase_Lite_Collection_Save_Couchbase_Lite_MutableDocument_[Collection.Save()]
...
:url-api-method-query-explain: {url-api-classes-query-pfx}{sep}Couchbase_Lite__Query_IQuery_Explain[Explain()]
:url-api-method-query-execute: {sep}Couchbase_Lite__Query_IQuery_Execute--[Execute()]
...
:url-api-method-function-lower: {url-api-classes-function-pfx}{sep}Couchbase_Lite_Query_Function_Lower_Couchbase_Lite_Query_IExpression_[Lower()]
:url-api-method-function-count: {url-api-classes-function-pfx}{sep}Couchbase_Lite_Query_Function_Count_Couchbase_Lite_Query_IExpression_[Count()]
...
// :url-api-references-p2p-classes: {url-api-references-csharp}/api/Couchbase.Lite.P2P..html[P2P Class index]

// URLENDPOINT CLASSES
:url-api-references-urlendpointlistener: {url-api-references-csharp}/api/Couchbase.Lite.P2P.{api-pfx}URLEndpointListener.html
...
:url-api-references-urlendpointlistener-property: {url-api-references-urlendpointlistener}{sep}Couchbase_Lite_P2P_URLEndpointListener_
// :url-api-method-urlendpointlistener-start: {url-api-references-urlendpointlistener}{sep}Couchbase_Lite_P2P_URLEndpointListener_Start[Start()]
...
:url-api-class-connection-status: {url-api-references-csharp}/api/Couchbase.Lite.P2P.{api-pfx}ConnectionStatus.html[ConnectionStatus]

:url-api-references-urlendpointconfiguration: {url-api-references-csharp}/api/Couchbase.Lite.P2P.{api-pfx}URLEndpointListenerConfiguration.html
:url-api-class-urlendpointconfiguration: {url-api-references-urlendpointconfiguration}[URLEndpointListenerConfiguration]

:url-api-references-tlsidentity: {url-api-references-csharp}/api/Couchbase.Lite.P2P.{api-pfx}TLSIdentity.html
...
:url-api-method-tls-identity-create: {url-api-references-tlsidentity}{sep}Couchbase_Lite_P2P_TLSIdentity_CreateIdentity_System_Boolean_System_Collections_Generic_Dictionary_System_String_System_String__System_Nullable_System_DateTimeOffset__System_Security_Cryptography_X509Certificates_X509Store_System_String_System_String_[CreateIdentity()]

// :url-api-method-tls-identity-delete: {url-api-references-tlsidentity}{sep}Couchbase_Lite_P2P_TLSIdentity_DeleteIdentity_System_Security_Cryptography_X509Certificates_X509Store_System_String_System_String_[DeleteIdentity()]

:url-api-method-tls-identity-get: {url-api-references-tlsidentity}{sep}Couchbase_Lite_P2P_TLSIdentity_GetIdentity_System_Security_Cryptography_X509Certificates_X509Store_System_String_System_String_[GetIdentity(X509Store, String, String)]

// :url-api-method-tls-identity-getcoln: {url-api-references-tlsidentity}{sep}Couchbase_Lite_P2P_TLSIdentity_GetIdentity_System_Security_Cryptography_X509Certificates_X509Certificate2Collection_[GetIdentity(X509Certificate2Collection)]

:url-api-method-tls-identity-import: {url-api-references-tlsidentity}{sep}Couchbase_Lite_P2P_TLSIdentity_ImportIdentity_System_Security_Cryptography_X509Certificates_X509Store_System_Byte___System_String_System_String_System_String_[ImportIdentity()]
...
:url-api-class-ListenerPasswordAuthenticator: {url-api-references-csharp}/api/Couchbase.Lite.P2P.{api-pfx}ListenerPasswordAuthenticator.html[ListenerPasswordAuthenticator]
:url-api-class-ListenerCertificateAuthenticator: {url-api-references-csharp}/api/Couchbase.Lite.P2P.{api-pfx}ListenerCertificateAuthenticator.html[ListenerCertificateAuthenticator]

// AUTHENTICATORS
:url-api-references-authenticator: {url-api-references-csharp}/api/Couchbase.Lite.Sync.{api-pfx}Authenticator.html
:url-api-class-authenticator: {url-api-references-authenticator}[Authenticator]

:url-api-references-basicauthenticator: {url-api-references-csharp}/api/Couchbase.Lite.Sync.{api-pfx}BasicAuthenticator.html
:url-api-class-basicauthenticator: {url-api-references-basicauthenticator}[BasicAuthenticator]

:url-api-references-cca-authenticator: {url-api-references-csharp}/api/Couchbase.Lite.P2P.{api-pfx}ClientCertificateAuthenticator.html
...
:url-api-references-replicator: {url-api-references-csharp}/api/Couchbase.Lite.Sync.{api-pfx}Replicator.html
...
// :url-api-references-replicator-abs: {url-api-references-csharp}/api/Couchbase.Lite.Sync.{api-pfx}AbstractReplicator.html
...
// REPLICATORSTATUS
:url-api-references-replicator-status: {url-api-references-csharp}/api/Couchbase.Lite.Sync.{api-pfx}ReplicatorStatus.html
...
:url-api-references-replicator-config: {url-api-references-csharp}/api/Couchbase.Lite.Sync.{api-pfx}ReplicatorConfiguration.html
...
:url-api-property-meta-revisionid: {url-api-references-meta}{sep}Couchbase_Lite_Query_Meta_RevisionID[Meta.revisionID]



// BEGIN Logs and logging references
:url-api-class-logging: {url-api-references-csharp}/api/Couchbase.Lite.Logging.html[Logging classes]
:url-api-references-class-log: {url-api-references-csharp}/api/Couchbase.Lite.Logging.Log.html
...
:url-api-class-log-console: {url-api-references-csharp}/api/Couchbase.Lite.Logging.IConsoleLogger.html[IConsoleLogger]
...
:url-api-iface-log-custom: {url-api-references-csharp}/api/Couchbase.Lite.Logging.ILogger.html[ILogger]
...
:url-api-references-class-log-file:  {url-api-references-csharp}/api/Couchbase.Lite.Logging.FileLogger.html
...
:url-api-enum-log-domain: {url-api-references-csharp}/api/Couchbase.Lite.Logging.LogDomain.html[LogDomain]
:url-api-enum-log-level: {url-api-references-csharp}/api/Couchbase.Lite.Logging.LogLevel.html[LogLevel]


:url-api-references-class-log-config: {url-api-references-csharp}/api/Couchbase.Lite.Logging.LogFileConfiguration.html
