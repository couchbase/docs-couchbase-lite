...
include::{root-partials}pn-issues-list-litecore.adoc[tag=enhancements-2-8-6-net]
...
==== Fixed
// tag::fixed-2-8-6-net[]
include::{root-partials}pn-issues-list-litecore.adoc[tag=fixed-2-8-6-net]

// * https://issues.couchbase.com/browse/CBL-1984[CBL-1984] -- https://issues.couchbase.com/browse/CBL-1984[Backport --  Support domain specific server authentication]
// * https://issues.couchbase.com/browse/CBL-2001[CBL-2001] -- https://issues.couchbase.com/browse/CBL-2001[Backport --  Android v30 compatibility to 2.8.6]
// * https://issues.couchbase.com/browse/CBL-2037[CBL-2037] -- https://issues.couchbase.com/browse/CBL-2037[Core pool size is too small]
* https://issues.couchbase.com/browse/CBL-2108[CBL-2108] -- https://issues.couchbase.com/browse/CBL-2108[Backport --  Fix memory leak in WebSocketWrapper]
* https://issues.couchbase.com/browse/CBL-2109[CBL-2109] -- https://issues.couchbase.com/browse/CBL-2109[Backport --  SetPrivateKey failed in .Net Framework ]
* https://issues.couchbase.com/browse/CBL-2110[CBL-2110] -- https://issues.couchbase.com/browse/CBL-2110[Backport --  Memory leak when calling MutableArrayObject.AddBlob]
* https://issues.couchbase.com/browse/CBL-2120[CBL-2120] -- https://issues.couchbase.com/browse/CBL-2120[Retain c4socket when WebSocket starts and a release c4socket after c4socket is closed]

// end::fixed-2-8-6-net[]

==== Known Issues
// tag::knownissues-2-8-6-net[]
include::{root-partials}pn-issues-list-litecore.adoc[tag=knownissues-2-8-6-net]
...
* https://issues.couchbase.com/browse/CBL-1579[CBL-1579] -- https://issues.couchbase.com/browse/CBL-1579[Add replication heartbeat]
...
* https://issues.couchbase.com/browse/CBL-1476[CBL-1476] -- https://issues.couchbase.com/browse/CBL-1476[Add Support For DNS Proxy Addresses]
