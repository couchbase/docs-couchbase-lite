...
// include::csharp:example$code_snippets/Program.cs[tag=listener,indent=0]
[source]
----
...
// include::csharp:example$code_snippets/Program.cs[tag=message-endpoint,indent=0]
[source]
----
...
// include::csharp:example$code_snippets/Program.cs[tag=message-endpoint-replicator,indent=0]
[source]
----
...
// include::csharp:example$code_snippets/Program.cs[tag=create-connection,indent=0]
...
// include::csharp:example$code_snippets/Program.cs[tag=active-peer-open,indent=0]
[source]
----
...
// include::csharp:example$code_snippets/Program.cs[tag=advertizer-accept,indent=0]
[source]
----
...
// include::csharp:example$code_snippets/Program.cs[tag=passive-peer-open,indent=0]
[source]
----
/* implementation of MessageEndpointConnection */
...
// include::csharp:example$code_snippets/Program.cs[tag=active-peer-send,indent=0]
[source]
----
/* implementation of MessageEndpointConnection */
...
// include::csharp:example$code_snippets/Program.cs[tag=active-peer-receive,indent=0]
[source]
----
...
// include::csharp:example$code_snippets/Program.cs[tag=passive-peer-send,indent=0]
[source]
----
/* implementation of MessageEndpointConnection */
public async Task Send(Message message)
...
// include::csharp:example$code_snippets/Program.cs[tag=passive-peer-receive,indent=0]
[source]
----
var message = Message.FromBytes(data);
_replicatorConnection?.Receive(message);
...
// include::csharp:example$code_snippets/Program.cs[tag=active-replicator-close,indent=0]
[source]
----
...
// include::csharp:example$code_snippets/Program.cs[tag=active-peer-close,indent=0]
[source]
----
/* implementation of MessageEndpointConnection */
...
// include::csharp:example$code_snippets/Program.cs[tag=passive-replicator-close,indent=0]
[source]
----
_replicatorConnection?.Close(null);
----
...
// include::csharp:example$code_snippets/Program.cs[tag=passive-peer-close,indent=0]
[source]
----
/* implementation of MessageEndpointConnection */
public async Task Close(Exception error)
...
// include::csharp:example$code_snippets/Program.cs[tag=passive-stop-listener,indent=0]
[source]
----
...
[.column#csharp:p2psync-custom:::-2]
=== {empty}
.Concepts
...
[.column#csharp:p2psync-custom:::-3]
=== {empty}
.Community Resources ...
