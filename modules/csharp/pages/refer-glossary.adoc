...
:page-role: -toc
:page-aliases: glossary, refer/csharp-refer-glossary.adoc
...
== Index
[.pane__frame--blue]
xref:csharp:refer-glossary.adoc#a[]  |  xref:B>>  |  <<csharp:refer-glossary.adoc#c[]  |  xref:csharp:refer-glossary.adoc#d[]  |  xref:E>>  |  <<F>>  |  <<G>>  |  <<H>>  |  <<csharp:refer-glossary.adoc#i[]  |  xref:J>>  |  <<K>>  |  <<csharp:refer-glossary.adoc#l[]  |  xref:M>>  |  <<csharp:refer-glossary.adoc#n[]  |  xref:O>>  |  <<csharp:refer-glossary.adoc#p[]  |  xref:Q>>  |  <<csharp:refer-glossary.adoc#r[]  |  xref:csharp:refer-glossary.adoc#s[]  |  xref:csharp:refer-glossary.adoc#t[]  |  <<U>>  |  <<V>>  |  <<W>>  |  <<X>>  |  <<Y>>  |  <<Z>>
...
* _Related Term(s)_: xref:csharp:refer-glossary.adoc#passive-peer[] xref:csharp:refer-glossary.adoc#peer-to-peer-sync[]
* _Read More_: xref:csharp:landing-p2psync.adoc[Peer-to-Peer Sync]
...
[[csharp:refer-glossary:::checkpoint]]Checkpoint::
...
Back to xref:csharp:refer-glossary.adoc#index[]
...
// tag::cbl-delta-sync[]
// tag::cbl-delta-sync-def[]
* _Related Term(s)_: xref:csharp:refer-glossary.adoc#passive-replicator[Passive replicator]
* _Read More_: xref:csharp:replication.adoc#delta-sync[Delta Sync]
// tag::cbl-delta-sync-full[]
...
* _Related Term(s)_: xref:csharp:refer-glossary.adoc#active-peer[], xref:csharp:refer-glossary.adoc#peer-to-peer-sync[]
* _Read More_: xref:csharp:landing-p2psync.adoc[Peer-to-Peer Sync]
// end::cbl-passive-peer[]
...
* _Related Term(s)_: xref:csharp:refer-glossary.adoc#active-peer[] xref:csharp:refer-glossary.adoc#passive-peer[]
* _Read More_: xref:csharp:landing-p2psync.adoc[Peer-to-Peer Sync]
...
* _Related Term(s)_: xref:csharp:refer-glossary.adoc#active-peer[] xref:csharp:refer-glossary.adoc#passive-peer[]
* _Read More_: xref:csharp:p2psync-websocket.adoc[Peer-to-Peer]
