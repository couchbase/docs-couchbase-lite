...
Optionally, existing conflicts in the 1.x database can be resolved with the https://docs-archive.couchbase.com/couchbase-lite/1.4/clang.html#resolving-conflicts[1.x API] prior to the database being upgraded to 2.0.
