...
:packageNm: couchbase-lite-clang
:url-issues: {url-issues-clang}
...
:url-api-references: {url-api-references-clang}
...
:url-api-references-clang-sep: {sep}c:clang(cs)
...
:url-api-method-database: {url-api-references-database}{url-api-references-clang-sep}{api-pfx}Database(im)
...
:url-api-method-database-copy: {url-api-references-database}{url-api-references-clang-sep}CBLDatabase(cm)copyFromPath:toDatabase:withConfig:error:[copyFromPath()]
...
:url-api-method-database-setloglevel: {url-api-references-database}{sep}c:clang(cs)CBLDatabase(cm)setLogLevel:domain:[{api-pfx}Database.setLogLevel()]
...
:url-api-method-query-explain: {url-api-classes-query-pfx}{url-api-references-clang-sep}CBLQuery(im)explain:[explain()]
...
:url-api-method-expression-like: {url-api-method-expression-pfx}c:clang(cs)CBLQueryExpression(im)like:[Like()]
:url-api-method-expression-collate: {url-api-method-expression-pfx}c:clang(cs)CBLQueryExpression(im)collate:[Collate()]
...
:url-api-method-function-lower: {url-api-classes-function-pfx}{url-api-references-clang-sep}CBLQueryFunction(cm)lower:[lower()]
:url-api-method-function-count: {url-api-classes-function-pfx}{url-api-references-clang-sep}CBLQueryFunction(cm)count:[count()]
...
:url-api-references-urlendpointlistener-property: {url-api-references-urlendpointlistener}{url-api-references-clang-sep}CBLURLEndpointListener(py)
...
:url-api-method-tls-identity-import: {url-api-references-tlsidentity}{url-api-references-clang-sep}{api-pfx}TLSIdentity(cm)importIdentityWithData:password:label:error:[importIdentity(withData:password:label:error:)]

:url-api-method-tls-identity-create: {url-api-references-tlsidentity}{url-api-references-clang-sep}{api-pfx}TLSIdentity(cm)createIdentityForServer:attributes:expiration:label:error:[createIdentity()]

:url-api-method-tls-identity-get: {url-api-references-tlsidentity}{url-api-references-clang-sep}{api-pfx}TLSIdentity(cm)identityWithLabel:error:[identityWithLabel:error]

:url-api-method-tls-identity-get-withId: {url-api-references-tlsidentity}{url-api-references-clang-sep}{api-pfx}TLSIdentity(cm)identityWithIdentity:certs:error:[identityWithIdentity:certs:error]

:url-api-class-urlendpointconfiguration: {url-api-references-urlendpointconfiguration}[URLEndpointListenerConfiguration]

:url-api-references-urlendpointconfiguration-property: {url-api-references-urlendpointconfiguration}{url-api-references-clang-sep}{api-pfx}URLEndpointListenerConfiguration
...
:url-api-properties-replicator: {url-api-references-replicator}{url-api-references-clang-sep}{api-pfx}Replicator
...
//:url-api-property-replicator-status-activity: {url-api-references-replicator}{sep}s:18CouchbaseLiteclang10ReplicatorC13ActivityLevelO
...
:url-api-properties-replicator-status: {url-api-references-replicator-status}{url-api-references-clang-sep}{api-pfx}ReplicatorStatus
...
:url-api-references-replicator-config-prop: {url-api-references-replicator-config}{url-api-references-clang-sep}{api-pfx}ReplicatorConfiguration
...
:url-api-property-meta-revisionid: {url-api-references-meta}{url-api-references-clang-sep}CBLQueryMeta(cm)revisionID[{api-pfx}QueryMeta.revisionID]
...
:url-api-class-log-prop-file: {url-api-references-class-log}{url-api-references-clang-sep}CBLLog(py)file[{api-pfx}Log.file]
:url-api-class-log-prop-custom: {url-api-references-class-log}{url-api-references-clang-sep}CBLLog(py)custom[{api-pfx}Log.custom]
...
:url-api-class-log-console-getcons: {url-api-references-class-log}{url-api-references-clang-sep}CBLLog(py)console[{api-pfx}Log.console]
:url-api-class-log-console-getcons-setlvl: {url-api-references-class-log-cons}{url-api-references-clang-sep}CBLConsoleLogger(py)level[{api-pfx}Log.console.level]
:url-api-class-log-console-getcons-setdmn: {url-api-references-class-log-cons}{url-api-references-clang-sep}CBLConsoleLogger(py)domains[{api-pfx}Log.console.domains]
...
:url-api-class-log-custom-getcust: {url-api-references-class-log}{url-api-references-clang-sep}CBLLog(py)custom[{api-pfx}Log.custom]
:url-api-class-log-custom-setcust: {url-api-references-class-log}{url-api-references-clang-sep}CBLLog(py)custom[{api-pfx}Log.custom]
:url-api-class-log-custom-getcust-setlvl: {url-api-references-class-log-cust}{url-api-references-clang-sep}CBLLogger(py)level[{api-pfx}Log.custom.setLevel()]
:url-api-class-log-custom-getfile-logmsg: {url-api-references-class-log-cust}{url-api-references-clang-sep})CBLLogger(im)logWithLevel:domain:message:[{api-pfx}Log(logWithlevel:,domain:, message:)]
...
:url-api-class-log-file-getfile: {url-api-references-class-log}{url-api-references-clang-sep}CBLLog(py)file[{api-pfx}Log.file]
:url-api-class-log-file-getfile-setcfg: {url-api-references-class-log-file}{url-api-references-clang-sep}CBLFileLogger(py)config[{api-pfx}Log.file.config: LogConfiguration(directory:)]
:url-api-class-log-file-getfile-setlvl: {url-api-references-class-log-file}{url-api-references-clang-sep})CBLFileLogger(py)level[{api-pfx}Log.file.level: LogLevel]

:url-api-class-log-file-getfile-logmsg: {url-api-references-class-log}{url-api-references-clang-sep}[{api-pfx}Log(level: LogLevel, domain: LogDomain, message: String)]
...
:url-api-class-log-config-props: {url-api-references-class-log-config}{url-api-references-clang-sep}
