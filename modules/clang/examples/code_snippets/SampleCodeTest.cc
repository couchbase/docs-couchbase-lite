/*
  The code snippet in this file need to be refactored for C
  This initial part is drawn from engineer written examples.

  Please retain tag structure when refactoring.
*/
...
/* The `tag::replication[]` example is inlined in clang.adoc */
...
- (void) dontTestCreateSelfSignedCert {
    ...
    // <site-rooot>/clang/advance/clang-p2psync-websocket-using-passive.html
    // Example-6
...
/*
  The remaining code comprises snippets I have put together.
  They mostly relate to P2P Replication
  They are not necessarily compilable as they stand.
  Please retain tags when refactoring.
*/


- void ibListenerSimple {
  // tag::listener-simple[]
...
- void ibGetNeworkInterfaces {
  // Identify and list availble network interfaces
...
- void ibListenerConfigClientAuthRoot {
// EXAMPLE 8
// tag::listener-config-client-auth-root[]
...
- void ibListenerConfigClientAuthLambda {
  // tag::listener-config-client-auth-lambda[]
...
@synthesize replicator=_replicator;
  ...
  - (void) startReplication {
      ...
      CBLURLEndpoint *target =
        [[CBLURLEndpoint alloc] initWithURL: url];
      CBLReplicatorConfiguration *config =
        [[CBLReplicatorConfiguration alloc] initWithDatabase:_database
                                                                                        target:target];
...
- void ibSyncGatewayReplicatorInitialize {
