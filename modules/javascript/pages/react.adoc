...
Couchbase Lite Enterprise Edition for React Native is a Native Module implementation using TypeScript.
...
You can find information on the prerequisites and setup, including Expo configuration at https://cbl-reactnative.dev/StartHere/prerequisites[Prerequisites].
