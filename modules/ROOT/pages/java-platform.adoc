...
[source,groovy]
----
include::partial$gsBuildGradle.adoc[tag=compileOptions]
----
Dependencies
+
[source,groovy]
----
include::partial$gsBuildGradle.adoc[tag=dependenciesCE]
----
...
[source,groovy]
----
include::partial$gsBuildGradle.adoc[tag=dependencies]
----
Repositories
+
[source,groovy]
----
include::partial$gsBuildGradle.adoc[tag=repositories]
----
...
----
include::partial$gsBuildGradle.adoc[tag=allContent]
----
