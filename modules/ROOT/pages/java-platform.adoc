...
:snippet-java-platform: {examplesdir}/java/src/com/couchbase/code_snippets/Examples.java
...
NOTE: In our examples here we are using the _IntelliJ IDEA CE_ IDE.
This is not an endorsement or otherwise of this product.
You are free to use the IDE of your choice.

Create a new *command line app* in the IDE of your choice.
