...
The tutorial shows how to build an app that allows users to search and bookmark hotels using data loaded from a Couchbase Lite database -- see tutorial at https://ionic.io/docs/couchbase-lite/tutorials/hotel-search[tutorial/to/be/created/for/3.0.GA].
...
*resolve link* <<Reach out to Ionic sales to get access, either from the docs page or this landing page>>
****
