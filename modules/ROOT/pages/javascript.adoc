...
You can develop your own https://electronjs.org[Electron.js] wrapper on top of https://docs.couchbase.com/couchbase-lite/2.7/csharp.html[Couchbase Lite’s .NET] API.
