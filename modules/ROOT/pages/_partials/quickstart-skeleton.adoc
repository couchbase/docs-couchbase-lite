...
** https://docs.couchbase.com/mobile/{major}.{minor}.{base}-{releasetag}/couchbase-lite-android[Java/Kotlin API]
** https://docs.couchbase.com/mobile/{major}.{minor}.{base}-{releasetag}/couchbase-lite-android-ktx[Kotlin Extension API]
endif::is-android[]
...
* xref:{param-module}:query-n1ql-mobile.adoc[N1QL for Mobile]
