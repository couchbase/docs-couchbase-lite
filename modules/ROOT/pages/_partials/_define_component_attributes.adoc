XXX _define_component_attributes.adoc
...
:version-maintenance-swift: {major}.{minor}.{maintenance-swift}{tag}

// vs-version-maintenance is the full version including maintenance release number of VECTOR SEARCH EXTENSION.
// Note that the maintenance release is set at module level in the `_define_module_attributes.adoc` file
// here at component level it is always same as version-full
:vs-version-maintenance-android: {vs-major}.{vs-minor}.{vs-maintenance-android}{tag}
:vs-version-maintenance-c: {vs-major}.{vs-minor}.{vs-maintenance-c}{tag}
:vs-version-maintenance-net: {vs-major}.{vs-minor}.{vs-maintenance-net}{tag}
:vs-version-maintenance-java: {vs-major}.{vs-minor}.{vs-maintenance-java}{tag}
:vs-version-maintenance-ios: {vs-major}.{vs-minor}.{vs-maintenance-ios}{tag}
:vs-version-maintenance-swift: {vs-major}.{vs-minor}.{vs-maintenance-swift}{tag}
...
:!is-live:
:!is-beta:
:url-api-references-staging: https://docs.couchbase.com/mobile/
...
:url-api-references-swift: {url-api-references-pfx}{version-maintenance-swift}/couchbase-lite-{lang-mod-swift}
