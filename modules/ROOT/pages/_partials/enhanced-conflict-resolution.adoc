...
In version 2.5 and earlier, by default, Couchbase Lite uses last-write-win concurrency control to handle a conflict when saving a document.
...
The following example invokes this method.
