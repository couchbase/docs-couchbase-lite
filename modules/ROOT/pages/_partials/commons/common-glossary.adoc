...
* _Read More_: {cbl--xref} landing-p2psync.adoc[Peer-to-Peer Sync]
...
* _Read More_: {cbl--xref} replication.adoc#delta-sync[Delta Sync]
// tag::cbl-delta-sync-full[]
...
* _Related Term(s)_: <<active-peer>> <<passive-peer>>
* _Read More_: {cbl--xref} p2psync-websocket.adoc[Peer-to-Peer]
