...
This maintenance release addresses a backward-compatibility issue (https://issues.couchbase.com/browse/CBL-1406[CBL-1406]), which affects:

* Couchbase Lite on Java
* Couchbase Lite on Android (Java)

If you develop apps using those products, and those apps could potentially access databases created by a mix of Release 2.7 and Release 2.8 versions, then you should apply Release 2.8.1 as soon as practicable.
