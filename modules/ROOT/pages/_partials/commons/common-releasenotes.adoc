...
[#maint-2.8.5]
== 2.8.5 -- March 2021
Version 2.8.5 of Couchbase Lite for {param-title} delivers a fix that removes a blocking, but extraneous, Kotlin dependency.
This avoids any potential clash with an installed Kotlin version.
