...
.Release Notes for Couchbase Lite on {param-title} {version}
ifndef::i-c[]
_Quick Links_::
 <<new-features-3-0-0>> *|* <<improvements-3-0-0>> *|* <<issues-and-resolutions-3-0-0>> *|* <<support-notices-3-0-0>> *|* <<Related Content>>
endif::is-c[]
...
// tag::api-changes[]
include::api-changes[tag=content, leveloffset=+2]
