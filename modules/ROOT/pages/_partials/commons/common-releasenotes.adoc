...
// Begin -- Release 3-0-1 (All) -- March 2022
ifdef::param-3-0-1[]
...
Version 3.0.1 of Couchbase Lite for {param-title} delivers a number of fixes
ifdef::is-ios[ and enhancements]
.

=== Enhancements
ifdef::is-ios[]

Couchbase Lite for {param-title} provides an enhancement to the Replicator Configuration API, which now allows you to specify the network interface to use for connecting to the remote target (for example, `en0` or `pdp_ip0`) -- see:
...
// End -- Release 3-0-1 (All) -- Mar 2021
