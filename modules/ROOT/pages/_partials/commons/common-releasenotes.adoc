...
Couchbase Lite on {param-title} 2.8.1, supersedes version 2.8.0, which was released in October 2020.
It addresses a backward-compatibility issue (https://issues.couchbase.com/browse/CBL-1406[CBL-1406]).
