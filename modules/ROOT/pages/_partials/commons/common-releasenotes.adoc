...
ifdef::param-3-0-5[]
// Set release number
:param-release-tag: -3-0-5

[#maint-latest]
[#maint-3-0-5]
== 3.0.5 -- November 2022

Version 3.0.5 of Couchbase Lite for {param-title} delivers a number of fixes and enhancements.

=== Enhancements

include::{module-partials}pn-issues-list.adoc[tag=Enhancements{param-release-tag}]

[#issues-and-resolutions-3-0-5]
...
:param-link: xref:{param-module}:query-n1ql-mobile.adoc[{sqlpp_cbm} for Mobile]
