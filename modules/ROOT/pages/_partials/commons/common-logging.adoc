...
:tslinks: {cbl--xref} troubleshooting-queries.adoc[Troubleshooting Queries]
ifdef::is-ios[]
:tslinks: {tslinks} | {cbl--xref} troubleshooting-crashes.adoc[Decoding Crash Logs]
endif::[]
...
----
wget https://packages.couchbase.com/releases/couchbase-lite-log/{cbl-log-version}/couchbase-lite-log-{cbl-log-version}-macos.zip
----
...
[source,console, subs="attributes"]
----
wget https://packages.couchbase.com/releases/couchbase-lite-log/{cbl-log-version}/couchbase-lite-log-{cbl-log-version}-centos.zip
----
...
----
Invoke-WebRequest https://packages.couchbase.com/releases/couchbase-lite-log/{cbl-log-version}/couchbase-lite-log-{cbl-log-version}-windows.zip -OutFile couchbase-lite-log-{cbl-log-version}-windows.zip
----
...
.Deprecation
[NOTE]
include::ROOT:partial$block-deprecations.adoc[tag=logging25]
