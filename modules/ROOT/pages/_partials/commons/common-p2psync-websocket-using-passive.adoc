...
:param-leader: pass:q,a[Create a TLSIdentity for the server using convenience API.  The system generates a self-signed certificate.]
include::{root-partials}block_tabbed_code_example.adoc[]
...
:param-leader: pass:q,a[This example uses an _anonymous_ self signed certificate.  Generated certificates are held in {securestorage}.]
include::{root-partials}block_tabbed_code_example.adoc[]
