...
include::{module-partials}_callouts.adoc[tags=listener-initialize]
...
include::{module-partials}_callouts.adoc[tags=listener-start, indent=0]
...
// include::{example_callouts.adoc[tags=listener-status-check, indent=0]
include::{module-partials}_callouts.adoc[tags=listener-status-check, indent=0]
