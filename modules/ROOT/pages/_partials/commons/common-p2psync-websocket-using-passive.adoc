...
Note that the server must always authenticate itself with the client -- see {xref-cbl-bmk-dbo-p2psync-websocket-using-active-auth-listener} for how the client deals with this.
