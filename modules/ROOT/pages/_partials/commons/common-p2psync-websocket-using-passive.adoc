...
<.> Get keypair data
<.> Use keypair data to create and store the TLS identity
...
* Basic Authentication -- uses the {url-api-class-ListenerPasswordAuthenticator} to authenticate the client using the client-supplied username and password.
