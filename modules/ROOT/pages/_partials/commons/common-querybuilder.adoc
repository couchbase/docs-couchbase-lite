...
Couchbase Lite for {param-title} provides two ways to build and run database queries; the QueryBuilder API described in this topic and {cbl--xref} query-n1ql-mobile.adoc[{sqlpp} for Mobile].
...
ifdef::fnref_2x5[footnote:fn2x5[]]
...
include::ROOT:example$query-snippets.adoc[tags=query-result-format-count]
