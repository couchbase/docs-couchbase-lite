...
The result set produced by N1QL and {querybuilder--xref)} queries is the same -- see <<lbl-resultsets>>.
...
----
include::{snippet}[tags=query-syntax-n1ql-params, indent=0]
----
...
// [{json-snippet}]
// ----
// include::{root-examples}query-snippets.adoc[tag=n1ql-result-format-props]
// ----

// .Code to Create Index
// [{code-snippet}]
// ----
// include::{snippet}[tag=n1ql-index,indent=0]
// ----
// ====
...
// include::{snippet}[tag=n1ql-join,indent=0]
[source, sql]
----
SELECT * FROM travel-sample r JOIN travel-sample a ON r.airlineid = a.meta.id WHERE a.country = "France"
...
// [{code-snippet}]
// ----
// include::{snippet}[tag=n1ql-groupby,indent=0]
// ----
// ====
...
// .Query using OrderBy
// ====
// This example returns documents of type equal to "hotel" sorted in ascending order by the value of the title property.

// [{code-snippet}]
// ----
// include::{snippet}[tag=n1ql-orderby,indent=0]
// ----
// ====
...
// [{code-snippet}]
// ----
// include::{snippet}[tag=n1ql-where,indent=0]
// ----
