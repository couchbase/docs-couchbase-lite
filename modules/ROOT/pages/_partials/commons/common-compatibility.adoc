...
:param-related: {xref-cbl-pg-whatsnew}  |  {xref-cbl-pg-release-notes} | {xref-cbl-pg-supported-os}
...
|xref:2.8@couchbase-lite:swift:product/swift-supported-os.adoc[link]
...
|xref:2.8@couchbase-lite:java:product/java-supported-os.adoc[link]
...
|xref:2.8@couchbase-lite:android:product/java-android-supported-os.adoc[link]
...
|xref:2.8@couchbase-lite:csharp:product/csharp-supported-os.adoc[link]
|===
