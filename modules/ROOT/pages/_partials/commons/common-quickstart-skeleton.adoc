...
** https://docs.couchbase.com/mobile/{major}.{minor}.{maintenance-android}/couchbase-lite-android[API References]
** https://docs.couchbase.com/mobile/{major}.{minor}.{maintenance-android}/couchbase-lite-android-ktx[Kotlin Extensions]
endif::is-android[]
