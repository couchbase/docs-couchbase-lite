...
In addition, if you are syncing with a 3.0.0-beta01 Sync Gateway, you should be aware of the significant configuration enhancements introduced and their impact.
This is a one-way conversion.

== API Changes at BETA 3.0.0

include::{module-partials}api-changes.adoc[tag=content, level-offset=+1]
