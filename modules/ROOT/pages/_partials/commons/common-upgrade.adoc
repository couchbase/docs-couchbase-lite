...
This functionality is related to the way conflicts are now being handled in Couchbase Lite -- see {cbl--xref} conflict.adoc[Handling Data Conflicts].
...
* Install the Couchbase Lite 2.0 framework in your project  -- see {cbl--xref} gs-install.adoc[Install].
