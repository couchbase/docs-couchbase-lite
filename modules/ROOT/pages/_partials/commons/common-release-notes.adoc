...
// BEGIN: Decide which releases are relevant for which platform
//
// .NET Maintenance Releases
...
// BEGIN -- Release 2.8.6 (.NET only) -- Aug 2021
ifdef::param-2-8-6-net[]

[#maint-latest]
[#maint-2.8.6-net]
== 2.8.6 -- August 2021
Version 2.8.6 of Couchbase Lite for {param-title} delivers fixes that improve security and performance; specifically resolving memory leak issues.

// === Enhancements

// include::{module-partials}pn-issues-list.adoc[tag=enhancements-2-8-6-net]


[#issues-and-resolutions-2-8-6-net]
=== Issues and Resolutions
==== Fixed Issues
include::{module-partials}pn-issues-list.adoc[tag=fixed-2-8-6-net]

==== Known Issues

include::{module-partials}pn-issues-list.adoc[tag=knownissues-2-8-6-net]


endif::[]
// END -- Release 2.8.6 (.NET-only) -- Aug 2021



// BEGIN -- Release 2.8.6 (Android-only) -- Mar 2021
ifdef::param-2-8-6[]

[#maint-latest]
[#maint-2.8.6]
== 2.8.6 -- July 2021
Version 2.8.6 of Couchbase Lite for {param-title} delivers:
...
include::{module-partials}pn-issues-list.adoc[tag=enhancements-2-8-6]


[#issues-and-resolutions-2-8-6]
=== Issues and Resolutions
==== Fixed Issues
include::{module-partials}pn-issues-list.adoc[tag=fixed-2-8-6]

==== Known Issues

include::{module-partials}pn-issues-list.adoc[tag=knownissues-2-8-6]


endif::[]
// END -- Release 2.8.6 (Android-only) -- Jul 2021
...
:param-link1: {landing-p2psync--xref}
...
// END inclusion commons-release-notes.adoc
