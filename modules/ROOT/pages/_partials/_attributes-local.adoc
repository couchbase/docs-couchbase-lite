...
// BEGIN Product versions
ifndef::maintenance[:maintenance: 4]
ifndef::api-vn[:api-vn: 4]
ifndef::version[:version: {major}.{minor}]
ifndef::version-full[:version-full: {major}.{minor}.0]
ifndef::version-maintenance[:version-maintenance: {major}.{minor}.{maintenance}]
ifndef::version-api[:version-api: {major}.{minor}.{api-vn}]
...
// API Reference Links
:url-api-references-staging: https://ibsoln.github.io/stage/api/mobile/{version-api}/couchbase-lite-
:url-api-references-beta: https://ibsoln.github.io/betasites/api/mobile/{version-api}/couchbase-lite-
:url-api-references-production: http://docs.couchbase.com/mobile/{version-api}/couchbase-lite-
