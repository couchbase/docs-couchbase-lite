...
:url-api-references-beta: http://docs.couchbase.com/mobile/{releasetag}/couchbase-lite-
...
:url-api-references-kotlin: {url-api-references-pfx}{lang-mod-android}-ee-kt
