...
This optimized implementation is ensured feature parity with our other Couchbase Lite platforms and is supported on a wide-range of mobile and desktop platforms -- see: xref:c:supported-os.adoc[Supported Platfroms].
