...
|macOS
|ARM-64 (Apple Silicon), x86-64
|Apple OS X v10.14 (Mojave)
|


|Windows - UWP
|ARM-64, ARM-32, x86-64
|10.0.16299
|
...
|Embedded Linux
|ARM-32 (ARMv7), ARM-64 (ARMv8)
Raspberry Pi 4 B (Cortex-A72, ARMv8a, 64-bit, 2GB RAM)
Raspberry Pi 3 A+ (Cortex-A53, ARMv8a, 64-bit, 512MB RAM)
Raspberry Pi 2 B  (Cortex-A7, ARMv7a, 32-bit, 1GB RAM)
|Debian{nbsp}9
|Raspbian is substitute

|Linux barebones kernel
|ARM-32 (ARMv7), ARM-64 (ARMv8)
|ARCH Linux ARM?
|
...
|Storage
|Driven by user data storage needs
