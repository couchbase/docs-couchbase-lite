...
:cbl-pg-dbo-p2psync-websocket-using: advance/{param-name}-p2psync-websocket-using.adoc
...
:xref-cbl-pg-dbo-p2psync-websocket-using: {xref-pfx-cbl}{cbl-pg-dbo-p2psync-websocket-using}[Using peer-to-peer sync over websockets]
:xref-cbl-pg-dbo-p2psync-cloud-using: {xref-pfx-cbl}{cbl-pg-dbo-p2psync-cloud-using}[Using peer-to-peer sync over cloud]
