...
:xref-cbl-pg-tutorial-p2psync: xref:tutorials:cbl-p2p-sync-websockets:{param-module}/cbl-p2p-sync-websockets.adoc[Getting Started with Peer-to-Peer Sync]
...
:xref-cbl-pg-p2psync-websocket: {xref-cbl-ref-p2psync-websocket}[Peer-to-peer sync over web sockets]
