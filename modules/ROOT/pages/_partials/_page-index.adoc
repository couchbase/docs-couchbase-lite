...
:xref-cbl-pg-releasenotes-all: xref:couchbase-lite:swift:product/swift-releasenotes.adoc[Swift]  |  xref:couchbase-lite:objc:product/objc-releasenotes.adoc[Objective-C]  |  xref:couchbase-lite:java:product/java-releasenotes.adoc[Java]  |  xref:couchbase-lite:android:product/java-android-releasenotes.adoc[Android (Java)]  |  xref:couchbase-lite:csharp:product/csharp-releasenotes.adoc[C#.Net]
