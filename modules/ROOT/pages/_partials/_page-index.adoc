...
:xref-cbl-pg-tutorial-p2psync: xref:tutorials:cbl-p2p-sync-websockets:{param-module}/cbl-p2p-sync-websockets.adoc[Getting Started with Peer-to-Peer Synchronization]
...
:xref-cbl-ref-dbo-p2psync-websocket-using-active: {xref-pfx-cbl}{cbl-pg-dbo-p2psync-websocket-using-active}
:xref-cbl-pg-dbo-p2psync-websocket-using-active: {xref-cbl-ref-dbo-p2psync-websocket-using-active}[Active Peer]
:xref-cbl-bmk-dbo-p2psync-websocket-using-active-auth-listener: {xref-cbl-ref-dbo-p2psync-websocket-using-active}#authenticating-the-listener[Active Peer - authenticating the listener]
...
:xref-cbl-ref-database: {xref-pfx-cbl}{cbl-pg-database}
:xref-cbl-pg-database: {xref-cbl-ref-database}[Databases]
:xref-cbl-bmk-database-findfile: {xref-cbl-ref-database}#finding-a-database-file[Finding a Database File]
...
:xref-cbl-ref-p2psync-websocket: {xref-pfx-cbl}{cbl-pg-p2psync-websocket}
:xref-cbl-pg-p2psync-websocket: {xref-cbl-ref-p2psync-websocket}[Peer-to-Peer Synchronization over web sockets]
:xref-cbl-pg-p2psync-websocket-using-secure-storage: {xref-cbl-ref-p2psync-websocket}#using-secure-storage[Using secure storage]
...
:xref-cbl-pg-releasenotes: {xref-pfx-cbl}{cbl-pg-releasenotes}[Release Notes]
:xref-cbl-ref-replication: {xref-pfx-cbl}{cbl-pg-replication}
:xref-cbl-pg-replication: {xref-cbl-ref-replication}[Sync{nbsp}Gateway Replications]
:xref-cbl-bmk-replication-deltasync: {xref-cbl-ref-replication}#delta-sync[Delta-Sync Replications]
