...
:database--pfx: {cbl--xref}{database--page}
:database--xref: {database--pfx}[Database]
:database--xref--bmk--findfile: {database--pfx}#lbl-find-db-loc[Finding a Database File]
...
// :get-started-install--xref: {sgw--xref}{get-started-install--page}[Install Sync Gateway]
:load-balancer--xref: {sgw--xref}{load-balancer--page}[Load Balancer]
:load-balancer--xref-bmk-keepalive: {sgw--xref}{load-balancer--page}#lbl-keepalive[Load Balancer - Keep Alive]
:get-started-prepare--xref-bmk-createuser: {sgw--xref}{get-started-prepare--page-bmk-createuser}[Create an RBAC User]
:get-started-prepare--xref-bmk-createbucket: {sgw--xref}{get-started-prepare--page-bmk-createbucket}[Create a Bucket]
