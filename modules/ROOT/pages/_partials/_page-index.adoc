...
:cbl-pg-dbo-p2psync-websocket: advance/{param-name}-dbo-p2psync-websocket.adoc
...
:xref-cbl-pg-dbo-p2psync-websocket: {xref-pfx-cbl}{cbl-pg-dbo-p2psync-websocket}[Using P2P sync]
