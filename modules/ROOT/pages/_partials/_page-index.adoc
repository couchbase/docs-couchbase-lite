...
:xref-cbl-pg-dbreplica: {xref-pfx-cbl}{cbl-pg-dbreplica}[Intra-device Replication]
...
:xref-cbl-pg-landing-p2psync: {xref-cbl-pfx-p2psync-websocket}[Peer-to-Peer Device Sync]
...
:xref-cbl-pg-p2psync-websocket: {xref-cbl-pfx-p2psync-websocket}[Peer-to-Peer Device Sync]
