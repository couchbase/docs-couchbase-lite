...
:p2psync-websocket-using-passive--page: {p2psync-websocket-using-passive--page}
...
:landing-p2psync--xref: {p2psync-websocket--pfx}[Peer-to-Peer Data Sync]
...
:xref-sgw-pg-install: {sgw--xref}{sgw-pg-install}[Install Sync Gateway]
:xref-sgw-pg-load-balancer: {sgw--xref}{sgw-pg-load-balancer}[Load Balancer]
:xref-sgw-bmk-load-balancer-keepalive: {sgw--xref}{sgw-pg-load-balancer}#websocket-connection[Load Balancer - Keep Alive]
:xref-sgw-pg-svr-cfg-bmk-createuser: {sgw--xref}{sgw-pg-svr-cfg-bmk-createuser}[Create an RBAC User]
:xref-sgw-pg-svr-cfg-bmk-createbucket: {sgw--xref}{sgw-pg-svr-cfg-bmk-createbucket}[Create a Bucket]
