...
[IMPORTANT]
--
If you have downloaded a `.framework` package to install, you may be impacted by an existing issue in _Xcode 12.3_, which prevents use of 'fat' frameworks  -- see: https://developer.apple.com/forums/thread/669411[Apple Developer Forum].
