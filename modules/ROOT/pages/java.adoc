...
:ziputils: {examplesdir}/java/code-snippets/app/src/main/java/com/couchbase/code_snippets/ZipUtils.java
...
http://docs.couchbase.com/mobile/2.1/couchbase-lite-java[Java SDK API References]
