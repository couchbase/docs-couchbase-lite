...
:url-api-references: http://docs.couchbase.com/mobile/2.0/couchbase-lite-java

// Begin define attributes used in INCLUDEs
:snippet: example$java/code-snippets/app/src/main/java/com/couchbase/code_snippets/MainActivity.java
...
// Include standard documents constraints (prefixes) content
include::{root-commons}document-constraints.adoc[]
