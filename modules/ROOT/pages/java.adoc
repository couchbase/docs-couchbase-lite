...
- https://github.com/couchbase/couchbase-lite-android/issues/1426[*#1426*] Using LiteListener with Couchbase mobile 2.0
- https://github.com/couchbase/couchbase-lite-android/issues/1708[*#1708*] 2.1: Refactored change notification into CBLChangeNotifier
