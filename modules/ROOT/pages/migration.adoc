...
Map<Collection, CollectionConfiguration> collections = new HashMap<>();
collections.put(defaultCollection, colConfig);
ReplicatorConfiguration config = new ReplicatorConfiguration(endpoint, collections);
----
--
...
----
// Before
var config = new ReplicatorConfiguration(database);
