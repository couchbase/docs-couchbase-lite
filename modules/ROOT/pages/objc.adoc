...
http://docs.couchbase.com/mobile/2.0/couchbase-lite-objc/index.html[Objective-C API References]
...
Refer to the https://developer.couchbase.com/documentation/mobile/1.4/guides/couchbase-lite/native-api/revision/index.html[Revisions] guide to learn about compaction and pruning to manage the database size.
...
// FIXME I don't know where this page resolves
...
It may be desirable to use https://developer.couchbase.com/documentation/mobile/1.4/guides/couchbase-lite/native-api/replication/index.html#filtered-replications[filter functions] to replicate only the documents of interest to another peer.
