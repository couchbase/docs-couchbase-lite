...
* N1QL for Mobile -- supporting the emerging SQL for JSON technology, SQL++.
...
:param-link: xref:swift:querybuilder-n1ql.adoc[Swift]  |  xref:objc:querybuilder-n1ql.adoc[Objective-C]  |  xref:java:querybuilder-n1ql.adoc[Java]  |  xref:android:querybuilder-n1ql.adoc[Android]  |  xref:csharp:querybuilder-n1ql.adoc[.Net] |  xref:c:querybuilder-n1ql.adoc[C]
