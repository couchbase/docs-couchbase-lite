...
== Release 3.3.3 (May 2026)

Couchbase Lite Release 3.3.3 introduces fixes and enhancements for:

xref:android:releasenotes.adoc#maint-3-3-3[Android]
|
xref:java:releasenotes.adoc#maint-3-3-3[Java]
|
...
Couchbase Lite 3.3.0 introduces the new Multipeer Replicator API for bidirectional peer-to-peer synchronization in both Swift and Kotlin platforms.
