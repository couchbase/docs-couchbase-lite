...
:url-issues-net: https://github.com/couchbase/couchbase-lite-net/issues	:url-issues-net: https://github.com/couchbase/couchbase-lite-net/issues
:url-api-references: http://docs.couchbase.com/mobile/2.0/couchbase-lite-net

// Begin define attributes used in INCLUDEs
:snippet: example$csharp/api-walkthrough/api-walkthrough/Program.cs
