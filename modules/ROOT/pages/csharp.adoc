...
:packageNm: couchbase-lite-net
:blank-field: ____
:url-issues-net: https://github.com/couchbase/{packageNm}/issues
:url-api-references: https://docs.couchbase.com/mobile/{version-full}/{packageNm}/
//
// End header
