...
- Resetting a replication (in other words, making it start over again) is now supported via Replication's ResetCheckpoint method.
Be sure to call it before the Replication is started.
