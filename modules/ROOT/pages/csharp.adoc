...
.Bugs
* https://github.com/couchbase/couchbase-lite-net/issues/1019[*#1019*] Change default socket timeout to be slightly more than default heartbeat
* https://github.com/couchbase/couchbase-lite-net/issues/1055[*#1055*] Lack of thread safety in hashset causing odd exception
