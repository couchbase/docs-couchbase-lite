...
.Bugs
* https://github.com/couchbase/couchbase-lite-net/issues/693[#693] TestJSViews failing with ForestDB
* https://github.com/couchbase/couchbase-lite-net/issues/716[#716] V1.3 Unauthorized http state not reported on replicators LastError property
* https://github.com/couchbase/couchbase-lite-net/issues/717[#717] Unexpected replications returned from active tasks
* https://github.com/couchbase/couchbase-lite-net/issues/723[#723] POST _replicate fails which when "source" or "target" is a dictionary

=== 1.3 release

.Enhancements
* https://github.com/couchbase/couchbase-lite-net/issues/50[#50] Add WebSocket support to replication
* https://github.com/couchbase/couchbase-lite-net/issues/558[#558] Missing PrefixMatchLevel under query
* https://github.com/couchbase/couchbase-lite-net/issues/570[#570] Implement Database.Close()
* https://github.com/couchbase/couchbase-lite-net/issues/574[#574] Remove requirement to define SQLCIPHER
* https://github.com/couchbase/couchbase-lite-net/issues/582[#582] Stop using long poll limit
* https://github.com/couchbase/couchbase-lite-net/issues/595[#595] Support POST /_changes in listener
* https://github.com/couchbase/couchbase-lite-net/issues/596[#596] Package 32-bit CBForest-Interop.dll
* https://github.com/couchbase/couchbase-lite-net/issues/599[#599] Allow users to specify the format they want dates to be deserialized as
* https://github.com/couchbase/couchbase-lite-net/issues/606[#606] Implement remote logging interface
* https://github.com/couchbase/couchbase-lite-net/issues/613[#613] Make View.UpdateIndex() public
* https://github.com/couchbase/couchbase-lite-net/issues/615[#615] Hook up GET _active_tasks
* https://github.com/couchbase/couchbase-lite-net/issues/617[#617] TTL support
* https://github.com/couchbase/couchbase-lite-net/issues/634[#634] No way to remove a database.
* https://github.com/couchbase/couchbase-lite-net/issues/635[#635] Add support for HTTP 408 status
* https://github.com/couchbase/couchbase-lite-net/issues/639[#639] Provide build of ListenerConsole in latestbuilds with each nuget package set.
* https://github.com/couchbase/couchbase-lite-net/issues/648[#648] Major inefficiencies replicating docs with many revisions
* https://github.com/couchbase/couchbase-lite-net/issues/650[#650] Investigate ability to more quickly start a stopping replication
* https://github.com/couchbase/couchbase-lite-net/issues/652[#652] OpenID connect mechanism
* https://github.com/couchbase/couchbase-lite-net/issues/653[#653] REST API for TTL
* https://github.com/couchbase/couchbase-lite-net/issues/678[#678] Implement GET design doc
* https://github.com/couchbase/couchbase-lite-net/issues/685[#685] Add API for clearing OpenID auth token
* https://github.com/couchbase/couchbase-lite-net/issues/686[#686] OpenID tokens in the key store should be per-database

.Bugs
* https://github.com/couchbase/couchbase-lite-net/issues/557[#557] SimpleAndroidSync freezing when adding items offline
* https://github.com/couchbase/couchbase-lite-net/issues/573[#573] Implement query filter on ForestDB views
* https://github.com/couchbase/couchbase-lite-net/issues/580[#580] Prevent nuget from using incompatible Stateless versions
* https://github.com/couchbase/couchbase-lite-net/issues/583[#583] System.BadImageFormatException when calling manager.GetDatabase("dbname") method
* https://github.com/couchbase/couchbase-lite-net/issues/590[#590] Listener crashes when receiving improper messages
* https://github.com/couchbase/couchbase-lite-net/issues/591[#591] Warn if map function calls emit(null, ...)
* https://github.com/couchbase/couchbase-lite-net/issues/608[#608] Listener intermittently enters hanging state
* https://github.com/couchbase/couchbase-lite-net/issues/609[#609] After purging a doc, live queries are not informed of the view change
* https://github.com/couchbase/couchbase-lite-net/issues/610[#610] Docs in SQLite dbs never get pruned until entire db is compacted
* https://github.com/couchbase/couchbase-lite-net/issues/611[#611] Stop() should not wait for changes to finish
* https://github.com/couchbase/couchbase-lite-net/issues/612[#612] When examining an exception, all nested exceptions should be examined
* https://github.com/couchbase/couchbase-lite-net/issues/616[#616] ExecSQL timeout prevents successful query of a very large db
* https://github.com/couchbase/couchbase-lite-net/issues/623[#623] Pushing ending prematurely
* https://github.com/couchbase/couchbase-lite-net/issues/625[#625] Xamarin Android crash due to hitting max application memory while syncing large attachments
* https://github.com/couchbase/couchbase-lite-net/issues/627[#627] Revpos == 0 needs to be treated as valid
* https://github.com/couchbase/couchbase-lite-net/issues/628[#628] Fallback to GET when POST is not allowed to _changes
* https://github.com/couchbase/couchbase-lite-net/issues/631[#631] Duplicate rows emitted during UpdateIndex
* https://github.com/couchbase/couchbase-lite-net/issues/636[#636] Starting a replication that already exists causes NRE
* https://github.com/couchbase/couchbase-lite-net/issues/637[#637] IOS device build error in 1.2.1.1
* https://github.com/couchbase/couchbase-lite-net/issues/640[#640] Docs taking a really long time to replicate
* https://github.com/couchbase/couchbase-lite-net/issues/641[#641] 401 Unauthorized during replication
* https://github.com/couchbase/couchbase-lite-net/issues/643[#643] Manager constructor fails on Windows 10
* https://github.com/couchbase/couchbase-lite-net/issues/644[#644] Heartbeat not behaving correctly with Listener (not honoring user setting)
* https://github.com/couchbase/couchbase-lite-net/issues/654[#654] Change tracker paused not working
* https://github.com/couchbase/couchbase-lite-net/issues/655[#655] Web socket change tracker doesn't use auth
* https://github.com/couchbase/couchbase-lite-net/issues/656[#656] Delete replications not following the same behavior as the native iOS library
* https://github.com/couchbase/couchbase-lite-net/issues/657[#657] Documents with null _attachments property cause NullReferenceException
* https://github.com/couchbase/couchbase-lite-net/issues/659[#659] Document.Update enters infinite loop
* https://github.com/couchbase/couchbase-lite-net/issues/660[#660] Setting log configuration via app.config is throwing exception
* https://github.com/couchbase/couchbase-lite-net/issues/661[#661] Removed attachments reported by UnsavedRevision
* https://github.com/couchbase/couchbase-lite-net/issues/666[#666] Unsaved attachment ContentType property throws NullReferenceException
* https://github.com/couchbase/couchbase-lite-net/issues/667[#667] WebSocketChangeTracker does not support using cookies for authentication
* https://github.com/couchbase/couchbase-lite-net/issues/669[#669] POST _replicate on the listen does not returns null "session_id"
* https://github.com/couchbase/couchbase-lite-net/issues/673[#673] Incorrect processing in REST API of documents with null bodies
* https://github.com/couchbase/couchbase-lite-net/issues/674[#674] Needless exception thrown and caught when dynamic DLL is loaded
* https://github.com/couchbase/couchbase-lite-net/issues/675[#675] Incorrect class type causing issues with REST all documents query
* https://github.com/couchbase/couchbase-lite-net/issues/676[#676] Rare continuous changes feed issue over SSL
* https://github.com/couchbase/couchbase-lite-net/issues/679[#679] Functional test failure on auto pruning
* https://github.com/couchbase/couchbase-lite-net/issues/683[#683] Fail to GET encrypted raw attachment
* https://github.com/couchbase/couchbase-lite-net/issues/687[#687] Pusher not properly setting headers on HTTP requests
* https://github.com/couchbase/couchbase-lite-net/issues/688[#688] Null reference exception during functional auto prune test
* https://github.com/couchbase/couchbase-lite-net/issues/694[#694] Xamarin Android SIGSEGV on unit test
* https://github.com/couchbase/couchbase-lite-net/issues/698[#698] NullReferenceException in SendAsyncRequest
* https://github.com/couchbase/couchbase-lite-net/issues/705[#705] Replication unable to recover from remote checkpoint conflict
