...
. *Pre-release only:* Add https://mobile.nuget.couchbase.com/nuget/Developer/ to your Nuget package sources.
...
http://docs.couchbase.com/mobile/2.5.0/couchbase-lite-net[C# SDK API References]
...
The http://docs.couchbase.com/mobile/2.0/couchbase-lite-net/db022/html/M_Couchbase_Lite_Query_IExpression_Regex.htm[`regex`] operator is case sensitive.
