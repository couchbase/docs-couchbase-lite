...
|Java
|xref:2.0@java-jvm.adoc#supported-versions[link]
|xref:2.1@java-jvm.adoc#supported-versions[link]
|xref:2.5@java-jvm.adoc#supported-versions[link]

|Java (Android)
|xref:2.0@java-android.adoc#supported-versions[link]
|xref:2.1@java-android.adoc#supported-versions[link]
|xref:2.5@java.android.adoc#supported-versions[link]
