...
[discrete#java:upgrade:::3-2-0-upgrade]
...
[discrete#java:upgrade:::api-changes]
=== API Changes


This content introduces the changes made to the pass:q,a[pass:q,a[Couchbase{nbsp}Lite]] for Java API for release {version-full}.

[discrete#java:upgrade:::removed]
==== Removed

[discrete#java:upgrade:::resetcheckpoint]
===== ResetCheckpoint
...
Instead, use https://docs.couchbase.com/mobile/{version-full}/couchbase-lite-java/com/couchbase/lite/AbstractReplicator.html#start-boolean-[Replicator.resetCheckpoint(boolean reset)].
...
[discrete#java:upgrade:::database-setloglevel]
...
[discrete#java:upgrade:::database-compact]
===== Database.compact
...
It is replaced by the new https://docs.couchbase.com/mobile/{version-full}/couchbase-lite-java/com/couchbase/lite/Database.html#performMaintenance-com.couchbase.lite.MaintenanceType-[Database.performMaintenance(MaintenanceType)] method, and the maintenance operations represented in the enum https://docs.couchbase.com/mobile/{version-full}/couchbase-lite-java/com/couchbase/lite/MaintenanceType.html[MaintenanceType]
...
[discrete#java:upgrade:::deprecated-in-the-api]
==== Deprecated in the API

[discrete#java:upgrade:::match]
===== MATCH
...
has been deprecated. +
Use https://docs.couchbase.com/mobile/{version-full}/couchbase-lite-java/com/couchbase/lite/FullTextFunction.html[FullTextFunction] instead.
...
[discrete#java:upgrade:::isnullormissingnotnullormissing]
...
[discrete#java:upgrade:::abstractreplicatorconfiguration]
...
[discrete#java:upgrade:::moved-in-the-api]
==== Moved in the API
...
* https://docs.couchbase.com/mobile/{version-full}/couchbase-lite-java/com/couchbase/lite/ReplicatorActivityLevel.html[ReplicatorActivityLevel]
* https://docs.couchbase.com/mobile/{version-full}/couchbase-lite-java/com/couchbase/lite/ReplicatorProgress.html[ReplicatorProgress]
* https://docs.couchbase.com/mobile/{version-full}/couchbase-lite-java/com/couchbase/lite/ReplicatorStatus.html[ReplicatorStatus]
...
[discrete#java:upgrade:::lbl-db-upgrades]
...
[discrete#java:upgrade:::encrypted-databases]
=== Encrypted Databases
...
[discrete#java:upgrade:::handling-of-existing-conflicts]
...
[discrete#java:upgrade:::handling-of-existing-attachments]
...
See <<java:upgrade:::ex-get-att>> for how to retrieve an attachment that was created in a 1.x database with a 2.x API.

.Retrieve 1.x Attachment
[#ex-get-att]


[#java:upgrade:::ex-get-att]
====
...
[discrete#java:upgrade:::replication-compatibility]
...
[discrete#java:upgrade:::visual-studio]
== Visual Studio
...
* Install the Couchbase Lite 2.0 framework in your project  -- see xref:java:gs-install.adoc[Install].
