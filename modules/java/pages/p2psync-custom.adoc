...
[#java:p2psync-custom:::peer-discovery]
== Peer Discovery
...
[#java:p2psync-custom:::active-peer]
=== Active Peer

The first step is to initialize the Couchbase Lite database.

[#java:p2psync-custom:::passive-peer]
=== Passive Peer
...
// include::java:example$codesnippet_collection.java[tag=listener,indent=0]
[source]
----
...
[#java:p2psync-custom:::peer-selection-and-connection-setup]
...
[#java:p2psync-custom:::replication-setup]
== Replication Setup


image::ROOT:connection.png[]

[#java:p2psync-custom:::active-peer-2]
=== Active Peer
...
// include::java:example$codesnippet_collection.java[tag=message-endpoint,indent=0]
[source]
----
Database database = new Database("dbName");
...
// include::java:example$codesnippet_collection.java[tag=message-endpoint-replicator,indent=0]
[source]
----
...
// include::java:example$codesnippet_collection.java[tag=create-connection,indent=0]
...
// include::java:example$codesnippet_collection.java[tag=active-peer-open,indent=0]
[source]
----
...
[#java:p2psync-custom:::passive-peer-2]
=== Passive Peer
...
// include::java:example$codesnippet_collection.java[tag=advertizer-accept,indent=0]
[source]
----
...
// include::java:example$codesnippet_collection.java[tag=passive-peer-open,indent=0]
[source]
----
/* implementation of MessageEndpointConnection */
@Override
...
[#java:p2psync-custom:::pushpull-replication]
...
[#java:p2psync-custom:::active-peer-3]
=== Active Peer
...
// include::java:example$codesnippet_collection.java[tag=active-peer-send,indent=0]
[source]
----
/* implementation of MessageEndpointConnection */
@Override
...
// include::java:example$codesnippet_collection.java[tag=active-peer-receive,indent=0]
[source]
----
...
[#java:p2psync-custom:::passive-peer-3]
=== Passive Peer
...
// include::java:example$codesnippet_collection.java[tag=passive-peer-send,indent=0]
[source]
----
/* implementation of MessageEndpointConnection */
@Override
...
// include::java:example$codesnippet_collection.java[tag=passive-peer-receive,indent=0]
[source]
----
replicatorConnection.receive(message);
----
...
[#java:p2psync-custom:::connection-teardown]
== Connection Teardown
...
[#java:p2psync-custom:::initiated-by-active-peer]
=== Initiated by Active Peer

image::ROOT:dis-active.png[]

[#java:p2psync-custom:::active-peer-4]
=== Active Peer

When an active Peer disconnects, it must call the `ReplicatorConnection.close` method.

// include::java:example$codesnippet_collection.java[tag=active-replicator-close,indent=0]
[source]
----
...
// include::java:example$codesnippet_collection.java[tag=active-peer-close,indent=0]
[source]
----
@Override
...
[#java:p2psync-custom:::passive-peer-4]
=== Passive Peer
...
// include::java:example$codesnippet_collection.java[tag=passive-replicator-close,indent=0]
[source]
----
replicatorConnection.close(null);
----
...
// include::java:example$codesnippet_collection.java[tag=passive-peer-close,indent=0]
[source]
----
/* implementation of MessageEndpointConnection */
@Override
...
[#java:p2psync-custom:::initiated-by-passive-peer]
=== Initiated by Passive Peer

image::ROOT:dis-passive.png[]

[#java:p2psync-custom:::passive-peer-5]
=== Passive Peer

When the passive disconnects, it must class the `MessageEndpointListener.closeAll` method.

// include::java:example$codesnippet_collection.java[tag=passive-stop-listener,indent=0]
[source]
----
...
[#java:p2psync-custom:::active-peer-5]
=== Active Peer
...
[#java:p2psync-custom:::related-content]
== Related Content
++++
