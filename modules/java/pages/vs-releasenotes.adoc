...
[#maint-vs-latest]
[#java:vs-releasenotes:::vs-maint-1-0-0-beta-2]
=== 1.0.0 Beta 2 -- May 2024

Version 1.0.0 Beta 2 for Java delivers the following features and enhancements:

[#java:vs-releasenotes:::enhancements]
==== Enhancements

None for this release

[#java:vs-releasenotes:::issues-and-resolutions]
==== Issues and Resolutions

None for this release

[#java:vs-releasenotes:::known-issues]
=====  Known Issues
...
[#java:vs-releasenotes:::deprecations]
==== Deprecations
