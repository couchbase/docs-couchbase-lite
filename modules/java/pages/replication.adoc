...
[tabs]
======
[#java:replication:::tabs-1-ca-cert]
CA Cert::
+
--
...
[#java:replication:::tabs-1-self-signed-cert]
Self Signed Cert::
+
--
...
[#java:replication:::tabs-1-pinned-certificate]
Pinned Certificate::
+
--
...
[tabs]
======
[#java:replication:::tabs-2-adding-a-change-listener]
...
--
+
[#java:replication:::tabs-2-using-replicator-status]
