...
// tag::content[]
:source-header: pass:q,a[source, {source-language},subs="attributes+, macros+"]
:url-api-references-2-8-0: https://docs.couchbase.com/mobile/2.8.0/couchbase-lite-java/com/couchbase/lite/
:url-api-references-3-0-0: https://docs.couchbase.com/mobile/{version-full}/couchbase-lite-java/com/couchbase/lite/


This content introduces the changes made to the pass:q,a[pass:q,a[Couchbase{nbsp}Lite]] for {param-title} API for release {version-full}.

== Removed

=== ResetCheckpoint

The method {url-api-references-2-8-0}AbstractReplicator.html#resetCheckpoint--[Replicator.resetCheckpoint()] method has been removed. +
