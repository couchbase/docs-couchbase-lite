...
:version-maintenance: {version}.{maintenance-java}{tag}
:version-maintenance-hyphenated: {major}-{minor}-{maintenance-java}{tag}

// VECTOR SEARCH attributes
:vs-version-maintenance: {vs-version}.{vs-maintenance-java}{tag}
:vs-version-maintenance-hyphenated: {vs-major}-{vs-minor}-{vs-maintenance-java}{tag}
...
:packageNmCE: {packageNm}-{version-maintenance}
:packageNmEE: {packageNm}-ee-{version-maintenance}
...
:url-api-enum-database-maintenance-type: {url-api-references-classes}MaintenanceType.html[MaintenanceType]
