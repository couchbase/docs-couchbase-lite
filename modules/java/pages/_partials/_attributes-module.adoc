// BEGIN -- _attributes-module.adoc -- Java
//
// Definition:
//    Objective: This adoc defines values for attributes specific to pages within this module (Java)
//    Invoked-by: ROOT:_partials/_std_cbl_hdr.adoc (from within module/_partials/_std-cbl-hdr-java.adoc)
//    Parameters: none
// End Definition:
...
:url-api-method-database-save-conflict: {url-api-method-database}save-com.couchbase.lite.MutableDocument-com.couchbase.lite.ConflictHandler-[database.save(MutableDocument document, ConflictHandler conflictHandler)]
...
:url-api-class-log-prop-console: {url-api-references-class-log}{sep}getConsole--[Log.getConsole]
:url-api-class-log-prop-file: {url-api-references-class-log}{sep}getFile--[Log.getFile]
:url-api-class-log-prop-custom: {url-api-references-class-log}{sep}getCustom--[Log.getCustom]
...
:url-api-class-log-console-getcons: {url-api-references-class-log}[log.getConsole()]
...
:url-api-class-log-custom-getcust: {url-api-references-class-log}[log.getCustom()]
:url-api-class-log-custom-setcust: {url-api-references-class-log}[log.setCustom()]
...
:url-api-class-log-file-getfile: {url-api-references-class-log}[log.getFile()]
...
// END -- _attributes-module.adoc -- Java