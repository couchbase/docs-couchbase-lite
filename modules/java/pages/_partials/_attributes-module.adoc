...
:url-api-method-database-close: {url-api-references-database}{sep}close-com.couchbase.lite.MutableDocument-com.couchbase.lite.ConflictHandler-[database.close()]
:url-api-method-database-delete: {url-api-references-database}{sep}delete-com.couchbase.lite.MutableDocument-com.couchbase.lite.ConflictHandler-[database.delete()]
...
// :url-api-methods-expression-like: {url-api-methods-expression-pfx}Like_Couchbase_Lite_Query_IExpression_
...
:url-api-methods-expression-pfx: {url-api-classes-query-expression-pfx}{sep}
:url-api-methods-expression-like: {url-api-methods-expression-pfx}like-com.couchbase.lite.Expression-[Like()]
:url-api-methods-expression-collate: {url-api-methods-expression-pfx}collate-com.couchbase.lite.Collation-[Collate()]
...
:url-api-methods-arrayfunction-pfx: {url-api-classes-query-arrayfunction-pfx}{sep}
...
:url-api-methods-select-pfx: {url-api-classes-query-select-pfx}{sep}
...
:url-api-method-replicator-getPendingDocumentIds: {url-api-properties-replicator-abs}getPendingDocumentIds--
