...
[#maint-latest]
[#java:releasenotes:::maint-3-2-1]
== 3.2.1 -- November 2024

Version 3.2.1 for Java delivers the following features and enhancements:

[#java:releasenotes:::couchbase-lite-release-notes]
== Couchbase Lite Release Notes

[#java:releasenotes:::enhancements]
=== Enhancements
...
[#java:releasenotes:::issues-and-resolutions]
...
[#java:releasenotes:::known-issues]
=== Known Issues

None for this release

[#java:releasenotes:::deprecations]
=== Deprecations
...
[#java:releasenotes:::issues-and-resolutions-2]
=== Issues and Resolutions
...
[#java:releasenotes:::known-issues-2]
=== Known Issues

None for this release

[#java:releasenotes:::deprecations-2]
=== Deprecations
...
[#java:releasenotes:::couchbase-lite-beta-2-release-notes]
== Couchbase Lite Beta 2 Release Notes

[#java:releasenotes:::enhancements-3]
=== Enhancements
...
[#java:releasenotes:::issues-and-resolutions-3]
=== Issues and Resolutions
...
[#java:releasenotes:::known-issues-3]
=== Known Issues

None for this release

[#java:releasenotes:::deprecations-3]
=== Deprecations
