...
You can create a new database and-or open an existing database, using the https://docs.couchbase.com/mobile/{version-maintenance-java}/couchbase-lite-java/com/couchbase/lite/Database.html[Database] class.
Just pass in a database name and optionally a https://docs.couchbase.com/mobile/{version-maintenance-java}/couchbase-lite-java/com/couchbase/lite/DatabaseConfiguration.html[DatabaseConfiguration] -- see <<java:database:::ex-dbopen>>.

Things to watch for include:

* If the named database does not exist in the specified, or default, location then a new one is created
* The database is created in a default location unless you  specify a directory for it -- see: https://docs.couchbase.com/mobile/{version-maintenance-java}/couchbase-lite-java/com/couchbase/lite/DatabaseConfiguration.html[DatabaseConfiguration] and https://docs.couchbase.com/mobile/{version-maintenance-java}/couchbase-lite-java/com/couchbase/lite/DatabaseConfiguration.html#setDirectory-java.lang.String-[DatabaseConfiguration.setDirectory()]
+
--
...
To close a database, use https://docs.couchbase.com/mobile/{version-maintenance-java}/couchbase-lite-java/com/couchbase/lite/Database.html#close--[Database.close()] -- see: <<java:database:::ex-dbclose>>.
This also closes
...
=== Enabling
To enable encryption, use https://docs.couchbase.com/mobile/{version-maintenance-java}/couchbase-lite-java/com/couchbase/lite/DatabaseConfiguration.html#setEncryptionKey(com.couchbase.lite.EncryptionKey)[DatabaseConfiguration.setEncryptionKey()] to set the encryption key of your choice.
...
=== Changing
To change an existing encryption key, open the database using its existing encryption-key and use https://docs.couchbase.com/mobile/{version-maintenance-java}/couchbase-lite-java/com/couchbase/lite/Database.html#changeEncryptionKey(com.couchbase.lite.EncryptionKey)[Database.changeEncryptionKey()]
...
https://docs.couchbase.com/mobile/{version-maintenance-java}/couchbase-lite-java/com/couchbase/lite/Database.html#changeEncryptionKey(com.couchbase.lite.EncryptionKey)[Database.changeEncryptionKey()]
...
This location is set by the link:https://docs.couchbase.com/mobile/{version-maintenance-java}/couchbase-lite-java//com/couchbase/lite/DatabaseConfiguration.html[DatabaseConfiguration] method.
...
Couchbase Lite's API provides the https://docs.couchbase.com/mobile/{version-maintenance-java}/couchbase-lite-java/com/couchbase/lite/Database.html#performMaintenance-com.couchbase.lite.MaintenanceType-[Database.performMaintenance()] method.
The available maintenance operations, including `compact` are as shown in the enum https://docs.couchbase.com/mobile/{version-maintenance-java}/couchbase-lite-java/com/couchbase/lite/MaintenanceType.html[MaintenanceType] to accomplish this.
