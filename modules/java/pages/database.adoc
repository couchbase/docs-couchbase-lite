...
[plantum#java:database:::cbl-database-structurel]
----
@startuml
...
// BEGIN: inclusion-platform-specific - java:partial$database-finding-file.adoc[]
...
// END: inclusion-platform-specific - java:partial$database-finding-file.adoc[]
