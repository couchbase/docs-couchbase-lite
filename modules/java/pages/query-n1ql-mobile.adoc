...
[#java:query-n1ql-mobile:::introduction]
== Introduction
...
[#java:query-n1ql-mobile:::running]
== Running
...
[#java:query-n1ql-mobile:::query-format]
== Query Format
...
| <<java:query-n1ql-mobile:::lbl-unnest>>
...
[#java:query-n1ql-mobile:::arguments]
=== Arguments
...
[#java:query-n1ql-mobile:::select-wildcard]
==== Select Wildcard
...
[#java:query-n1ql-mobile:::example]
=== Example
...
[#java:query-n1ql-mobile:::datasource]
=== Datasource
...
[#java:query-n1ql-mobile:::arguments-2]
=== Arguments
...
[#java:query-n1ql-mobile:::example-2]
=== Example
...
[#java:query-n1ql-mobile:::purpose-3]
=== Purpose
...
[#java:query-n1ql-mobile:::syntax-3]
=== Syntax
...
[#java:query-n1ql-mobile:::arguments-3]
=== Arguments
...
[#java:query-n1ql-mobile:::example-3]
=== Example
...
[#java:query-n1ql-mobile:::purpose-4]
=== Purpose
...
You can also use a new type of index, the xref:java:indexing.adoc#array-indexing[Array Index], to allow querying with `UNNEST` more efficiently.

NOTE: Couchbase Lite currently supports inner `UNNEST` only.

[#java:query-n1ql-mobile:::syntax-4]
=== Syntax
...
[#java:query-n1ql-mobile:::examples]
=== Examples

For examples of using Array Indexes in conjunction with `UNNEST`, see xref:java:indexing.adoc#array-indexing[Array Index].

We are also accessing the current database using the shorthand notation *`_`* -- see the <<java:query-n1ql-mobile:::lbl-from>> clause for more on data source selection and <<java:query-n1ql-mobile:::lbl-query-params>> for more on parameterized queries.
...
[#java:query-n1ql-mobile:::purpose-5]
=== Purpose
...
[#java:query-n1ql-mobile:::syntax-5]
=== Syntax
...
[#java:query-n1ql-mobile:::arguments-4]
=== Arguments
...
[#java:query-n1ql-mobile:::examples-2]
=== Examples
...
[#java:query-n1ql-mobile:::arguments-5]
=== Arguments
...
[#java:query-n1ql-mobile:::examples-3]
=== Examples
...
[#java:query-n1ql-mobile:::purpose-7]
=== Purpose
Sort query results based on a given expression result.

[#java:query-n1ql-mobile:::syntax-7]
=== Syntax
...
[#java:query-n1ql-mobile:::arguments-6]
=== Arguments
...
[#java:query-n1ql-mobile:::examples-4]
=== Examples
...
[#java:query-n1ql-mobile:::purpose-9]
=== Purpose
Specifies the number of results to be skipped by the query.

[#java:query-n1ql-mobile:::syntax-9]
=== Syntax
...
[#java:query-n1ql-mobile:::arguments-8]
=== Arguments
...
[#java:query-n1ql-mobile:::examples-6]
=== Examples
...
[#java:query-n1ql-mobile:::lbl-literals]
== Expressions
In this section::
...
[#java:query-n1ql-mobile:::lbl-exp-literals]
=== Literals
...
[#java:query-n1ql-mobile:::lbl-lit-bool]
==== Boolean

[#java:query-n1ql-mobile:::purpose-10]
==== Purpose
Represents a true or false value.

[#java:query-n1ql-mobile:::syntax-10]
==== Syntax

`TRUE | FALSE`

[#java:query-n1ql-mobile:::example-4]
==== Example
...
[#java:query-n1ql-mobile:::lbl-lit-numbers]
==== Numeric

[#java:query-n1ql-mobile:::purpose-11]
==== Purpose
Represents a numeric value.
Numbers may be signed or unsigned digits.
They have optional fractional and exponent components.

[#java:query-n1ql-mobile:::syntax-11]
==== Syntax
...
[#java:query-n1ql-mobile:::example-5]
==== Example
...
[#java:query-n1ql-mobile:::lbl-lit-string]
==== String

[#java:query-n1ql-mobile:::purpose-12]
==== Purpose
The string literal represents a string or sequence of characters.


[#java:query-n1ql-mobile:::syntax-12]
==== Syntax
...
[#java:query-n1ql-mobile:::example-6]
==== Example
[source,sql]
----
...
[#java:query-n1ql-mobile:::lbl-lit-null]
==== NULL

[#java:query-n1ql-mobile:::purpose-13]
==== Purpose
The literal NULL represents an empty value.

[#java:query-n1ql-mobile:::syntax-13]
==== Syntax
...
[#java:query-n1ql-mobile:::example-7]
==== Example
[source,sql]
----
...
[#java:query-n1ql-mobile:::lbl-lit-missing]
==== MISSING

[#java:query-n1ql-mobile:::purpose-14]
==== Purpose
The MISSING literal represents a missing name-value pair in a document.

[#java:query-n1ql-mobile:::syntax-14]
==== Syntax
...
[#java:query-n1ql-mobile:::example-8]
==== Example
[source,sql]
----
...
[#java:query-n1ql-mobile:::lbl-lit-array]
==== Array

[#java:query-n1ql-mobile:::purpose-15]
==== Purpose
Represents an Array

[#java:query-n1ql-mobile:::syntax-15]
==== Syntax
...
[#java:query-n1ql-mobile:::example-9]
==== Example
[source,sql]
----
SELECT [“a”, “b”, “c”] FROM _
...
[#java:query-n1ql-mobile:::lbl-lit-dict]
==== Dictionary

[#java:query-n1ql-mobile:::purpose-16]
==== Purpose
Represents a dictionary literal

[#java:query-n1ql-mobile:::syntax-16]
==== Syntax
...
[#java:query-n1ql-mobile:::example-10]
==== Example
[source,sql]
----
...
[#java:query-n1ql-mobile:::lbl-exp-ident]
=== Identifiers

[#java:query-n1ql-mobile:::purpose-17]
==== Purpose
...
[#java:query-n1ql-mobile:::syntax-17]
==== Syntax
...
[#java:query-n1ql-mobile:::example-11]
==== Example
...
[#java:query-n1ql-mobile:::lbl-exp-prop]
=== Property Expressions

[#java:query-n1ql-mobile:::purpose-18]
==== Purpose
The property expression is used to reference a property in a document

[#java:query-n1ql-mobile:::syntax-18]
==== Syntax
...
[#java:query-n1ql-mobile:::example-12]
==== Example
...
[#java:query-n1ql-mobile:::lbl-exp-any]
=== Any and Every Expressions

[#java:query-n1ql-mobile:::purpose-19]
==== Purpose
Evaluates expressions over items in an array object.


[#java:query-n1ql-mobile:::syntax-19]
==== Syntax
...
[#java:query-n1ql-mobile:::example-13]
==== Example
...
[#java:query-n1ql-mobile:::lbl-exp-param]
=== Parameter Expressions

[#java:query-n1ql-mobile:::purpose-20]
==== Purpose
...
[#java:query-n1ql-mobile:::syntax-20]
==== Syntax
...
[#java:query-n1ql-mobile:::examples-7]
==== Examples
...
[#java:query-n1ql-mobile:::lbl-operators]
== Operators
In this section::
...
[#java:query-n1ql-mobile:::lbl-ops-binary]
=== Binary Operators
...
[#java:query-n1ql-mobile:::lbl-ops-maths]
==== Maths
...
[#java:query-n1ql-mobile:::lbl-comp-ops]
==== Comparison Operators

[#java:query-n1ql-mobile:::purpose-22]
==== Purpose
The _comparison operators_ are used in the WHERE statement to specify the condition on which to match documents.

.Comparison Operators
[#tbl-ops-comp]
[ops-comp#java:query-n1ql-mobile:::tbl-ops-comp, cols="^1m,2,2m", options="header"]
|===
...
[#tbl-ops-isnot]
[ops-comp#java:query-n1ql-mobile:::tbl-ops-isnot, cols="^1,^1,^1,^1", options="header"]
|===
...
[#java:query-n1ql-mobile:::lbl-ops-logical]
==== Logical Operators

[#java:query-n1ql-mobile:::purpose-23]
==== Purpose
...
.Logical Operators
[#tbl-ops-logical]
[ops-comp#java:query-n1ql-mobile:::tbl-ops-logical, cols="^1m,2,2m", options="header"]
|===
...
[#java:query-n1ql-mobile:::purpose-24]
==== Purpose
...
[#java:query-n1ql-mobile:::lbl-ops-unary]
=== Unary Operators

[#java:query-n1ql-mobile:::purpose-25]
==== Purpose
...
[#java:query-n1ql-mobile:::syntax-21]
==== Syntax
...
[#java:query-n1ql-mobile:::lbl-ops-coll]
=== COLLATE Operators

[#java:query-n1ql-mobile:::purpose-26]
==== Purpose
Collate operators specify how the string comparison is conducted.

[#java:query-n1ql-mobile:::usage]
==== Usage
...
[#java:query-n1ql-mobile:::syntax-22]
==== Syntax
...
[#java:query-n1ql-mobile:::arguments-9]
==== Arguments
...
[#java:query-n1ql-mobile:::example-15]
==== Example
...
[#java:query-n1ql-mobile:::example-16]
==== Example
...
[#java:query-n1ql-mobile:::lbl-functions]
== Functions
In this section::
...
[#java:query-n1ql-mobile:::purpose-28]
=== Purpose

Functions are also expressions.

[#java:query-n1ql-mobile:::syntax-24]
=== Syntax
...
[#java:query-n1ql-mobile:::lbl-func-agg]
...
[#java:query-n1ql-mobile:::lbl-func-array]
=== Array Functions
...
[#java:query-n1ql-mobile:::lbl-func-cond]
...
[#java:query-n1ql-mobile:::lbl-func-date]
...
[#java:query-n1ql-mobile:::lbl-func-fts]
...
[#java:query-n1ql-mobile:::lbl-func-maths]
=== Maths Functions
...
[#java:query-n1ql-mobile:::lbl-func-meta]
=== Metadata Functions
...
[#java:query-n1ql-mobile:::lbl-func-pattern]
...
[#java:query-n1ql-mobile:::lbl-func-string]
=== String Functions
...
[#java:query-n1ql-mobile:::lbl-func-typecheck]
...
[#java:query-n1ql-mobile:::querybuilder-differences]
...
[#java:query-n1ql-mobile:::lbl-query-params]
== Query Parameters
...
[#java:query-n1ql-mobile:::related-content]
== Related Content
++++
...
[.column#java:query-n1ql-mobile:::-2]
====== {empty}
.Learn more . . .
...
[.column#java:query-n1ql-mobile:::-3]
====== {empty}
.Dive Deeper . . .
