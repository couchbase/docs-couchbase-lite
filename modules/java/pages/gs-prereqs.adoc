...
[#java:gs-prereqs:::introduction]
== Introduction

pass:q,a[_pass:q,a[pass:q,a[Couchbase{nbsp}Lite]]_]] on Java enables development and deployment of pass:q,a[Couchbase{nbsp}Lite applications to a JVM environment.
...
[#java:gs-prereqs:::bmkSetupSyncAndServer]
...
[#java:gs-prereqs:::macos-and-windows]
== MacOS and Windows

You may now proceed directly to <<java:gs-install:::>>.

[#java:gs-prereqs:::additional-steps-for-linux]
...
[#java:gs-prereqs:::related-content]
== Related Content
++++
