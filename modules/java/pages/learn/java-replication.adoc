...
And since Couchbase Lite 2 only supports the new protocol, you will need to run a version of Sync Gateway that supports it -- see:  xref:sync-gateway::prodnotes/pn-compatibility.adoc[Sync{nbsp}Gateway Compatibility Matrix].
