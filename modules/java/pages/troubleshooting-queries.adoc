...
[#java:troubleshooting-queries:::query-explain]
== Query Explain


[#java:troubleshooting-queries:::using]
=== Using
...
[#java:troubleshooting-queries:::output]
=== Output
...
[#java:troubleshooting-queries:::the-query-plan]
== The Query Plan


[#java:troubleshooting-queries:::format]
=== Format
...
[#java:troubleshooting-queries:::ret-method]
=== Retrieval Method
...
[#java:troubleshooting-queries:::order-group]
=== Order and Group
...
[#java:troubleshooting-queries:::queries-and-indexes]
== Queries and Indexes
...
[#java:troubleshooting-queries:::working-with-the-query-optimizer]
...
[#java:troubleshooting-queries:::use-like-based-queries]
...
[source#java:troubleshooting-queries:::like-wild-pfx-qry, Java]
----
Query query = QueryBuilder
    .select(SelectResult.all())
    .from(DataSource.collection(collection))
...
[#java:troubleshooting-queries:::use-functions-wisely]
...
[source#java:troubleshooting-queries:::use-like-based-queries, Java]
----
Query query = QueryBuilder
    .select(SelectResult.all())
    .from(DataSource.collection(collection))
...
[#java:troubleshooting-queries:::optimization-considerations]
...
[#java:troubleshooting-queries:::related-content]
== Related Content
++++
...
[.column#java:troubleshooting-queries:::-2]
====== {empty}
.Learn more . . .
...
[.column#java:troubleshooting-queries:::-3]
====== {empty}
.Dive Deeper . . .
