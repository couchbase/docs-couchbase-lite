...
[#java:p2psync-websocket-using-active:::introduction]
== Introduction
...
[#java:p2psync-websocket-using-active:::configuration-summary]
...
[#java:p2psync-websocket-using-active:::api-references]
== API References
...
[#java:p2psync-websocket-using-active:::device-discovery]
== Device Discovery
...
[#java:p2psync-websocket-using-active:::configure-replicator]
...
[#java:p2psync-websocket-using-active:::certificate-authentication]
...
[#java:p2psync-websocket-using-active:::initialize-replicator]
...
[#java:p2psync-websocket-using-active:::lbl-repl-mon]
== Monitor Sync
...
[#java:p2psync-websocket-using-active:::lbl-repl-states]
=== Replication States
...
[#java:p2psync-websocket-using-active:::lbl-repl-stop]
== Stop Sync
...
[#java:p2psync-websocket-using-active:::conflict-resolution]
== Conflict Resolution
...
[#java:p2psync-websocket-using-active:::delta-sync]
== Delta Sync
If delta sync is enabled on the listener, then replication will use delta sync.


[#java:p2psync-websocket-using-active:::related-content]
== Related Content
++++
...
[.column#java:p2psync-websocket-using-active:::-2]
=== {empty}
.Concepts
...
[.column#java:p2psync-websocket-using-active:::-3]
=== {empty}
.Community Resources ...
