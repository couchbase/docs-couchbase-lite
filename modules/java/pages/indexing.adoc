...
[#java:indexing:::creating-a-new-index]
...
[#java:indexing:::array-index-syntax]
=== Array Index Syntax
...
[#java:indexing:::using-array-indexes-with-unnest]
