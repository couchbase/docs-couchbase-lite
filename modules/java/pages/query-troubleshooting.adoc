...
[source#java:query-troubleshooting:::like-wild-pfx-qry, Java]
----
Query query = QueryBuilder
    .select(SelectResult.all())
    .from(DataSource.collection(collection))
...
[source#java:query-troubleshooting:::use-like-based-queries, Java]
----
Query query = QueryBuilder
    .select(SelectResult.all())
    .from(DataSource.collection(collection))
...
[.column#java:query-troubleshooting:::-2]
====== {empty}
.Learn more . . .
...
[.column#java:query-troubleshooting:::-3]
====== {empty}
.Dive Deeper . . .
