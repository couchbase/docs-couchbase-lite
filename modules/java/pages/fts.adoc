...
[#java:fts:::querybuilder]
=== QueryBuilder

[#java:fts:::create-index-2]
==== Create Index
...
[#java:fts:::pattern-matching-formats]
...
[#java:fts:::overriding-the-property-name]
...
[#java:fts:::and-or-not-query-operators]
