...
+
Use the API's https://docs.couchbase.com/mobile/{major}.{minor}.{maintenance-java}{empty}/couchbase-lite-java/com/couchbase/lite/Database.html#lbl-code>>; this ensures that a UUID is generated for each copy
+
