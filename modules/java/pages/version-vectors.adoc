...
Related Content -- xref:java:database.adoc[Databases] | xref:java:document.adoc[Documents] | xref:java:conflict.adoc[Handling Data Conflicts] | xref:java:replication.adoc[Data Sync]
--
...
The timestamp value returns `long` representing nanoseconds since the Unix epoch (January 1, 1970 00:00:00 UTC).
