...
[tabs]
====
[#java:troubleshooting-logs:::tabs-1-macos]
macOS::
+
--
...
[#java:troubleshooting-logs:::tabs-1-centos]
CentOS::
+
--
Download the *cbl-log* tool using `wget`.
...
[#java:troubleshooting-logs:::tabs-1-windows]
Windows::
+
--
...
[.column]
// [.content]
[discrete#java:troubleshooting-logs:::-3]
===== {empty}
.Dive Deeper . . .
//* Community
