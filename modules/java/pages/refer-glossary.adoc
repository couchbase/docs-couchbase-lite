...
== Index
[.pane__frame--blue]
xref:java:refer-glossary.adoc#a[]  |  xref:B>>  |  <<java:refer-glossary.adoc#c[]  |  xref:java:refer-glossary.adoc#d[]  |  xref:E>>  |  <<F>>  |  <<G>>  |  <<H>>  |  <<java:refer-glossary.adoc#i[]  |  xref:J>>  |  <<K>>  |  <<java:refer-glossary.adoc#l[]  |  xref:M>>  |  <<java:refer-glossary.adoc#n[]  |  xref:O>>  |  <<java:refer-glossary.adoc#p[]  |  xref:Q>>  |  <<java:refer-glossary.adoc#r[]  |  xref:java:refer-glossary.adoc#s[]  |  xref:java:refer-glossary.adoc#t[]  |  <<U>>  |  <<V>>  |  <<W>>  |  <<X>>  |  <<Y>>  |  <<Z>>
...
* _Related Term(s)_: xref:java:refer-glossary.adoc#passive-peer[] xref:java:refer-glossary.adoc#peer-to-peer-sync[]
* _Read More_: xref:java:landing-p2psync.adoc[Peer-to-Peer Sync]
...
[[java:refer-glossary:::checkpoint]]Checkpoint::
...
Back to xref:java:refer-glossary.adoc#index[]
...
// tag::cbl-delta-sync[]
// tag::cbl-delta-sync-def[]
* _Related Term(s)_: xref:java:refer-glossary.adoc#passive-replicator[Passive replicator]
* _Read More_: xref:java:replication.adoc#delta-sync[Delta Sync]
// tag::cbl-delta-sync-full[]
...
* _Related Term(s)_: xref:java:refer-glossary.adoc#active-peer[], xref:java:refer-glossary.adoc#peer-to-peer-sync[]
* _Read More_: xref:java:landing-p2psync.adoc[Peer-to-Peer Sync]
// end::cbl-passive-peer[]
...
* _Related Term(s)_: xref:java:refer-glossary.adoc#active-peer[] xref:java:refer-glossary.adoc#passive-peer[]
* _Read More_: xref:java:landing-p2psync.adoc[Peer-to-Peer Sync]
...
* _Related Term(s)_: xref:java:refer-glossary.adoc#active-peer[] xref:java:refer-glossary.adoc#passive-peer[]
* _Read More_: xref:java:p2psync-websocket.adoc[Peer-to-Peer]
