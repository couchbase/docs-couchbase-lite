.xref:java:quickstart.adoc[Java]
  ...
  * Queries
    ...
    ** xref:java:query-n1ql-mobile-querybuilder-diffs.adoc[N1QL Querybuilder Differences]
  ...
  * https://docs.couchbase.com/mobile/{major}.{minor}.{base}/couchbase-lite-java/[API{nbsp}References]
