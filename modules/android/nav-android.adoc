...
.xref:android:quickstart.adoc[Android]
  ...
  * Queries
    ...
    ** xref:android:query-n1ql-mobile.adoc[{sqlpp_cbm} for Mobile]
    ** xref:android:query-n1ql-mobile-server-diffs.adoc[{sqlpp_cbm} Server Differences]
    ** xref:android:query-n1ql-mobile-querybuilder-diffs.adoc[{sqlpp_cbm} Querybuilder Differences]
