...
.xref:android:quickstart.adoc[Android]
  ...
  * xref:android:kotlin-serialization.adoc[Kotlin Serialization]

  * xref:android:version-vectors.adoc[Version Vectors]
  ...
  ** xref:android:p2psync-multipeer.adoc[Multipeer Peer-to-Peer Replicator]
