...
.xref:android:quickstart.adoc[Android]
  ...
  * https://docs.couchbase.com/mobile/{major}.{minor}.{base}{tag}/couchbase-lite-android/[API References]

  * https://docs.couchbase.com/mobile/{major}.{minor}.{base}{tag}/couchbase-lite-android-ktx[Kotlin Extensions]
