...
[#android:p2psync-websocket-using-active:::introduction]
== Introduction
...
[#android:p2psync-websocket-using-active:::configuration-summary]
...
[#android:p2psync-websocket-using-active:::api-references]
== API References
...
[#android:p2psync-websocket-using-active:::device-discovery]
== Device Discovery
...
[#android:p2psync-websocket-using-active:::configure-replicator]
...
// include::android:example$codesnippet_collection.java[tag=p2p-act-rep-config-cacert-pinned-callouts, indent=0]
[source, Java]
----
...
[#android:p2psync-websocket-using-active:::certificate-authentication]
...
[#android:p2psync-websocket-using-active:::initialize-replicator]
...
[#android:p2psync-websocket-using-active:::lbl-repl-mon]
== Monitor Sync
...
[#android:p2psync-websocket-using-active:::using-kotlin-flows-and-livedata]
...
[#android:p2psync-websocket-using-active:::lbl-repl-states]
=== Replication States
...
[#android:p2psync-websocket-using-active:::replication-status-and-app-life-cycle]
...
[#android:p2psync-websocket-using-active:::lbl-repl-stop]
== Stop Sync
...
[#android:p2psync-websocket-using-active:::conflict-resolution]
== Conflict Resolution
...
[#android:p2psync-websocket-using-active:::delta-sync]
== Delta Sync
If delta sync is enabled on the listener, then replication will use delta sync.


[#android:p2psync-websocket-using-active:::related-content]
== Related Content
++++
...
[.column#android:p2psync-websocket-using-active:::-2]
=== {empty}
.Concepts
...
[.column#android:p2psync-websocket-using-active:::-3]
=== {empty}
.Community Resources ...
