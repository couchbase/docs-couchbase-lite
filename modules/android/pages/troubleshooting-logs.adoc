...
[#android:troubleshooting-logs:::introduction]
== Introduction
...
[#android:troubleshooting-logs:::formats]
=== Formats
...
[#android:troubleshooting-logs:::configuration]
=== Configuration
...
This example show how to enable the custom logger from <<android:troubleshooting-logs:::eg-impl-log>>.
[tabs]
=====
...
[#android:troubleshooting-logs:::decoding-binary-logs]
...
[#android:troubleshooting-logs:::related-content]
== Related Content
++++
...
[.column#android:troubleshooting-logs:::-2]
====== {empty}
.Learn more . . .
...
[.column#android:troubleshooting-logs:::-3]
====== {empty}
.Dive Deeper . . .
