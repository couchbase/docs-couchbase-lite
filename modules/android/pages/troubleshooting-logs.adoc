...
[NOTE]
--
* The value returned by `LogLevel.getValue()` is not useful.
It's not the Android log level.
...
* xref:android:troubleshooting-logs.adoc#lbl-file-logs[]
+
Here logs are written to xref:android:troubleshooting-logs.adoc#log-file-outputs[separate log files] filtered by log level, with each log level supporting individual retention policies.

* xref:android:troubleshooting-logs.adoc#lbl-console-logs[]
+
--
...
With console logging, you can fine-tune diagnostic output to suit specific debug scenarios and capture them for Couchbase Support for the investigation of issues.
--

* xref:android:troubleshooting-logs.adoc#lbl-custom-logs[]
+
--
...
NOTE: the use of https://docs.couchbase.com/mobile/{major}.{minor}.{maintenance-android}{empty}/couchbase-lite-android/com/couchbase/lite/Database.html#setLogLevel-com.couchbase.lite.LogDomain-com.couchbase.lite.LogLevel-[Database.setLogLevel()] is now deprecated.
...
To change default settings use database's https://docs.couchbase.com/mobile/{major}.{minor}.{maintenance-android}{empty}/couchbase-lite-android/com/couchbase/lite/Log.html[Log] method to set the required values -- see xref:android:troubleshooting-logs.adoc#eg-cons-log[]
...
You will primarily use `Database.log.getConsole()` to get the https://docs.couchbase.com/mobile/{major}.{minor}.{maintenance-android}{empty}/couchbase-lite-android/com/couchbase/lite/ConsoleLogger.html[ConsoleLogger] used to control console logging.
...
[#lbl-file-logs]
== File based logging
File based logging is disabled by default --  see: xref:android:troubleshooting-logs.adoc#eg-file-log[] for how to enable it.

You will primarily use `Database.log.getFile()` and https://docs.couchbase.com/mobile/{major}.{minor}.{maintenance-android}{empty}/couchbase-lite-android/com/couchbase/lite/FileLogger.html[FileLogger] to control file-based logging.
...
+
Use this format and a decoder, such as *cbl-log*, to view them -- see: xref:android:troubleshooting-logs.adoc#decoding-binary-logs[].
* Plaintext
...
With file based logging you can also use the https://docs.couchbase.com/mobile/{major}.{minor}.{maintenance-android}{empty}/couchbase-lite-android/com/couchbase/lite/LogFileConfiguration.html[LogFileConfiguration] class's properties to specify the:
...
To do this, apps must implement the https://docs.couchbase.com/mobile/{major}.{minor}.{maintenance-android}{empty}/couchbase-lite-android/com/couchbase/lite/Logger.html[Logger] interface -- see xref:android:troubleshooting-logs.adoc#eg-impl-log[] -- and enable custom logging using https://docs.couchbase.com/mobile/{major}.{minor}.{maintenance-android}{empty}/couchbase-lite-android/com/couchbase/lite/Logger.html[log.setCustom()] -- see xref:android:troubleshooting-logs.adoc#eg-cust-log[].
...
This example show how to enable the custom logger from xref:android:troubleshooting-logs.adoc#eg-impl-log[].
[tabs]
=====
