...
[source,kotlin]
----
val listener8080 = URLEndpointListenerConfigurationFactory.create(
    networkInterface="en0",
    port=8080)

val listener8081 = listener8080.create(port=8081)
----
...
db.createIndex("name_and_location_index",
      ValueIndexConfigurationFactory.create(expressions = arrayOf("name","location"))
    )
