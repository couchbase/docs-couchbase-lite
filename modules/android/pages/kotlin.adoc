...
Couchbase Lite _{param-title} {version-full}_ introduces full idiomatic support for Kotlin apps, out-of-the-box.
...
Couchbase Lite provides a set of {config-factories} and {common-config-factories}, these allow use of named parameters to specify property settings.
