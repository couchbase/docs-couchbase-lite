...
_Couchbase{nbsp}Lite_ _Android {major}.{minor}.{base}{empty}_ introduces full idiomatic support for Kotlin apps, out-of-the-box.
...
* xref:android:kotlin.adoc#lbl-factories[] for the configuration of important Couchbase Lite objects such as _Databases_, _Replicators_ and _Listeners_.
...
=== Logs
Use
https://docs.couchbase.com/mobile/{major}.{minor}.{base}{empty}/couchbase-lite-android-ktx/com/couchbase/lite/CommonConfigurationFactoriesKt.html#FileLogSinkFactory[FileLogSinkFactory]
