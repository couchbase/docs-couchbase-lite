...
_pass:q,a[pass:q,a[Couchbase{nbsp}Lite]]_ _Android {major}.{minor}.{base}{empty}_ introduces full idiomatic support for Kotlin apps, out-of-the-box.
...
//
[#android:kotlin:::full-text-search]
=== Full Text Search
Use
...
[#android:kotlin:::database-change-flow]
...
[#android:kotlin:::document-change-flow]
...
[#android:kotlin:::replicator-change-flow]
...
[#android:kotlin:::document-replicator-change-flow]
...
[#android:kotlin:::query-change-flow]
=== Query Change Flow
Use
...
[#android:kotlin:::related-content]
== Related Content
++++
