...
// :config-factories: {url-api-references-kotlin}ConfigurationFactoriesKt.html[ConfigurationFactories]
// :database-configuration-factory: {url-api-references-kotlin}ConfigurationFactoriesKt.html#DatabaseConfigurationFactory[DatabaseConfigurationFactory]
// :replicator-configuration-factory: {url-api-references-kotlin}ConfigurationFactoriesKt.html#ReplicatorConfigurationFactory[ReplicatorConfigurationFactory]

// :common-config-factories: {url-api-references-kotlin}CommonConfigurationFactoriesKt.html[CommonConfigurationFactories]
// :fulltextindex-configuration-factory: {url-api-references-kotlin}CommonConfigurationFactoriesKt.html#FullTextIndexConfigurationFactory[FullTextIndexConfigurationFactory]
// :valueindex-configuration-factory: {url-api-references-kotlin}CommonConfigurationFactoriesKt.html#ValueIndexConfigurationFactory[ValueIndexConfigurationFactory]
// :logfile-configuration-factory: {url-api-references-kotlin}CommonConfigurationFactoriesKt.html#LogFileConfigurationFactory[LogFileConfigurationFactory]

// :flows-database-change: {url-api-references-kotlin}CommonFlowsKt.html#databaseChangeFlow(Database,Executor)[databaseChangeFlow(Database,Executor)]
// :flows-document-change: {url-api-references-kotlin}CommonFlowsKt.html#documentChangeFlow(Database,String,Executor)[documentChangeFlow(Database,String,Executor)]
// :flows-replicator-changes: {url-api-references-kotlin}CommonFlowsKt.html#replicatorChangeFlow(Replicator,Executor)[replicatorChangeFlow(Replicator,Executor)]
// :flows-document-replication: {url-api-references-kotlin}CommonFlowsKt.html#documentReplicationFlow(Replicator,Executor)[documentReplicationFlow(Replicator,Executor)]
// :flows-query-changes: {url-api-references-kotlin}CommonFlowsKt.html#queryChangeFlow(Query,Executor)[queryChangeFlow(Query,Executor)]
...
{cbl-t} provides a set of {url-api-references-kotlin}ConfigurationFactoriesKt.html[ConfigurationFactories] and {url-api-references-kotlin}CommonConfigurationFactoriesKt.html[CommonConfigurationFactories], these allow use of named parameters to specify property settings.
...
=== Database
Use
{url-api-references-kotlin}ConfigurationFactoriesKt.html#DatabaseConfigurationFactory[DatabaseConfigurationFactory]
...
=== Replication
Use
{url-api-references-kotlin}ConfigurationFactoriesKt.html#ReplicatorConfigurationFactory[ReplicatorConfigurationFactory]
...
=== Full Text Search
Use
{url-api-references-kotlin}CommonConfigurationFactoriesKt.html#FullTextIndexConfigurationFactory[FullTextIndexConfigurationFactory]
...
=== Indexing
Use
{url-api-references-kotlin}CommonConfigurationFactoriesKt.html#ValueIndexConfigurationFactory[ValueIndexConfigurationFactory]
...
=== Logs
Use
{url-api-references-kotlin}CommonConfigurationFactoriesKt.html#LogFileConfigurationFactory[LogFileConfigurationFactory]
...
Use the
{url-api-references-kotlin}CommonFlowsKt.html#databaseChangeFlow(Database,Executor)[databaseChangeFlow(Database,Executor)]
...
Use
{url-api-references-kotlin}CommonFlowsKt.html#documentChangeFlow(Database,String,Executor)[documentChangeFlow(Database,String,Executor)]
...
Use
{url-api-references-kotlin}CommonFlowsKt.html#replicatorChangeFlow(Replicator,Executor)[replicatorChangeFlow(Replicator,Executor)]
...
Use
{url-api-references-kotlin}CommonFlowsKt.html#documentReplicationFlow(Replicator,Executor)[documentReplicationFlow(Replicator,Executor)]
...
=== Query Change Flow
Use
{url-api-references-kotlin}CommonFlowsKt.html#queryChangeFlow(Query,Executor)[queryChangeFlow(Query,Executor)]
to monitor document changes during replication.
