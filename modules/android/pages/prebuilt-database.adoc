...
****
. Create a new Couchbase Lite database with the required dataset -- see xref:android:prebuilt-database.adoc#crt-db[]
. Incorporate the pre-built database with your app bundle as an asset/resource -- see xref:android:prebuilt-database.adoc#bundle-db[]
...
Start a sync to update the data -- see xref:android:prebuilt-database.adoc#deploy-db[]
****
...
* You can write a simple CBL app to start a pull sync -- see: xref:android:replication.adoc[Remote Sync Gateway]
