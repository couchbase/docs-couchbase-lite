...
+
Use the API's https://docs.couchbase.com/mobile/{major}.{minor}.{maintenance-android}{empty}/couchbase-lite-android/com/couchbase/lite/Database.html#lbl-code>>; this ensures that a UUID is generated for each copy
+
