...
include::{root-partials}pn-issues-list-litecore.adoc[tag=enhancements-2-8-6]

* https://issues.couchbase.com/browse/CBL-1979[CBL-1979] -- Android v30 compatibility
* https://issues.couchbase.com/browse/CBL-2001[CBL-2001] -- Android v30 compatibility
...
==== Fixed
// tag::fixed-2-8-6[]
include::{root-partials}pn-issues-list-litecore.adoc[tag=fixed-2-8-6]

* https://issues.couchbase.com/browse/CBL-1984[CBL-1984] -- Support domain specific server authentication
* https://issues.couchbase.com/browse/CBL-2037[CBL-2037] -- Core pool size is too small
* https://issues.couchbase.com/browse/CBL-2089[CBL-2089] -- Replication failed to establish to a sync gateway configured with a system-trusted CA cert
...
include::{root-partials}pn-issues-list-litecore.adoc[tag=knownissues-2-8-6]
