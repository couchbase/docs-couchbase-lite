...
:snippet: android:example$codesnippet_collection.kt
// :snippet-alt: android:example$codesnippet_collection.java
:source-language-alt: Java
:source-language: Kotlin
// :docsnippet: snippets-android-docsnippets}
:url-issues: https://github.com/couchbase/couchbase-lite--android/issues
...
:url-api-references: {url-api-references-pfx}{major}.{minor}.{maintenance-android}/couchbase-lite-android/
