...
== Index
[.pane__frame--blue]
xref:android:refer-glossary.adoc#a[]  |  xref:B>>  |  <<android:refer-glossary.adoc#c[]  |  xref:android:refer-glossary.adoc#d[]  |  xref:E>>  |  <<F>>  |  <<G>>  |  <<H>>  |  <<android:refer-glossary.adoc#i[]  |  xref:J>>  |  <<K>>  |  <<android:refer-glossary.adoc#l[]  |  xref:M>>  |  <<android:refer-glossary.adoc#n[]  |  xref:O>>  |  <<android:refer-glossary.adoc#p[]  |  xref:Q>>  |  <<android:refer-glossary.adoc#r[]  |  xref:android:refer-glossary.adoc#s[]  |  xref:android:refer-glossary.adoc#t[]  |  <<U>>  |  <<V>>  |  <<W>>  |  <<X>>  |  <<Y>>  |  <<Z>>
...
* _Related Term(s)_: xref:android:refer-glossary.adoc#passive-peer[] xref:android:refer-glossary.adoc#peer-to-peer-sync[]
* _Read More_: xref:android:landing-p2psync.adoc[Peer-to-Peer Sync]
...
[[android:refer-glossary:::checkpoint]]Checkpoint::
...
Back to xref:android:refer-glossary.adoc#index[]
...
// tag::cbl-delta-sync[]
// tag::cbl-delta-sync-def[]
* _Related Term(s)_: xref:android:refer-glossary.adoc#passive-replicator[Passive replicator]
* _Read More_: xref:android:replication.adoc#delta-sync[Delta Sync]
// tag::cbl-delta-sync-full[]
...
* _Related Term(s)_: xref:android:refer-glossary.adoc#active-peer[], xref:android:refer-glossary.adoc#peer-to-peer-sync[]
* _Read More_: xref:android:landing-p2psync.adoc[Peer-to-Peer Sync]
// end::cbl-passive-peer[]
...
* _Related Term(s)_: xref:android:refer-glossary.adoc#active-peer[] xref:android:refer-glossary.adoc#passive-peer[]
* _Read More_: xref:android:landing-p2psync.adoc[Peer-to-Peer Sync]
...
* _Related Term(s)_: xref:android:refer-glossary.adoc#active-peer[] xref:android:refer-glossary.adoc#passive-peer[]
* _Read More_: xref:android:p2psync-websocket.adoc[Peer-to-Peer]
