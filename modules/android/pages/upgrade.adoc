...
[#android:upgrade:::android-studio]
== Android Studio
...
[#android:upgrade:::downgrading-couchbase-lite]
== Downgrading Couchbase Lite

[#android:upgrade:::downgrading-between-major-releases]
...
[#android:upgrade:::downgrading-between-minor-releases]
...
[#android:upgrade:::downgrading-between-patch-releases]
...
[#android:upgrade:::related-content]
== Related Content
++++
