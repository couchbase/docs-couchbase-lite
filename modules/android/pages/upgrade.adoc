...
[discrete#android:upgrade:::3-2-0-upgrade]
...
[discrete#android:upgrade:::api-changes]
=== API Changes


This content introduces the changes made to the pass:q,a[pass:q,a[Couchbase{nbsp}Lite]] for Android API for release {version-full}.


[discrete#android:upgrade:::removed]
==== Removed


[discrete#android:upgrade:::resetcheckpoint]
===== ResetCheckpoint
...
Instead, use https://docs.couchbase.com/mobile/{version-full}/couchbase-lite-android/com/couchbase/lite/AbstractReplicator.html#start-boolean-[Replicator.resetCheckpoint(boolean reset)].
...
[discrete#android:upgrade:::database-setloglevel]
...
[discrete#android:upgrade:::database-compact]
===== Database.compact
...
It is replaced by the new https://docs.couchbase.com/mobile/{version-full}/couchbase-lite-android/com/couchbase/lite/Database.html#performMaintenance-com.couchbase.lite.MaintenanceType-[Database.performMaintenance(MaintenanceType)] method, and the maintenance operations represented in the enum https://docs.couchbase.com/mobile/{version-full}/couchbase-lite-android/com/couchbase/lite/MaintenanceType.html[MaintenanceType]
...
[discrete#android:upgrade:::deprecated-in-the-api]
==== Deprecated in the API


[discrete#android:upgrade:::match]
===== MATCH
...
has been deprecated. +
Use https://docs.couchbase.com/mobile/{version-full}/couchbase-lite-android/com/couchbase/lite/FullTextFunction.html[FullTextFunction] instead.
...
[discrete#android:upgrade:::isnullormissingnotnullormissing]
...
[discrete#android:upgrade:::abstractreplicatorconfiguration]
...
[discrete#android:upgrade:::moved-in-the-api]
==== Moved in the API
...
* https://docs.couchbase.com/mobile/{version-full}/couchbase-lite-android/com/couchbase/lite/ReplicatorActivityLevel.html[ReplicatorActivityLevel]
* https://docs.couchbase.com/mobile/{version-full}/couchbase-lite-android/com/couchbase/lite/ReplicatorProgress.html[ReplicatorProgress]
* https://docs.couchbase.com/mobile/{version-full}/couchbase-lite-android/com/couchbase/lite/ReplicatorStatus.html[ReplicatorStatus]
...
[discrete#android:upgrade:::lbl-db-upgrades]
...
[discrete#android:upgrade:::encrypted-databases]
=== Encrypted Databases
...
[discrete#android:upgrade:::handling-of-existing-conflicts]
...
[discrete#android:upgrade:::handling-of-existing-attachments]
...
[discrete#android:upgrade:::replication-compatibility]
...
[discrete#android:upgrade:::visual-studio]
== Visual Studio
