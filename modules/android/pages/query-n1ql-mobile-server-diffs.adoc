...
[#android:query-n1ql-mobile-server-diffs:::boolean-logic-rules]
=== Boolean Logic Rules
...
[#android:query-n1ql-mobile-server-diffs:::logical-operations]
==== Logical Operations
...
[#android:query-n1ql-mobile-server-diffs:::crud-operations]
=== CRUD Operations
{sqlpp} for Mobile only supports Read or Query operations.

{sqlpp} for Server fully supports CRUD operation.

[#android:query-n1ql-mobile-server-diffs:::functions]
=== Functions

[#android:query-n1ql-mobile-server-diffs:::division-operator]
==== Division Operator
...
[#android:query-n1ql-mobile-server-diffs:::round-function]
==== Round Function
[,cols="1a,1a", options="header"]
|===
^| {sqlpp} for Server ^| {sqlpp} for Mobile
...
[#android:query-n1ql-mobile-server-diffs:::related-content]
=== Related Content
++++
