...
[#maint-latest]
[#android:releasenotes:::maint-3-2-1]
== 3.2.1 -- November 2024

Version 3.2.1 for Android delivers the following features and enhancements:

[#android:releasenotes:::couchbase-lite-release-notes]
== Couchbase Lite Release Notes

[#android:releasenotes:::enhancements]
=== Enhancements
...
* https://jira.issues.couchbase.com/browse/CBL-6074[CBL-6074 - Replace Java Finalizer with Cleaner Using Phantom Reference]

[#android:releasenotes:::issues-and-resolutions]
...
[#android:releasenotes:::known-issues]
=== Known Issues

None for this release

[#android:releasenotes:::deprecations]
=== Deprecations
...
[#android:releasenotes:::maint-3-2-0]
== 3.2.0 -- August 2024

Version 3.2.0 for Android delivers the following features and enhancements:

[#android:releasenotes:::couchbase-lite-release-notes-2]
== Couchbase Lite Release Notes

[#android:releasenotes:::downgrade-support]
=== Downgrade Support

Downgrades from 3.2.x to any other version of Couchbase Lite are not supported.

[#android:releasenotes:::enhancements-2]
=== Enhancements
...
[#android:releasenotes:::issues-and-resolutions-2]
=== Issues and Resolutions
...
[#android:releasenotes:::known-issues-2]
=== Known Issues

None for this release

[#android:releasenotes:::deprecations-2]
=== Deprecations
...
[#android:releasenotes:::issues-and-resolutions-3]
=== Issues and Resolutions
...
[#android:releasenotes:::known-issues-3]
=== Known Issues

None for this release

[#android:releasenotes:::deprecations-3]
=== Deprecations
