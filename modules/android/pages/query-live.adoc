...
the query automatically runs and posts the new query result to any observers (change listeners).
...
----
include::android:example$kotlin_snippets/app/src/main/kotlin/com/couchbase/codesnippets/FlowExamples.kt[tag="flow-as-query-change-listener"]
----
...
[.column]
====== {empty}
.Learn more{nbsp}.{nbsp}.{nbsp}.{nbsp}
...
[.column]
====== {empty}
.Dive Deeper{nbsp}.{nbsp}.{nbsp}.{nbsp}
