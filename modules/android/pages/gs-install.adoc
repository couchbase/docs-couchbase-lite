...
:cbl-version-text: pass:q,a[Set the variable `\{version\}` to the Couchbase Lite version number, for example {this-release}.]
...
dependencies {
  ...
  implementation "com.couchbase.lite.kotlin:couchbase-lite-android-ee-ktx:${version}"
