...
IMPORTANT: The Vector Search extension is an *Enterprise only* feature.
...
+
IMPORTANT: You must have Couchbase Lite installed before you can use the Vector Search Extension.
+
--
. Include the following in the `android {}` section:
+
