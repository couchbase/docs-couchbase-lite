...
== Kotlin - Vector Search Extension Install Instructions

More detailed instructions on getting up and running with the Couchbase Lite Vector Search Extension for Android (Kotlin).
...
=== Installing the Vector Search Beta Extension
...
== Java - Vector Search Extension Install Instructions

More detailed instructions on getting up and running with the Couchbase Lite Vector Search Extension for Android (Java).
