...
[#android:gs-install:::introduction]
== Introduction
...
[#android:gs-install:::kotlin-step-by-step-install]
...
[#android:gs-install:::kotlin-vector-search-extension-detailed-installation-instructions]
...
[#android:gs-install:::installing-the-vector-search-extension]
...
[#android:gs-install:::java-step-by-step-install]
...
[#android:gs-install:::java-vector-search-extension-detailed-installation-instructions]
...
[#android:gs-install:::installing-the-vector-search-extension-2]
=== Installing the Vector Search Extension
...
[#android:gs-install:::related-content]
== Related Content
++++
