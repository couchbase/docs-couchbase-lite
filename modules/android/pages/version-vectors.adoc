...
It also improves overall performance and scalability as the number of collaborating devices increases.
...
The `Document.getRevisionID()` method continues to work but now returns version-based IDs.
