...
Couchbase Lite 3.4 / 4.1 for Android adds native support for `kotlinx.serialization`, allowing you to read and write domain model objects directly without manual field-by-field mapping.
