...
Related Content -- xref:cbl-whatsnew.adoc[What's New]  |  xref:android:releasenotes.adoc[Release Notes] | xref:android:supported-os.adoc[Supported Platforms]
--

[discrete#android:compatibility:::couchbase-litesync-gateway-matrix]
...
[discrete#android:compatibility:::operating-system-sdk-support]
...
[discrete#android:compatibility:::related-content]
=== Related Content
++++
...
[discrete.colum#android:compatibility:::-2n]
==== {empty}
.Starting Points
...
[discrete.colum#android:compatibility:::-3n]
==== {empty}
.Tutorials
