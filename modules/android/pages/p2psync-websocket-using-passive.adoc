...
[#android:p2psync-websocket-using-passive:::introduction]
== Introduction
...
[#android:p2psync-websocket-using-passive:::configuration-summary]
...
[#android:p2psync-websocket-using-passive:::api-references]
== API References
...
[#android:p2psync-websocket-using-passive:::device-discovery]
== Device Discovery
...
[#android:p2psync-websocket-using-passive:::initialize-the-listener-configuration]
...
[#android:p2psync-websocket-using-passive:::lbl-set-network-and-port]
== Set Port and Network Interface


[#android:p2psync-websocket-using-passive:::port-number]
=== Port number
...
[#android:p2psync-websocket-using-passive:::network-interface]
=== Network Interface
...
[#android:p2psync-websocket-using-passive:::delta-sync]
== Delta Sync
...
[#android:p2psync-websocket-using-passive:::lbl-tls-security]
== TLS Security


[#android:p2psync-websocket-using-passive:::enable-or-disable-tls]
...
[#android:p2psync-websocket-using-passive:::configure-tls-identity-for-listener]
...
[#android:p2psync-websocket-using-passive:::lbl-authenticating-the-client]
...
[#android:p2psync-websocket-using-passive:::use-basic-authentication]
...
[#android:p2psync-websocket-using-passive:::using-client-certificate-authentication]
...
[#android:p2psync-websocket-using-passive:::delete-tls-identity]
=== Delete Entry
...
[#android:p2psync-websocket-using-passive:::the-impact-of-tls-settings]
...
[#android:p2psync-websocket-using-passive:::monitor-listener]
== Monitor Listener
...
[#android:p2psync-websocket-using-passive:::stop-listener]
== Stop Listener
...
[#android:p2psync-websocket-using-passive:::related-content]
== Related Content
++++
...
[.column#android:p2psync-websocket-using-passive:::-2]
=== {empty}
.Concepts
...
[.column#android:p2psync-websocket-using-passive:::-3]
=== {empty}
.Community Resources ...
