...
[source,kotlin]
----
include::example$code_snippets/MultipeerP2pReplicator.kt[tags="multipeer-collection-simple", indent=0]
----
.Specify collections with some configuration
[source,kotlin]
----
include::example$code_snippets/MultipeerP2pReplicator.kt[tags="multipeer-collection-config", indent=0]
----
...
`MultipeerReplicator` which uses TLS communication by default will require to specify a `TLSIdentity` object for specifying the identity.
...
[source,kotlin]
----
include::example$code_snippets/MultipeerP2pReplicator.kt[tags="multipeer-tlsidentity", indent=0]
----
...
When you specify the certificate authentication callback, the callback receives the remote peer's identity certificate.

When you specify the root certificates, the `MultipeerReplicator` automatically authenticates the remote peer's identity certificate by verifying whether one of the specified root certificates signed the certificate.


.Authenticator with authentication callback
[source,kotlin]
----
include::example$code_snippets/MultipeerP2pReplicator.kt[tags="multipeer-authenticator-callback", indent=0]
----
...
[source,kotlin]
----
include::example$code_snippets/MultipeerP2pReplicator.kt[tags="multipeer-authenticator-rootcerts", indent=0]
----
...
[source,kotlin]
----
include::example$code_snippets/MultipeerP2pReplicator.kt[tags="multipeer-config", indent=0]
----
...
[source,kotlin]
----
include::example$code_snippets/MultipeerP2pReplicator.kt[tags="multipeer-replicator", indent=0]
----
...
[source,kotlin]
----
include::example$code_snippets/MultipeerP2pReplicator.kt[tags="multipeer-permissions", indent=0]
----
...
[source,kotlin]
----
include::example$code_snippets/MultipeerP2pReplicator.kt[tags="multipeer-replicator-start", indent=0]
----
...
[source,kotlin]
----
include::example$code_snippets/MultipeerP2pReplicator.kt[tags="multipeer-replicator-stop", indent=0]
----
...
[source,kotlin]
----
include::example$code_snippets/MultipeerP2pReplicator.kt[tags="multipeer-status-listener", indent=0]
----
...
[source,kotlin]
----
include::example$code_snippets/MultipeerP2pReplicator.kt[tags="multipeer-peer-discovery-listener", indent=0]
----
...
[source,kotlin]
----
include::example$code_snippets/MultipeerP2pReplicator.kt[tags="multipeer-replicator-status-listener", indent=0]
----
...
[source,kotlin]
----
include::example$code_snippets/MultipeerP2pReplicator.kt[tags="multipeer-document-replication-listener", indent=0]
----
...
[source,kotlin]
----
include::example$code_snippets/MultipeerP2pReplicator.kt[tags="multipeer-peer-id", indent=0]
----
...
[source,kotlin]
----
include::example$code_snippets/MultipeerP2pReplicator.kt[tags="multipeer-neighbor-peers", indent=0]
----
...
[source,kotlin]
----
include::example$code_snippets/MultipeerP2pReplicator.kt[tags="multipeer-peer-info", indent=0]
----
...
[source,kotlin]
----
include::example$code_snippets/MultipeerP2pReplicator.kt[tags="multipeer-logdomain", indent=0]
----
