...
.Author's Notes
--
Add content covering CBL P2P sync based on current 1.4 topics.

DOC-6339-H2-P2P: New Topic - HTTP-based sync
https://issues.couchbase.com/browse/DOC-6339

This will be  full description of the http p2p sync from 1.4.
Refactor the content from 1.4 into a new WebsocketEndpointListener topic, link to parent topic DOC-6340.

Source https://docs-archive.couchbase.com/couchbase-lite/1.4/java.html#peer-to-peer
