...
[#android:conflict:::causes-of-conflicts]
== Causes of Conflicts
...
[#android:conflict:::lbl-conflicts-when-replicating]
...
[#android:conflict:::automatic-conflict-resolution]
...
[#android:conflict:::custom-conflict-resolution]
...
[#android:conflict:::conflict-resolver]
=== Conflict Resolver
...
[#android:conflict:::important-guidelines-and-best-practices]
...
[#android:conflict:::configure-the-replicator]
...
[#android:conflict:::conflicts-when-saving]
...
[#android:conflict:::automatic-conflict-resolution-2]
=== Automatic Conflict Resolution
...
[#android:conflict:::custom-conflict-handlers]
...
[#android:conflict:::related-content]
== Related Content
++++
...
= https://docs.couchbase.com/mobile/3.2.1/couchbase-lite-android/[API References]

= https://docs.couchbase.com/mobile/3.2.1/couchbase-lite-android-ktx[Kotlin Extensions]
