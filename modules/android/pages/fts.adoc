...
[#android:fts:::querybuilder]
== QueryBuilder

[#android:fts:::create-index-2]
=== Create Index
...
[#android:fts:::pattern-matching-formats]
...
[#android:fts:::overriding-the-property-name]
...
[#android:fts:::and-or-not-query-operators]
...
[#android:fts:::operator-precedence]
=== Operator Precedence
