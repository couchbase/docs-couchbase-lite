...
[#android:p2psync-custom:::overview]
== Overview
...
[#android:p2psync-custom:::peer-discovery]
== Peer Discovery
...
[#android:p2psync-custom:::active-peer]
=== Active Peer

The first step is to initialize the Couchbase Lite database.

[#android:p2psync-custom:::passive-peer]
=== Passive Peer
...
[#android:p2psync-custom:::peer-selection-and-connection-setup]
...
[#android:p2psync-custom:::replication-setup]
== Replication Setup


image::ROOT:connection.png[]

[#android:p2psync-custom:::active-peer-2]
=== Active Peer
...
[#android:p2psync-custom:::passive-peer-2]
=== Passive Peer
...
[#android:p2psync-custom:::pushpull-replication]
...
[#android:p2psync-custom:::active-peer-3]
=== Active Peer
...
[#android:p2psync-custom:::passive-peer-3]
=== Passive Peer
...
[#android:p2psync-custom:::connection-teardown]
== Connection Teardown
...
[#android:p2psync-custom:::initiated-by-active-peer]
=== Initiated by Active Peer

image::ROOT:dis-active.png[]

[#android:p2psync-custom:::active-peer-4]
=== Active Peer
...
[#android:p2psync-custom:::passive-peer-4]
=== Passive Peer
...
[#android:p2psync-custom:::initiated-by-passive-peer]
=== Initiated by Passive Peer

image::ROOT:dis-passive.png[]

[#android:p2psync-custom:::passive-peer-5]
=== Passive Peer
...
[#android:p2psync-custom:::active-peer-5]
=== Active Peer
...
[#android:p2psync-custom:::related-content]
== Related Content
++++
...
[.column#android:p2psync-custom:::-2]
=== {empty}
.Concepts
...
[.column#android:p2psync-custom:::-3]
=== {empty}
.Community Resources ...
