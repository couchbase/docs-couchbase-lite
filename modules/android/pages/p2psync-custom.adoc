...
`messageEndpointListener` is the instance of the `MessageEndpointListener` that was created in the first step (xref:android:p2psync-custom.adoc#peer-discovery[Peer Discovery])
