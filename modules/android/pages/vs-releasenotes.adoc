...
[#maint-vs-latest]
[#android:vs-releasenotes:::vs-maint-1-0-0-beta-1]
=== 1.0.0 Beta 1 -- March 2024

Version 1.0.0 Beta 1 for Android delivers the following features and enhancements:

[#android:vs-releasenotes:::enhancements]
==== Enhancements

None for this release

[#android:vs-releasenotes:::issues-and-resolutions]
==== Issues and Resolutions

None for this release

[#android:vs-releasenotes:::known-issues]
=====  Known Issues
...
[#android:vs-releasenotes:::deprecations]
==== Deprecations
