...
[source, Kotlin]
----
include::example$examples/GetStartedKotlin/app/src/main/java/com/couchbase/android/getstarted/java/DBManager.java[tag="getting-started"]
----
--
...
[source, Java]
----
include::example$examples/GetStartedJava/app/src/main/java/com/couchbase/android/getstarted/java/DBManager.java[tag="getting-started"]
----
--
