...
[#android:gs-build:::getting-started-app]
== Getting Started App
...
[#android:gs-build:::add-the-app-to-your-own-project]
...
[#android:gs-build:::sample-code-in-detail]
...
[#android:gs-build:::snags-and-pitfalls]
== Snags and Pitfalls
...
[#android:gs-build:::related-content]
== Related Content
++++
