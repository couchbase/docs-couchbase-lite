...
[#android:query-n1ql-mobile:::introduction]
== Introduction
...
[#android:query-n1ql-mobile:::running]
== Running
...
[#android:query-n1ql-mobile:::query-format]
== Query Format
...
| <<android:query-n1ql-mobile:::lbl-unnest>>
a| The criteria used to unpack arrays within a document into individual rows
...
[#android:query-n1ql-mobile:::arguments]
=== Arguments
...
[#android:query-n1ql-mobile:::select-wildcard]
==== Select Wildcard
...
[#android:query-n1ql-mobile:::example]
=== Example
...
[#android:query-n1ql-mobile:::datasource]
=== Datasource
...
[#android:query-n1ql-mobile:::arguments-2]
=== Arguments
...
[#android:query-n1ql-mobile:::example-2]
=== Example
...
[#android:query-n1ql-mobile:::purpose-3]
=== Purpose
...
[#android:query-n1ql-mobile:::syntax-3]
=== Syntax
...
[#android:query-n1ql-mobile:::arguments-3]
=== Arguments
...
[#android:query-n1ql-mobile:::example-3]
=== Example
...
[#android:query-n1ql-mobile:::purpose-4]
=== Purpose

You can use `UNNEST` in queries to unpack arrays within a document into individual rows.
This functionality makes it possible to join them with its parent object in the query.

`UNNEST` is used within the `FROM` clause and can be chained to perform multi-level `UNNEST`.

You can also use a new type of index, the xref:android:indexing.adoc#array-indexing[Array Index], to allow querying with `UNNEST` more efficiently.

NOTE: Couchbase Lite currently supports inner `UNNEST` only.

[#android:query-n1ql-mobile:::syntax-4]
=== Syntax
...
[CAUTION]
--
`"unnest"` will be defined as a new keyword in the SQL++ syntax.
You cannot use the term as an identifier for a property name or data source unless you escape it using backticks.
--

[#android:query-n1ql-mobile:::examples]
=== Examples

For examples of using Array Indexes in conjunction with `UNNEST`, see xref:android:indexing.adoc#array-indexing[Array Index].

We are also accessing the current database using the shorthand notation *`_`* -- see the <<android:query-n1ql-mobile:::lbl-from>> clause for more on data source selection and <<android:query-n1ql-mobile:::lbl-query-params>> for more on parameterized queries.
...
[#android:query-n1ql-mobile:::purpose-5]
=== Purpose
...
[#android:query-n1ql-mobile:::syntax-5]
=== Syntax
...
[#android:query-n1ql-mobile:::arguments-4]
=== Arguments
...
[#android:query-n1ql-mobile:::examples-2]
=== Examples
...
[#android:query-n1ql-mobile:::purpose-6]
=== Purpose
Use `group by` to arrange values in groups of one or more properties.

[#android:query-n1ql-mobile:::syntax-6]
=== Syntax
...
[#android:query-n1ql-mobile:::arguments-5]
=== Arguments
...
[#android:query-n1ql-mobile:::examples-3]
=== Examples
...
[#android:query-n1ql-mobile:::purpose-7]
=== Purpose
Sort query results based on a given expression result.

[#android:query-n1ql-mobile:::syntax-7]
=== Syntax
...
[#android:query-n1ql-mobile:::arguments-6]
=== Arguments
...
[#android:query-n1ql-mobile:::examples-4]
=== Examples
...
[#android:query-n1ql-mobile:::purpose-8]
=== Purpose
Specifies the maximum number of results to be returned by the query.

[#android:query-n1ql-mobile:::syntax-8]
=== Syntax
...
[#android:query-n1ql-mobile:::purpose-9]
=== Purpose
Specifies the number of results to be skipped by the query.

[#android:query-n1ql-mobile:::syntax-9]
=== Syntax
...
[#android:query-n1ql-mobile:::arguments-8]
=== Arguments
...
[#android:query-n1ql-mobile:::examples-6]
=== Examples
...
[#android:query-n1ql-mobile:::lbl-literals]
== Expressions
In this section::
...
[#android:query-n1ql-mobile:::lbl-exp-literals]
=== Literals
...
[#android:query-n1ql-mobile:::lbl-lit-bool]
==== Boolean

[#android:query-n1ql-mobile:::purpose-10]
==== Purpose
Represents a true or false value.

[#android:query-n1ql-mobile:::syntax-10]
==== Syntax

`TRUE | FALSE`

[#android:query-n1ql-mobile:::example-4]
==== Example
...
[#android:query-n1ql-mobile:::lbl-lit-numbers]
==== Numeric

[#android:query-n1ql-mobile:::purpose-11]
==== Purpose
Represents a numeric value.
Numbers may be signed or unsigned digits.
They have optional fractional and exponent components.

[#android:query-n1ql-mobile:::syntax-11]
==== Syntax
...
[#android:query-n1ql-mobile:::example-5]
==== Example
...
[#android:query-n1ql-mobile:::lbl-lit-string]
==== String

[#android:query-n1ql-mobile:::purpose-12]
==== Purpose
The string literal represents a string or sequence of characters.


[#android:query-n1ql-mobile:::syntax-12]
==== Syntax
...
[#android:query-n1ql-mobile:::example-6]
==== Example
[source,sql]
----
...
[#android:query-n1ql-mobile:::lbl-lit-null]
==== NULL

[#android:query-n1ql-mobile:::purpose-13]
==== Purpose
The literal NULL represents an empty value.

[#android:query-n1ql-mobile:::syntax-13]
==== Syntax
...
[#android:query-n1ql-mobile:::example-7]
==== Example
[source,sql]
----
...
[#android:query-n1ql-mobile:::lbl-lit-missing]
==== MISSING

[#android:query-n1ql-mobile:::purpose-14]
==== Purpose
The MISSING literal represents a missing name-value pair in a document.

[#android:query-n1ql-mobile:::syntax-14]
==== Syntax
...
[#android:query-n1ql-mobile:::example-8]
==== Example
[source,sql]
----
...
[#android:query-n1ql-mobile:::lbl-lit-array]
==== Array

[#android:query-n1ql-mobile:::purpose-15]
==== Purpose
Represents an Array

[#android:query-n1ql-mobile:::syntax-15]
==== Syntax
...
[#android:query-n1ql-mobile:::example-9]
==== Example
[source,sql]
----
SELECT [“a”, “b”, “c”] FROM _
...
[#android:query-n1ql-mobile:::lbl-lit-dict]
==== Dictionary

[#android:query-n1ql-mobile:::purpose-16]
==== Purpose
Represents a dictionary literal

[#android:query-n1ql-mobile:::syntax-16]
==== Syntax
...
[#android:query-n1ql-mobile:::example-10]
==== Example
[source,sql]
----
...
[#android:query-n1ql-mobile:::lbl-exp-ident]
=== Identifiers

[#android:query-n1ql-mobile:::purpose-17]
==== Purpose
...
[#android:query-n1ql-mobile:::syntax-17]
==== Syntax
...
[#android:query-n1ql-mobile:::example-11]
==== Example
...
[#android:query-n1ql-mobile:::lbl-exp-prop]
=== Property Expressions

[#android:query-n1ql-mobile:::purpose-18]
==== Purpose
The property expression is used to reference a property in a document

[#android:query-n1ql-mobile:::syntax-18]
==== Syntax
...
[#android:query-n1ql-mobile:::example-12]
==== Example
...
[#android:query-n1ql-mobile:::lbl-exp-any]
=== Any and Every Expressions

[#android:query-n1ql-mobile:::purpose-19]
==== Purpose
Evaluates expressions over items in an array object.


[#android:query-n1ql-mobile:::syntax-19]
==== Syntax
...
[#android:query-n1ql-mobile:::example-13]
==== Example
...
[#android:query-n1ql-mobile:::lbl-exp-param]
=== Parameter Expressions

[#android:query-n1ql-mobile:::purpose-20]
==== Purpose
...
[#android:query-n1ql-mobile:::syntax-20]
==== Syntax
...
[#android:query-n1ql-mobile:::examples-7]
==== Examples
...
[#android:query-n1ql-mobile:::lbl-operators]
== Operators
In this section::
...
[#android:query-n1ql-mobile:::lbl-ops-binary]
=== Binary Operators
...
[#android:query-n1ql-mobile:::lbl-ops-maths]
==== Maths
...
[#android:query-n1ql-mobile:::lbl-comp-ops]
==== Comparison Operators

[#android:query-n1ql-mobile:::purpose-22]
==== Purpose
The _comparison operators_ are used in the WHERE statement to specify the condition on which to match documents.

.Comparison Operators
[#tbl-ops-comp]
[ops-comp#android:query-n1ql-mobile:::tbl-ops-comp, cols="^1m,2,2m", options="header"]
|===
...
[#tbl-ops-isnot]
[ops-comp#android:query-n1ql-mobile:::tbl-ops-isnot, cols="^1,^1,^1,^1", options="header"]
|===
...
[#android:query-n1ql-mobile:::lbl-ops-logical]
==== Logical Operators

[#android:query-n1ql-mobile:::purpose-23]
==== Purpose
...
.Logical Operators
[#tbl-ops-logical]
[ops-comp#android:query-n1ql-mobile:::tbl-ops-logical, cols="^1m,2,2m", options="header"]
|===
...
[#android:query-n1ql-mobile:::purpose-24]
==== Purpose
...
[#android:query-n1ql-mobile:::lbl-ops-unary]
=== Unary Operators

[#android:query-n1ql-mobile:::purpose-25]
==== Purpose
...
[#android:query-n1ql-mobile:::syntax-21]
==== Syntax
...
[#android:query-n1ql-mobile:::lbl-ops-coll]
=== COLLATE Operators

[#android:query-n1ql-mobile:::purpose-26]
==== Purpose
Collate operators specify how the string comparison is conducted.

[#android:query-n1ql-mobile:::usage]
==== Usage
...
[#android:query-n1ql-mobile:::syntax-22]
==== Syntax
...
[#android:query-n1ql-mobile:::arguments-9]
==== Arguments
...
[#android:query-n1ql-mobile:::example-15]
==== Example
...
[#android:query-n1ql-mobile:::example-16]
==== Example
...
[#android:query-n1ql-mobile:::lbl-functions]
== Functions
In this section::
...
[#android:query-n1ql-mobile:::purpose-28]
=== Purpose

Functions are also expressions.

[#android:query-n1ql-mobile:::syntax-24]
=== Syntax
...
[#android:query-n1ql-mobile:::lbl-func-agg]
...
[#android:query-n1ql-mobile:::lbl-func-array]
=== Array Functions
...
[#android:query-n1ql-mobile:::lbl-func-cond]
...
[#android:query-n1ql-mobile:::lbl-func-date]
...
[#android:query-n1ql-mobile:::lbl-func-fts]
...
[#android:query-n1ql-mobile:::lbl-func-maths]
=== Maths Functions
...
[#android:query-n1ql-mobile:::lbl-func-meta]
=== Metadata Functions
...
[#android:query-n1ql-mobile:::lbl-func-pattern]
...
[#android:query-n1ql-mobile:::lbl-func-string]
=== String Functions
...
[#android:query-n1ql-mobile:::lbl-func-typecheck]
...
[#android:query-n1ql-mobile:::querybuilder-differences]
...
[#android:query-n1ql-mobile:::lbl-query-params]
== Query Parameters
...
[#android:query-n1ql-mobile:::related-content]
== Related Content
++++
...
[.column#android:query-n1ql-mobile:::-2]
====== {empty}
.Learn more . . .
...
[.column#android:query-n1ql-mobile:::-3]
====== {empty}
.Dive Deeper . . .
