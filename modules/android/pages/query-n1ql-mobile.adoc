...
This API uses query statements of the form shown in xref:android:query-n1ql-mobile.adoc#ex-query-form[].
...
We are accessing the current database using the shorthand notation *`_`* -- see the xref:android:query-n1ql-mobile.adoc#lbl-from[] clause for more on data source selection and xref:android:query-n1ql-mobile.adoc#lbl-query-params[] for more on parameterized queries.


[#query-format]
== Query Format

The API uses query statements of the form shown in xref:android:query-n1ql-mobile.adoc#ex-query-form[].
...
You can use the wildcard *** to select all columns -- see xref:android:query-n1ql-mobile.adoc#select-wildcard[]
...
This behavior is inline with that of Couchbase Server {sqlpp} -- see example in xref:android:query-n1ql-mobile.adoc#tbl-selstar[].
...
<.> `JOIN joinclause` -- use this optional argument to link datasources -- see xref:android:query-n1ql-mobile.adoc#lbl-join[]
...
For example to combine airline details with route details, linked by the airline id -- see xref:android:query-n1ql-mobile.adoc#ex-join[].
...
We are also accessing the current database using the shorthand notation *`_`* -- see the xref:android:query-n1ql-mobile.adoc#lbl-from[] clause for more on data source selection and xref:android:query-n1ql-mobile.adoc#lbl-query-params[] for more on parameterized queries.
...
See also -- xref:android:query-n1ql-mobile.adoc#lbl-operators[] for more on building expressions and xref:android:query-n1ql-mobile.adoc#lbl-query-params[] for more on parameterized queries.
...
== Expressions
In this section::
  xref:android:query-n1ql-mobile.adoc#lbl-exp-literals[]{nbsp}{nbsp}|{nbsp}{nbsp}
  xref:android:query-n1ql-mobile.adoc#lbl-exp-ident[]{nbsp}{nbsp}|{nbsp}{nbsp}
  xref:android:query-n1ql-mobile.adoc#lbl-exp-prop[]{nbsp}{nbsp}|{nbsp}{nbsp}
  xref:android:query-n1ql-mobile.adoc#lbl-exp-any[]{nbsp}{nbsp}|{nbsp}{nbsp}
  xref:android:query-n1ql-mobile.adoc#lbl-exp-param[]{nbsp}{nbsp}|{nbsp}{nbsp}
  xref:android:query-n1ql-mobile.adoc#lbl-exp-paren[]

Expressions are references to identifiers that resolve to values.
Categories of expression comprise the elements covered in this section (see above), together with xref:android:query-n1ql-mobile.adoc#lbl-operators[] and xref:android:query-n1ql-mobile.adoc#lbl-functions[], which are covered in their own sections


[#lbl-exp-literals]
=== Literals
xref:android:query-n1ql-mobile.adoc#lbl-lit-bool[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:android:query-n1ql-mobile.adoc#lbl-lit-numbers[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:android:query-n1ql-mobile.adoc#lbl-lit-string[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:android:query-n1ql-mobile.adoc#lbl-lit-null[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:android:query-n1ql-mobile.adoc#lbl-lit-missing[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:android:query-n1ql-mobile.adoc#lbl-lit-array[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:android:query-n1ql-mobile.adoc#lbl-lit-dict[]{nbsp}{nbsp}|{nbsp}{nbsp}
...
== Operators
In this section::
xref:android:query-n1ql-mobile.adoc#lbl-ops-binary[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:android:query-n1ql-mobile.adoc#lbl-ops-unary[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:android:query-n1ql-mobile.adoc#lbl-ops-coll[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:android:query-n1ql-mobile.adoc#lbl-ops-cond[]


[#lbl-ops-binary]
=== Binary Operators
xref:android:query-n1ql-mobile.adoc#lbl-ops-maths[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:android:query-n1ql-mobile.adoc#lbl-comp-ops[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:android:query-n1ql-mobile.adoc#lbl-ops-logical[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:android:query-n1ql-mobile.adoc#lbl-ops-string[]
...
.Comparison Operators
[#tbl-ops-comp]
[ops-comp#tbl-ops-comp, cols="^1m,2,2m", options="header"]
|===
...
|MATCH
|String matching using FTS see xref:android:query-n1ql-mobile.adoc#lbl-func-fts[]
...
[#tbl-ops-isnot]
[ops-comp#tbl-ops-isnot, cols="^1,^1,^1,^1", options="header"]
|===
...
.Logical Operators
[#tbl-ops-logical]
[ops-comp#tbl-ops-logical, cols="^1m,2,2m", options="header"]
|===
...
== Functions
In this section::
xref:android:query-n1ql-mobile.adoc#lbl-func-agg[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:android:query-n1ql-mobile.adoc#lbl-func-array[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:android:query-n1ql-mobile.adoc#lbl-func-cond[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:android:query-n1ql-mobile.adoc#lbl-func-date[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:android:query-n1ql-mobile.adoc#lbl-func-fts[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:android:query-n1ql-mobile.adoc#lbl-func-maths[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:android:query-n1ql-mobile.adoc#lbl-func-meta[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:android:query-n1ql-mobile.adoc#lbl-func-pattern[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:android:query-n1ql-mobile.adoc#lbl-func-string[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:android:query-n1ql-mobile.adoc#lbl-func-typecheck[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:android:query-n1ql-mobile.adoc#lbl-func-typeconv[]
...
Couchbase Lite {sqlpp} Query supports all QueryBuilder features, except _Predictive Query_ and _Index_. See xref:android:query-n1ql-mobile.adoc#tbl-qbldr-diffs[] for the features supported by {sqlpp} but not by QueryBuilder.
...
To specify substitutable parameters within your query string prefix the name with *`$`*, `$type` -- see: xref:android:query-n1ql-mobile.adoc#ex-sample-params[].
