...
// API Reference Links
//
:url-api-references: {url-api-references-pfx}{major}.{minor}.{maintenance-ios}/couchbase-lite-objc
//
...
:url-api-method-document-getdate: {url-api-references-protocols}{api-pfx}Dictionary.html#/c:objc(pl)CBLDictionary(im)dateForKey:[dateForKey:]
