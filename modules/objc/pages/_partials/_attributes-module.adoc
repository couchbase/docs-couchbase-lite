...
:url-api-classes-query-expression: {url-api-classes-query-expression-pfx}[{api-pfx}Expression]
...
:url-api-classes-query-arrayfunction-collection-ops: {url-api-references-classes}{api-pfx}QueryArrayExpression.html[ArrayFunction Collection Operators]
