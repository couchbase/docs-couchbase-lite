...
Just pass in a database name and optionally a https://docs.couchbase.com/mobile/{major}.{minor}.{maintenance-ios}{empty}/couchbase-lite-objc/Classes/CBLDatabaseConfiguration.html[CBLDatabaseConfiguration] -- see xref:objc:database.adoc#ex-dbopen[].
...
See also xref:objc:database.adoc#lbl-find-db-loc[].
--
...
To close a database, use https://docs.couchbase.com/mobile/{major}.{minor}.{maintenance-ios}{empty}/couchbase-lite-objc/Classes/CBLDatabase.html#/c:objc(cs)CBLDatabase(im)close:[CBLDatabase.Close()] -- see: xref:objc:database.adoc#ex-dbclose[].
This also closes
...
Provide this encryption key every time the database is opened -- see xref:objc:database.adoc#ex-sdb-encrypt[].
...
If the information in the default logging level is insufficient you can focus it on database errors and generate more verbose messages -- see: xref:objc:database.adoc#ex-logdb[].

For more on using Couchbase logs -- see: xref:objc:new-logging-logs.adoc[Using Logs].
