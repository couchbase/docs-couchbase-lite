...
[#objc:p2psync-websocket-using-active:::introduction]
== Introduction
...
[#objc:p2psync-websocket-using-active:::configuration-summary]
...
[#objc:p2psync-websocket-using-active:::api-references]
== API References
...
[#objc:p2psync-websocket-using-active:::device-discovery]
== Device Discovery
...
[#objc:p2psync-websocket-using-active:::configure-replicator]
...
[#objc:p2psync-websocket-using-active:::certificate-authentication]
...
[#objc:p2psync-websocket-using-active:::initialize-replicator]
...
[#objc:p2psync-websocket-using-active:::lbl-repl-mon]
== Monitor Sync
...
[#objc:p2psync-websocket-using-active:::lbl-repl-states]
=== Replication States
...
[#objc:p2psync-websocket-using-active:::replication-status-and-app-life-cycle]
...
[#objc:p2psync-websocket-using-active:::lbl-repl-stop]
== Stop Sync
...
[#objc:p2psync-websocket-using-active:::conflict-resolution]
== Conflict Resolution
...
[#objc:p2psync-websocket-using-active:::delta-sync]
== Delta Sync
If delta sync is enabled on the listener, then replication will use delta sync.


[#objc:p2psync-websocket-using-active:::related-content]
== Related Content
++++
...
[.column#objc:p2psync-websocket-using-active:::-2]
=== {empty}
.Concepts
...
[.column#objc:p2psync-websocket-using-active:::-3]
=== {empty}
.Community Resources ...
