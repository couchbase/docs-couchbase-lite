...
To change default settings use database's https://docs.couchbase.com/mobile/{major}.{minor}.{maintenance-ios}{empty}/couchbase-lite-objc/Classes/CBLLog.html[CBLLog] method to set the required values -- see <<eg-cons-log>>
...
To do this, apps must implement the https://docs.couchbase.com/mobile/{major}.{minor}.{maintenance-ios}{empty}/couchbase-lite-objc/Protocols/CBLLogger.html[CBLLogger] interface -- see <<eg-impl-log>> -- and enable custom logging using https://docs.couchbase.com/mobile/{major}.{minor}.{maintenance-ios}{empty}/couchbase-lite-objc/Classes/CBLLog.html#/c:objc(cs)CBLLog(py)custom[CBLLog.custom] -- see <<eg-cust-log>>.
