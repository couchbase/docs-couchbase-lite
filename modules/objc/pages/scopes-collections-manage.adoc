...
[#objc:scopes-collections-manage:::default-scopes-and-collections]
...
[#objc:scopes-collections-manage:::create-a-scope-and-collection]
...
[#objc:scopes-collections-manage:::index-a-collection]
== Index a Collection
...
[#objc:scopes-collections-manage:::drop-a-collection]
== Drop a Collection
...
[#objc:scopes-collections-manage:::list-scopes-and-collections]
