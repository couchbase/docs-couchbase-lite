...
include::objc:example$code_snippets/VectorSearch.m[tags=vs-create-default-config;vs-create-custom-config]
...
include::objc:example$code_snippets/VectorSearch.m[tags=vs-use-vector-match]
...
include::objc:example$code_snippets/VectorSearch.m[tags=vs-use-vector-distance]
