...
[#objc:working-with-vector-search:::use-vector-search]
== Use Vector Search
...
[#objc:working-with-vector-search:::create-a-vector-index]
== Create a Vector Index

This method shows how you can create a vector index using the Couchbase Lite Vector Search extension.

// include::objc:example$code_snippets/VectorSearch.m[tags=vs-create-custom-config]
[source, objc]
----
...
[#objc:working-with-vector-search:::vector-index-configuration]
...
[#objc:working-with-vector-search:::generating-vectors]
== Generating Vectors
...
[#objc:working-with-vector-search:::create-a-vector-index-with-embeddings]
=== Create a Vector Index with Embeddings

This method shows you how to create a Vector Index with embeddings.

// include::objc:example$code_snippets/VectorSearch.m[tags=vs-create-index]
[source, objc]
----
...
[#objc:working-with-vector-search:::create-vector-index-embeddings-from-a-predictive-model]
...
// include::objc:example$code_snippets/VectorSearch.m[tags=vs-create-predictive-index]
[source, objc]
----
...
[#objc:working-with-vector-search:::create-a-lazy-vector-index]
...
// include::objc:example$code_snippets/VectorSearch.m[tags=vs-lazy-index-config]
[source, objc]
----
...
[#objc:working-with-vector-search:::updating-the-lazy-index]
=== Updating the Lazy Index

Below is an example of how you can update your lazy index.

// include::objc:example$code_snippets/VectorSearch.m[tags=vs-create-lazy-index-embedding]
[source, objc]
----
...
[#objc:working-with-vector-search:::vector-search-sql-support]
...
[#objc:working-with-vector-search:::use-hybrid-vector-search]
...
[#objc:working-with-vector-search:::hybrid-vector-search-with-full-text-match]
=== Hybrid Vector Search with Full Text Match

Below is an example of using Hybrid Search with the Full Text `match()` function.

// include::objc:example$code_snippets/VectorSearch.m[tags=vs-hybrid-ftmatch]
[source, objc]
----
...
[#objc:working-with-vector-search:::prediction-with-hybrid-vector-search]
...
// include::objc:example$code_snippets/VectorSearch.m[tags=vs-hybrid-prediction]
[source, objc]
----
...
[#objc:working-with-vector-search:::approx_vector_distancevector-expr-target-vector-metric-nprobes-accurate]
...
[#objc:working-with-vector-search:::use-approx_vector_distance]
=== Use `APPROX_VECTOR_DISTANCE()`

// include::objc:example$code_snippets/VectorSearch.m[tags=vs-apvd-where]
[source, objc]
----
...
[#objc:working-with-vector-search:::prediction-with-approx_vector_distance]
...
// include::objc:example$code_snippets/VectorSearch.m[tags=vs-apvd-prediction]
[source, objc]
----
...
[#objc:working-with-vector-search:::see-also]
== See Also
