...
[#objc:query-troubleshooting:::query-explain]
== Query Explain


[#objc:query-troubleshooting:::using]
=== Using
...
[#objc:query-troubleshooting:::output]
=== Output
...
[#objc:query-troubleshooting:::the-query-plan]
== The Query Plan


[#objc:query-troubleshooting:::format]
=== Format
...
[#objc:query-troubleshooting:::ret-method]
=== Retrieval Method
...
[#objc:query-troubleshooting:::order-group]
=== Order and Group
...
[#objc:query-troubleshooting:::queries-and-indexes]
== Queries and Indexes
...
[#objc:query-troubleshooting:::working-with-the-query-optimizer]
...
[#objc:query-troubleshooting:::use-like-based-queries]
...
[source#objc:query-troubleshooting:::like-wild-pfx-qry, objc]
----
...
[#objc:query-troubleshooting:::use-functions-wisely]
...
[source#objc:query-troubleshooting:::use-like-based-queries, objc]
----
CBLQueryExpression *type =
...
[#objc:query-troubleshooting:::optimization-considerations]
...
[#objc:query-troubleshooting:::related-content]
== Related Content
++++
...
[.column#objc:query-troubleshooting:::-2]
====== {empty}
.Learn more . . .
...
[.column#objc:query-troubleshooting:::-3]
====== {empty}
.Dive Deeper . . .
