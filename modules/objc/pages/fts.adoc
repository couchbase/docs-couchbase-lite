...
[#objc:fts:::querybuilder]
=== QueryBuilder

[#objc:fts:::create-index-2]
==== Create Index
...
[#objc:fts:::pattern-matching-formats]
...
[#objc:fts:::overriding-the-property-name]
...
[#objc:fts:::and-or-not-query-operators]
