...
If Sync Gateway is configured with a self signed certificate, and your app points to a `wss` scheme but the replicator configuration isn't'git pull using the certificate you will encounter an error with status code `5011` -- see: <<ex-5011>>
