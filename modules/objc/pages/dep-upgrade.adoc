...
* Install the Couchbase Lite 2.0 framework in your project  -- see: xref:{param-module}:gs-install.adoc[].
...
This functionality is related to the way conflicts are being handled in Couchbase Lite 2.0  -- see xref:{param-module}:conflict.adoc[Handling Conflicts].
