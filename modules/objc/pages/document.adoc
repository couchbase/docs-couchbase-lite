...
[#objc:document:::overview]
== Overview


[#objc:document:::document-structure]
=== Document Structure
...
[#objc:document:::constructing-a-document]
...
[#objc:document:::create-a-document]
=== Create a Document
...
[#objc:document:::create-a-dictionary]
=== Create a Dictionary
...
[#objc:document:::populate-a-document]
=== Populate a Document
...
[#objc:document:::close-the-database]
=== Close the Database
...
[#objc:document:::working-with-data]
== Working with Data


[#objc:document:::date-accessors]
=== Date accessors
...
[#objc:document:::using-dictionaries]
=== Using Dictionaries
...
[#objc:document:::using-blobs]
=== Using Blobs

For more on working with blobs, see xref:objc:blob.adoc[Blobs]


[#objc:document:::document-initializers]
...
[#objc:document:::batch-operations]
== Batch operations
...
[#objc:document:::document-change-events]
...
[#objc:document:::document-expiration]
== Document Expiration
...
[#objc:document:::lbl-doc-constraints]
