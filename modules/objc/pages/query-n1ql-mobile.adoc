...
[#objc:query-n1ql-mobile:::introduction]
== Introduction
...
[#objc:query-n1ql-mobile:::running]
== Running
...
[#objc:query-n1ql-mobile:::query-format]
== Query Format
...
| <<objc:query-n1ql-mobile:::lbl-unnest>>
...
[#objc:query-n1ql-mobile:::arguments]
=== Arguments
...
[#objc:query-n1ql-mobile:::select-wildcard]
==== Select Wildcard
...
[#objc:query-n1ql-mobile:::example]
=== Example
...
[#objc:query-n1ql-mobile:::datasource]
=== Datasource
...
[#objc:query-n1ql-mobile:::arguments-2]
=== Arguments
...
[#objc:query-n1ql-mobile:::example-2]
=== Example
...
[#objc:query-n1ql-mobile:::purpose-3]
=== Purpose
...
[#objc:query-n1ql-mobile:::syntax-3]
=== Syntax
...
[#objc:query-n1ql-mobile:::arguments-3]
=== Arguments
...
[#objc:query-n1ql-mobile:::example-3]
=== Example
...
[#objc:query-n1ql-mobile:::purpose-4]
=== Purpose
...
You can also use a new type of index, the xref:objc:indexing.adoc#array-indexing[Array Index], to allow querying with `UNNEST` more efficiently.

NOTE: Couchbase Lite currently supports inner `UNNEST` only.

[#objc:query-n1ql-mobile:::syntax-4]
=== Syntax
...
[#objc:query-n1ql-mobile:::examples]
=== Examples

For examples of using Array Indexes in conjunction with `UNNEST`, see xref:objc:indexing.adoc#array-indexing[Array Index].

We are also accessing the current database using the shorthand notation *`_`* -- see the <<objc:query-n1ql-mobile:::lbl-from>> clause for more on data source selection and <<objc:query-n1ql-mobile:::lbl-query-params>> for more on parameterized queries.
...
[#objc:query-n1ql-mobile:::purpose-5]
=== Purpose
...
[#objc:query-n1ql-mobile:::syntax-5]
=== Syntax
...
[#objc:query-n1ql-mobile:::arguments-4]
=== Arguments
...
[#objc:query-n1ql-mobile:::examples-2]
=== Examples
...
[#objc:query-n1ql-mobile:::arguments-5]
=== Arguments
...
[#objc:query-n1ql-mobile:::examples-3]
=== Examples
...
[#objc:query-n1ql-mobile:::purpose-7]
=== Purpose
Sort query results based on a given expression result.

[#objc:query-n1ql-mobile:::syntax-7]
=== Syntax
...
[#objc:query-n1ql-mobile:::arguments-6]
=== Arguments
...
[#objc:query-n1ql-mobile:::examples-4]
=== Examples
...
[#objc:query-n1ql-mobile:::purpose-9]
=== Purpose
Specifies the number of results to be skipped by the query.

[#objc:query-n1ql-mobile:::syntax-9]
=== Syntax
...
[#objc:query-n1ql-mobile:::arguments-8]
=== Arguments
...
[#objc:query-n1ql-mobile:::examples-6]
=== Examples
...
[#objc:query-n1ql-mobile:::lbl-literals]
== Expressions
In this section::
...
[#objc:query-n1ql-mobile:::lbl-exp-literals]
=== Literals
...
[#objc:query-n1ql-mobile:::lbl-lit-bool]
==== Boolean

[#objc:query-n1ql-mobile:::purpose-10]
==== Purpose
Represents a true or false value.

[#objc:query-n1ql-mobile:::syntax-10]
==== Syntax

`TRUE | FALSE`

[#objc:query-n1ql-mobile:::example-4]
==== Example
...
[#objc:query-n1ql-mobile:::lbl-lit-numbers]
==== Numeric

[#objc:query-n1ql-mobile:::purpose-11]
==== Purpose
Represents a numeric value.
Numbers may be signed or unsigned digits.
They have optional fractional and exponent components.

[#objc:query-n1ql-mobile:::syntax-11]
==== Syntax
...
[#objc:query-n1ql-mobile:::example-5]
==== Example
...
[#objc:query-n1ql-mobile:::lbl-lit-string]
==== String

[#objc:query-n1ql-mobile:::purpose-12]
==== Purpose
The string literal represents a string or sequence of characters.


[#objc:query-n1ql-mobile:::syntax-12]
==== Syntax
...
[#objc:query-n1ql-mobile:::example-6]
==== Example
[source,sql]
----
...
[#objc:query-n1ql-mobile:::lbl-lit-null]
==== NULL

[#objc:query-n1ql-mobile:::purpose-13]
==== Purpose
The literal NULL represents an empty value.

[#objc:query-n1ql-mobile:::syntax-13]
==== Syntax
...
[#objc:query-n1ql-mobile:::example-7]
==== Example
[source,sql]
----
...
[#objc:query-n1ql-mobile:::lbl-lit-missing]
==== MISSING

[#objc:query-n1ql-mobile:::purpose-14]
==== Purpose
The MISSING literal represents a missing name-value pair in a document.

[#objc:query-n1ql-mobile:::syntax-14]
==== Syntax
...
[#objc:query-n1ql-mobile:::example-8]
==== Example
[source,sql]
----
...
[#objc:query-n1ql-mobile:::lbl-lit-array]
==== Array

[#objc:query-n1ql-mobile:::purpose-15]
==== Purpose
Represents an Array

[#objc:query-n1ql-mobile:::syntax-15]
==== Syntax
...
[#objc:query-n1ql-mobile:::example-9]
==== Example
[source,sql]
----
SELECT [“a”, “b”, “c”] FROM _
...
[#objc:query-n1ql-mobile:::lbl-lit-dict]
==== Dictionary

[#objc:query-n1ql-mobile:::purpose-16]
==== Purpose
Represents a dictionary literal

[#objc:query-n1ql-mobile:::syntax-16]
==== Syntax
...
[#objc:query-n1ql-mobile:::example-10]
==== Example
[source,sql]
----
...
[#objc:query-n1ql-mobile:::lbl-exp-ident]
=== Identifiers

[#objc:query-n1ql-mobile:::purpose-17]
==== Purpose
...
[#objc:query-n1ql-mobile:::syntax-17]
==== Syntax
...
[#objc:query-n1ql-mobile:::example-11]
==== Example
...
[#objc:query-n1ql-mobile:::lbl-exp-prop]
=== Property Expressions

[#objc:query-n1ql-mobile:::purpose-18]
==== Purpose
The property expression is used to reference a property in a document

[#objc:query-n1ql-mobile:::syntax-18]
==== Syntax
...
[#objc:query-n1ql-mobile:::example-12]
==== Example
...
[#objc:query-n1ql-mobile:::lbl-exp-any]
=== Any and Every Expressions

[#objc:query-n1ql-mobile:::purpose-19]
==== Purpose
Evaluates expressions over items in an array object.


[#objc:query-n1ql-mobile:::syntax-19]
==== Syntax
...
[#objc:query-n1ql-mobile:::example-13]
==== Example
...
[#objc:query-n1ql-mobile:::lbl-exp-param]
=== Parameter Expressions

[#objc:query-n1ql-mobile:::purpose-20]
==== Purpose
...
[#objc:query-n1ql-mobile:::syntax-20]
==== Syntax
...
[#objc:query-n1ql-mobile:::examples-7]
==== Examples
...
[#objc:query-n1ql-mobile:::lbl-operators]
== Operators
In this section::
...
[#objc:query-n1ql-mobile:::lbl-ops-binary]
=== Binary Operators
...
[#objc:query-n1ql-mobile:::lbl-ops-maths]
==== Maths
...
[#objc:query-n1ql-mobile:::lbl-comp-ops]
==== Comparison Operators

[#objc:query-n1ql-mobile:::purpose-22]
==== Purpose
The _comparison operators_ are used in the WHERE statement to specify the condition on which to match documents.

.Comparison Operators
[#tbl-ops-comp]
[ops-comp#objc:query-n1ql-mobile:::tbl-ops-comp, cols="^1m,2,2m", options="header"]
|===
...
[#tbl-ops-isnot]
[ops-comp#objc:query-n1ql-mobile:::tbl-ops-isnot, cols="^1,^1,^1,^1", options="header"]
|===
...
[#objc:query-n1ql-mobile:::lbl-ops-logical]
==== Logical Operators

[#objc:query-n1ql-mobile:::purpose-23]
==== Purpose
...
.Logical Operators
[#tbl-ops-logical]
[ops-comp#objc:query-n1ql-mobile:::tbl-ops-logical, cols="^1m,2,2m", options="header"]
|===
...
[#objc:query-n1ql-mobile:::purpose-24]
==== Purpose
...
[#objc:query-n1ql-mobile:::lbl-ops-unary]
=== Unary Operators

[#objc:query-n1ql-mobile:::purpose-25]
==== Purpose
...
[#objc:query-n1ql-mobile:::syntax-21]
==== Syntax
...
[#objc:query-n1ql-mobile:::lbl-ops-coll]
=== COLLATE Operators

[#objc:query-n1ql-mobile:::purpose-26]
==== Purpose
Collate operators specify how the string comparison is conducted.

[#objc:query-n1ql-mobile:::usage]
==== Usage
...
[#objc:query-n1ql-mobile:::syntax-22]
==== Syntax
...
[#objc:query-n1ql-mobile:::arguments-9]
==== Arguments
...
[#objc:query-n1ql-mobile:::example-15]
==== Example
...
[#objc:query-n1ql-mobile:::example-16]
==== Example
...
[#objc:query-n1ql-mobile:::lbl-functions]
== Functions
In this section::
...
[#objc:query-n1ql-mobile:::purpose-28]
=== Purpose

Functions are also expressions.

[#objc:query-n1ql-mobile:::syntax-24]
=== Syntax
...
[#objc:query-n1ql-mobile:::lbl-func-agg]
...
[#objc:query-n1ql-mobile:::lbl-func-array]
=== Array Functions
...
[#objc:query-n1ql-mobile:::lbl-func-cond]
...
[#objc:query-n1ql-mobile:::lbl-func-date]
...
[#objc:query-n1ql-mobile:::lbl-func-fts]
...
[#objc:query-n1ql-mobile:::lbl-func-maths]
=== Maths Functions
...
[#objc:query-n1ql-mobile:::lbl-func-meta]
=== Metadata Functions
...
[#objc:query-n1ql-mobile:::lbl-func-pattern]
...
[#objc:query-n1ql-mobile:::lbl-func-string]
=== String Functions
...
[#objc:query-n1ql-mobile:::lbl-func-typecheck]
...
[#objc:query-n1ql-mobile:::querybuilder-differences]
...
[#objc:query-n1ql-mobile:::lbl-query-params]
== Query Parameters
...
[#objc:query-n1ql-mobile:::related-content]
== Related Content
++++
...
[.column#objc:query-n1ql-mobile:::-2]
====== {empty}
.Learn more . . .
...
[.column#objc:query-n1ql-mobile:::-3]
====== {empty}
.Dive Deeper . . .
