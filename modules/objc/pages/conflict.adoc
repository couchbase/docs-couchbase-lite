...
. Your code updates the document with its modified properties, for example using https://docs.couchbase.com/mobile/{version-maintenance-ios}/couchbase-lite-objc/Classes/CBLDatabase.html#/c:objc(cs)CBLDatabase(im)saveDocument:error:[CBLDatabase saveDocument:error:].
====
...
====
Save operations::
https://docs.couchbase.com/mobile/{version-maintenance-ios}/couchbase-lite-objc/Classes/CBLDatabase.html#/c:objc(cs)CBLDatabase(im)saveDocument:concurrencyControl:error:[CBLDatabase saveDocument:concurrencyControl:error:] -- attempts to save the document with a concurrency control.
+
...
* https://docs.couchbase.com/mobile/{version-maintenance-ios}/couchbase-lite-objc/Classes/CBLDatabase.html#/c:objc(cs)CBLDatabase(im)deleteDocument:error:[CBLDatabase deleteDocument:error:]: The last write will win if there is a conflict.
* https://docs.couchbase.com/mobile/{version-maintenance-ios}/couchbase-lite-objc/Classes/CBLDatabase.html#/c:objc(cs)CBLDatabase(im)deleteDocument:concurrencyControl:error:[CBLDatabase -deleteDocument:concurrencyControl:error:]: attempts to delete the document with a concurrency control.
...
[discrete.colum#objc:conflict:::-3n]
=== {empty}
.Community Resources ...
