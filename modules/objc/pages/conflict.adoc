...
//  Used-by:  objc-conflict.adoc files
...
[discrete#objc:conflict:::causes-of-conflicts]
=== Causes of Conflicts
...
[discrete#objc:conflict:::lbl-conflicts-when-replicating]
...
[discrete#objc:conflict:::automatic-conflict-resolution]
...
[discrete#objc:conflict:::custom-conflict-resolution]
...
[discrete#objc:conflict:::conflict-resolver]
==== Conflict Resolver
...
[tabs]
=====
[#objc:conflict:::tabs-1-local-wins]
Local Wins::
+
--
...
[#objc:conflict:::tabs-1-remote-wins]
Remote Wins::
+
--
...
[discrete#objc:conflict:::important-guidelines-and-best-practices]
...
[discrete#objc:conflict:::configure-the-replicator]
...
[discrete#objc:conflict:::conflicts-when-saving]
...
[discrete#objc:conflict:::automatic-conflict-resolution-2]
==== Automatic Conflict Resolution
...
[discrete#objc:conflict:::custom-conflict-handlers]
...
[discrete#objc:conflict:::related-content]
=== Related Content
++++
...
[discrete.colum#objc:conflict:::-2n]
==== {empty}
.Concepts
...
== https://docs.couchbase.com/mobile/3.2.0/couchbase-lite-objc/index.html[API&#160;References]
