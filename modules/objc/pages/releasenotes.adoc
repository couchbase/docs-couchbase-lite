...
[#objc:releasenotes:::couchbase-lite-release-notes-2]
== Couchbase Lite Release Notes

[#objc:releasenotes:::downgrade-support]
=== Downgrade Support
...
[#objc:releasenotes:::enhancements-3]
=== Enhancements
...
[#objc:releasenotes:::issues-and-resolutions-3]
=== Issues and Resolutions
...
[#objc:releasenotes:::known-issues-3]
=== Known Issues

None for this release

[#objc:releasenotes:::deprecations-3]
=== Deprecations
