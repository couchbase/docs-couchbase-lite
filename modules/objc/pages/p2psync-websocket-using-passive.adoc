...
[#objc:p2psync-websocket-using-passive:::introduction]
== Introduction
...
[#objc:p2psync-websocket-using-passive:::configuration-summary]
...
[#objc:p2psync-websocket-using-passive:::api-references]
== API References
...
[#objc:p2psync-websocket-using-passive:::device-discovery]
== Device Discovery
...
[#objc:p2psync-websocket-using-passive:::initialize-the-listener-configuration]
...
[#objc:p2psync-websocket-using-passive:::lbl-set-network-and-port]
== Set Port and Network Interface


[#objc:p2psync-websocket-using-passive:::port-number]
=== Port number
...
[#objc:p2psync-websocket-using-passive:::network-interface]
=== Network Interface
...
[#objc:p2psync-websocket-using-passive:::delta-sync]
== Delta Sync
...
[#objc:p2psync-websocket-using-passive:::lbl-tls-security]
== TLS Security


[#objc:p2psync-websocket-using-passive:::enable-or-disable-tls]
...
[#objc:p2psync-websocket-using-passive:::configure-tls-identity-for-listener]
...
[#objc:p2psync-websocket-using-passive:::lbl-authenticating-the-client]
...
[#objc:p2psync-websocket-using-passive:::use-basic-authentication]
...
[#objc:p2psync-websocket-using-passive:::using-client-certificate-authentication]
...
[#objc:p2psync-websocket-using-passive:::delete-tls-identity]
=== Delete Entry
...
[#objc:p2psync-websocket-using-passive:::the-impact-of-tls-settings]
...
[#objc:p2psync-websocket-using-passive:::monitor-listener]
== Monitor Listener
...
[#objc:p2psync-websocket-using-passive:::stop-listener]
== Stop Listener
...
[#objc:p2psync-websocket-using-passive:::related-content]
== Related Content
++++
...
[.column#objc:p2psync-websocket-using-passive:::-2]
=== {empty}
.Concepts
...
[.column#objc:p2psync-websocket-using-passive:::-3]
=== {empty}
.Community Resources ...
