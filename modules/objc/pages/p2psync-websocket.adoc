...
====
xref:p2psync-multipeer.adoc[Multipeer P2P Replicator] is available for Objective-C, offering:
...
Here you can see configuration involves a xref:objc:p2psync-websocket-using-passive.adoc[Passive Peer] and an xref:objc:p2psync-websocket-using-active.adoc[Active Peer] and a user-friendly Listener configuration in <<simple-configuration>>.
