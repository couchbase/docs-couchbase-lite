...
+
Use the API's https://docs.couchbase.com/mobile/{major}.{minor}.{maintenance-ios}{empty}/couchbase-lite-objc/Classes/CBLDatabase.html#lbl-code>>; this ensures that a UUID is generated for each copy
+
