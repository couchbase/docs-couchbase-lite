...
[#objc:prebuilt-database:::overview]
== Overview


_pass:q,a[pass:q,a[Couchbase{nbsp}Lite]]_] supports  pre-built databases. You can pre-load your app with data instead of syncing it from pass:q,a[_pass:q,a[Sync{nbsp}Gateway]_ during startup to minimize consumer wait time (arising from data setup) on initial install and launch of the application.
...
[#objc:prebuilt-database:::bundle-db]
...
[#objc:prebuilt-database:::database-encryption]
== Database Encryption
...
[#objc:prebuilt-database:::deploy-db]
...
[#objc:prebuilt-database:::related-content]
== Related Content
++++
...
[.column#objc:prebuilt-database:::-2]
=== {empty}
.Learn more . . .
...
[.column#objc:prebuilt-database:::-3]
=== {empty}
.Dive Deeper . . .
