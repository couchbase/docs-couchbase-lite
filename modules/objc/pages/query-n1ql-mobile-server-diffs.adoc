...
[#objc:query-n1ql-mobile-server-diffs:::boolean-logic-rules]
=== Boolean Logic Rules
...
[#objc:query-n1ql-mobile-server-diffs:::logical-operations]
==== Logical Operations
...
[#objc:query-n1ql-mobile-server-diffs:::crud-operations]
=== CRUD Operations
{sqlpp} for Mobile only supports Read or Query operations.

{sqlpp} for Server fully supports CRUD operation.

[#objc:query-n1ql-mobile-server-diffs:::functions]
=== Functions

[#objc:query-n1ql-mobile-server-diffs:::division-operator]
==== Division Operator
...
[#objc:query-n1ql-mobile-server-diffs:::round-function]
==== Round Function
[,cols="1a,1a", options="header"]
|===
^| {sqlpp} for Server ^| {sqlpp} for Mobile
...
[#objc:query-n1ql-mobile-server-diffs:::related-content]
=== Related Content
++++
