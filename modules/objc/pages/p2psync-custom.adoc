...
[#objc:p2psync-custom:::peer-discovery]
== Peer Discovery
...
[#objc:p2psync-custom:::active-peer]
=== Active Peer

The first step is to initialize the Couchbase Lite database.

[#objc:p2psync-custom:::passive-peer]
=== Passive Peer
...
// include::objc:example$code_snippets/SampleCodeTest.m[tag=listener,indent=0]
[source]
----
...
[#objc:p2psync-custom:::peer-selection-and-connection-setup]
...
[#objc:p2psync-custom:::replication-setup]
== Replication Setup


image::ROOT:connection.png[]

[#objc:p2psync-custom:::active-peer-2]
=== Active Peer
...
// include::objc:example$code_snippets/SampleCodeTest.m[tag=message-endpoint,indent=0]
[source]
----
...
// include::objc:example$code_snippets/SampleCodeTest.m[tag=message-endpoint-replicator,indent=0]
[source]
----
...
// include::objc:example$code_snippets/SampleCodeTest.m[tag=create-connection,indent=0]
...
// include::objc:example$code_snippets/SampleCodeTest.m[tag=active-peer-open,indent=0]
[source]
----
...
[#objc:p2psync-custom:::passive-peer-2]
=== Passive Peer
...
// include::objc:example$code_snippets/SampleCodeTest.m[tag=advertizer-accept,indent=0]
[source]
----
...
// include::objc:example$code_snippets/SampleCodeTest.m[tag=passive-peer-open,indent=0]
[source]
----
/* implementation of CBLMessageEndpointConnection */
- (void)open:(nonnull id<CBLReplicatorConnection>)connection completion:(nonnull void (^)(BOOL, CBLMessagingError *_Nullable))completion {
...
[#objc:p2psync-custom:::pushpull-replication]
...
[#objc:p2psync-custom:::active-peer-3]
=== Active Peer
...
// include::objc:example$code_snippets/SampleCodeTest.m[tag=active-peer-send,indent=0]
[source]
----
/* implementation of CBLMessageEndpointConnection */
...
// include::objc:example$code_snippets/SampleCodeTest.m[tag=active-peer-receive,indent=0]
[source]
----
...
[#objc:p2psync-custom:::passive-peer-3]
=== Passive Peer
...
// include::objc:example$code_snippets/SampleCodeTest.m[tag=passive-peer-send,indent=0]
[source]
----
/* implementation of CBLMessageEndpointConnection */
- (void)send:(nonnull CBLMessage *)message completion:(nonnull void (^)(BOOL, CBLMessagingError *_Nullable))completion {
...
// include::objc:example$code_snippets/SampleCodeTest.m[tag=passive-peer-receive,indent=0]
[source]
----
CBLMessage *message = [CBLMessage fromData:data];
[_replicatorConnection receive:message];
...
[#objc:p2psync-custom:::connection-teardown]
== Connection Teardown
...
[#objc:p2psync-custom:::initiated-by-active-peer]
=== Initiated by Active Peer

image::ROOT:dis-active.png[]

[#objc:p2psync-custom:::active-peer-4]
=== Active Peer

When an active Peer disconnects, it must call the `ReplicatorConnection.close` method.

// include::objc:example$code_snippets/SampleCodeTest.m[tag=active-replicator-close,indent=0]
[source]
----
...
// include::objc:example$code_snippets/SampleCodeTest.m[tag=active-peer-close,indent=0]
[source]
----
/* implementation of CBLMessageEndpointConnection */
...
[#objc:p2psync-custom:::passive-peer-4]
=== Passive Peer
...
// include::objc:example$code_snippets/SampleCodeTest.m[tag=passive-replicator-close,indent=0]
[source]
----
[_replicatorConnection close:nil];
----
...
// include::objc:example$code_snippets/SampleCodeTest.m[tag=passive-peer-close,indent=0]
[source]
----
/* implementation of CBLMessageEndpointConnection */
- (void)close:(nullable NSError *)error completion:(nonnull void (^)(void))completion {
...
[#objc:p2psync-custom:::initiated-by-passive-peer]
=== Initiated by Passive Peer

image::ROOT:dis-passive.png[]

[#objc:p2psync-custom:::passive-peer-5]
=== Passive Peer

When the passive disconnects, it must class the `MessageEndpointListener.closeAll` method.

// include::objc:example$code_snippets/SampleCodeTest.m[tag=passive-stop-listener,indent=0]
[source]
----
...
[#objc:p2psync-custom:::active-peer-5]
=== Active Peer
...
[#objc:p2psync-custom:::related-content]
== Related Content
++++
