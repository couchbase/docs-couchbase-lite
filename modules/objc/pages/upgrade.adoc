...
[#objc:upgrade:::api-changes]
=== API Changes

[#objc:upgrade:::removed-apis]
==== Removed APIs

[#objc:upgrade:::resetcheckpoint]
===== ResetCheckpoint
...
[#objc:upgrade:::database-setloglevel]
...
[#objc:upgrade:::isnullormissing-and-notnullormissing]
...
[#objc:upgrade:::encrypted-databases]
=== Encrypted Databases
...
[#objc:upgrade:::handling-of-existing-conflicts]
...
[#objc:upgrade:::handling-of-existing-attachments]
...
[#objc:upgrade:::replication-compatibility]
...
[#objc:upgrade:::downgrading-couchbase-lite]
== Downgrading Couchbase Lite

[#objc:upgrade:::downgrading-between-major-releases]
...
[#objc:upgrade:::downgrading-between-minor-releases]
...
[#objc:upgrade:::downgrading-between-patch-releases]
