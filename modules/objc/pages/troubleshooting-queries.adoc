...
[source#objc:troubleshooting-queries:::like-wild-pfx-qry, objc]
----
...
[source#objc:troubleshooting-queries:::use-like-based-queries, objc]
----
CBLQueryExpression *type =
...
[.column#objc:troubleshooting-queries:::-2]
====== {empty}
.Learn more . . .
...
[.column#objc:troubleshooting-queries:::-3]
====== {empty}
.Dive Deeper . . .
