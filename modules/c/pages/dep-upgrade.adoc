...
This functionality is related to the way conflicts are being handled in Couchbase Lite 2.0  -- see xref:c:conflict.adoc[Handling Data Conflicts].
...
[source]
----
include::c:example$code_snippets/main.cpp[tag=1x-attachment,indent=0]
----
