...
[source, c]
----
include::c:example$code_snippets/main.cpp[tags=remote-win-conflict-resolver,indent=0]
----
--
...
[source, c]
----
include::c:example$code_snippets/main.cpp[tags=merge-conflict-resolver,indent=0]
----
--
...
[source, cpp]
----
include::c:example$code_snippets_cpp/cbl_cpp.cpp[tags=replication-conflict-resolver,indent=0]
----
--
=====
====
