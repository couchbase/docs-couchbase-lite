...
[source, cpp]
----
include::c:example$code_snippets/cbl_cpp.cpp[tags="query-access-id", indent=0]
----
<.> Extract the Id value from the dictionary and use it to get the document from the database
--
=====
...
[source, cpp]
----
include::c:example$code_snippets/cbl_cpp.cpp[tags="query-access-props", indent=0]
----
--
=====
...
[source, cpp]
----
include::c:example$code_snippets/cbl_cpp.cpp[tags="query-access-json", indent=0]
----
--
=====
