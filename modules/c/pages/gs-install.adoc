...
Before you can use Vector Search, you must link:https://www.couchbase.com/downloads/?family=couchbase-lite#LiteExtensions[Install the Vector Search extension].
...
. Find the extension path using the appropriate snippet:
...
// If Android version of vector search deviates this will need a custom change.
