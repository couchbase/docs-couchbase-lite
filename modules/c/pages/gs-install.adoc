...
// :release-dir-ce-include: pass:q,a[pass:q,a[libcblite-community]/include/]
// :release-dir-ce-lib:  pass:q,a[pass:q,a[libcblite-community]/lib/]
:release-dirs-include: pass:q,a[`pass:q,a[pass:q,a[libcblite-community]/include/]` or `{release-dir-ee-include}`]
// :release-dirs-ce-lib: pass:q,a[` pass:q,a[pass:q,a[libcblite-community]/lib/]` or `{release-dir-ee-lib}`]
// :release-dirs-ce-lib: pass:q,a[` pass:q,a[pass:q,a[libcblite-community]/lib/]`]
// :release-dirs: pass:q,a[`pass:q,a[libcblite-community]` or `{release-dir-ee}`]
...
// :url-apt-pkg:  pass:q,a[https://packages.couchbase.com/releases/couchbase-release/couchbase-release-1.0-noarch.deb]
...
[{bash-header}]
----
curl -O  pass:q,a[https://packages.couchbase.com/releases/couchbase-release/couchbase-release-1.0-noarch.deb]
----
--
...
[{bash-header}]
----
wget  pass:q,a[https://packages.couchbase.com/releases/couchbase-release/couchbase-release-1.0-noarch.deb]
----
--
=====
...
That's it.
pass:q,a[At this point, you are ready to start building the xref:gs-build.adoc[Getting Started] app, or doing your own thing with _Couchbase Lite for C_]
