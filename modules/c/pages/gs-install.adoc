...
* _Linux_ and _macOS_ -- <<lbl-beta-downloads, downloads table>>
...
. Just `wget` the appropriate `.deb` package  -- see <<lbl-beta-downloads, downloads table>>  for a BETA package URL.
...
[#lbl-mac-steps]
. Download and extract the release package here -- <<lbl-beta-downloads, downloads table>>.
