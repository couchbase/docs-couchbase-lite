...
:release-dir: pass:q,a[libcblite-{version-full}]
:release-dir-ee: {release-dir}
:release-dir-dev: pass:q,a[libcblite-dev-{version-full}]
// :release-dir-dev-ee: pass:q,a[libcblite-dev-enterprise-{version-full}]
:release-dir-dev-ee: {release-dir-dev}
...
:release-dirs-lib: pass:q,a[`{release-dir-lib}`]
// :release-dirs: pass:q,a[`{release-dir}` or `{release-dir-ee}`]
:release-dirs: pass:q,a[`{release-dir}`]
...
The binary release download comprises a root directory ({release-dir}), which contains:
...
[NOTE]
--
Coming soon! Simplified installation using the Homebrew +
...
.. *Drag* `{release-dir}.dylib` into your Xcode project.
...
. Within _Android Studio_, select and open the project folder (within the {release-dir} folder)
