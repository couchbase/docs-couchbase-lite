...
[source, cpp]
----
include::c:example$code_snippets/cbl_cpp.cpp[tags="new-database", indent=0]
----
--
...
[source, cpp]
----
include::c:example$code_snippets/cbl_cpp.cpp[tags="close-database", indent=0]
----
--
...
[source, cpp]
----
include::c:example$code_snippets/cbl_cpp.cpp[tags="database-fullsync", indent=0]
----
--
...
[source, cpp]
----
include::c:example$code_snippets/cbl_cpp.cpp[tags="database-encryption", indent=0]
----
--
