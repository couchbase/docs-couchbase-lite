...
NOTE: TODO this is the "inlined" version after mobile-simplification, that would require more manual work, but is more explicit.
...
NOTE: TODO this is the automated style if we want to continue using that
