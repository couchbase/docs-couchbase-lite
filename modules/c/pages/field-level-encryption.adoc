...
You register the callback function for use by declaring them in the replicator configuration using {url-api-references-replicator-config-prop}ab731bf9f140158d6967c1af645d8744a[propertyEncryptor()] and-or {url-api-references-replicator-config-prop}ab6a0d9e0830755d284039018a09c27d6[propertyDecryptor()] -- see: <<ex-callback-config>>
