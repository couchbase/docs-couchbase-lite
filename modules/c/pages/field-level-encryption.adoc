...
[source, cpp]
----
include::c:example$code_snippets/cbl_cpp.cpp[tag=replicator_property_encryptor_decryptor_sample]
----
--
=====
...
[source, cpp]
----
include::c:example$code_snippets/cbl_cpp.cpp[tag=replicator_property_encryption]
----
--
=====
