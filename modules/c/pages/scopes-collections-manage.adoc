...
[source, cpp]
----
include::c:example$code_snippets/cbl_cpp.cpp[tags="scopes-manage-create-collection", indent=0]
----
--
=====
...
[source, cpp]
----
include::c:example$code_snippets/cbl_cpp.cpp[tags="scopes-manage-index-collection", indent=0]
----
--
=====
...
[source, cpp]
----
include::c:example$code_snippets/cbl_cpp.cpp[tags="scopes-manage-drop-collection", indent=0]
----
--
=====
...
[source, cpp]
----
include::c:example$code_snippets/cbl_cpp.cpp[tags="scopes-manage-list", indent=0]
----
--
=====
