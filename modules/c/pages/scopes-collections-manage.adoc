...
[source, cpp]
----
include::c:example$code_snippets_cpp/cbl_cpp.cpp[tag=scopes-manage-create-collection,indent=0]
----
--
=====
====
...
[source, cpp]
----
include::c:example$code_snippets_cpp/cbl_cpp.cpp[tag=scopes-manage-index-collection,indent=0]
----
--
=====
====
...
[source, cpp]
----
include::c:example$code_snippets_cpp/cbl_cpp.cpp[tag=scopes-manage-drop-collection,indent=0]
----
--
=====
====
...
[source, cpp]
----
include::c:example$code_snippets_cpp/cbl_cpp.cpp[tag=scopes-manage-list,indent=0]
----
--
=====
====
