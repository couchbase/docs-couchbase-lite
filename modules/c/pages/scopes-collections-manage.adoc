...
[#c:scopes-collections-manage:::default-scopes-and-collections]
...
[#c:scopes-collections-manage:::create-a-scope-and-collection]
...
[#c:scopes-collections-manage:::index-a-collection]
== Index a Collection
...
[#c:scopes-collections-manage:::drop-a-collection]
== Drop a Collection
...
[#c:scopes-collections-manage:::list-scopes-and-collections]
