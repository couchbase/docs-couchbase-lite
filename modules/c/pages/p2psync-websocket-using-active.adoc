...
----
include::c:example$code_snippets/cbl_cpp.cpp[tags="sgw-act-rep-initialize", indent=0]
----
--
=====
====
...
[source.no-callouts, cpp]
----
include::c:example$code_snippets/cbl_cpp.cpp[tags="p2p-act-rep-config-type;p2p-act-rep-config-cont", indent=0]
----
--
=====
====
...
[source, c]
----
include::c:example$code_snippets/main.cpp[tag=p2p-act-rep-config-pinnedcert, indent=0]
----
--
...
[source, cpp]
----
include::c:example$code_snippets/cbl_cpp.cpp[tags=p2p-act-rep-config-cacert, indent=0]
----
This is the default.
Only certificate chains with roots signed by a trusted CA are allowed.
Self signed certificates are not allowed.
...
[source, cpp]
----
include::c:example$code_snippets/cbl_cpp.cpp[tags=p2p-act-rep-config-self-cert, indent=0]
----
Set this to `true` to accept any self signed cert.
Any certificates that are not self-signed are rejected.
--
...
[source, cpp]
----
include::c:example$code_snippets/cbl_cpp.cpp[tag=p2p-act-rep-config-pinnedcert, indent=0]
----
--
...
[source, cpp]
----
include::c:example$code_snippets/cbl_cpp.cpp[tags=p2p-act-rep-add-change-listener;!p2p-act-rep-add-change-listener-label,indent=0]
----
--
+
...
[source, cpp]
----
include::c:example$code_snippets/cbl_cpp.cpp[tags=p2p-act-rep-status,indent=0]
----
--
======
--
...
[source, cpp]
----
include::c:example$code_snippets/cbl_cpp.cpp[tags="p2p-act-rep-stop", indent=0]
----
--
=====
...
[source, cpp]
----
include::c:example$code_snippets/cbl_cpp.cpp[tags="update-document-with-conflict-handler", indent=0]
----
--
=====
