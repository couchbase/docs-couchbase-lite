...
Here we say to provide _Basic Authentication_ credentials. Other options are available -- see: <<lbl-authclnt>>.
...
You can remove a change listener with {url-api-references-replicator}#(im)removeChangeListenerWithToken[removeChangeListenerWithToken(ListenerToken:)].
