...
[source, cpp]
----
include::c:example$code_snippets_cpp/vector_search.cpp[tag=vs-create-custom-config]
----
--
====
...
[source, cpp]
----
include::c:example$code_snippets_cpp/vector_search.cpp[tag=vs-create-index]
----
--
====
...
[source, cpp]
----
include::c:example$code_snippets_cpp/vector_search.cpp[tag=vs-create-predictive-index]
----
--
====
...
[source, cpp]
----
include::c:example$code_snippets_cpp/vector_search.cpp[tag=vs-lazy-index-config]
----
--
====
...
[source, cpp]
----
include::c:example$code_snippets_cpp/vector_search.cpp[tag=vs-create-lazy-index-embedding]
----
--
====
...
[source, cpp]
----
include::c:example$code_snippets_cpp/vector_search.cpp[tag=vs-hybrid-ftmatch]
----
--
====
...
[source, cpp]
----
include::c:example$code_snippets_cpp/vector_search.cpp[tag=vs-hybrid-prediction]
----
--
====
...
[source, cpp]
----
include::c:example$code_snippets_cpp/vector_search.cpp[tag=vs-apvd-where]
----
--
====
...
[source, cpp]
----
include::c:example$code_snippets_cpp/vector_search.cpp[tag=vs-apvd-prediction]
----
--
====
