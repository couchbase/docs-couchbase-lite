...
[source, cpp]
----
include::c:example$code_snippets/cbl_cpp.cpp[tags="query-index", indent=0]
----
--
=====
...
----
include::c:example$code_snippets/cbl_cpp.cpp[tags=partial-value-index]
----
--
=====
====
...
[source.no-callouts, cpp, indent=0]
----
include::c:example$code_snippets/cbl_cpp.cpp[tags=partial-full-text-index]
----
--
=====
====
...
[source.no-callouts, cpp, indent=0]
----
include::c:example$code_snippets/cbl_cpp.cpp[tags=array-index-config]
----
--
=====
====
...
[source.no-callouts, cpp, indent=0]
----
include::c:example$code_snippets/cbl_cpp.cpp[tags=array-index-single]
----
--
=====
====
...
[source.no-callouts, cpp, indent=0]
----
include::c:example$code_snippets/cbl_cpp.cpp[tags=array-index-nested]
----
--
=====
====
