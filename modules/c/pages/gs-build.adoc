...
Enter the code from xref:c:gs-build.adoc#ex-c-starter[] into your editor of choice and build it.
...
[source, cpp]
----
include::c:example$code_snippets/cbl_cpp.cpp[tag=getting-started,indent=0]
----
--
