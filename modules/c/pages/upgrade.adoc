...
[#c:upgrade:::downgrading-couchbase-lite]
== Downgrading Couchbase Lite

[#c:upgrade:::downgrading-between-major-releases]
...
[#c:upgrade:::downgrading-between-minor-releases]
...
[#c:upgrade:::downgrading-between-patch-releases]
...
= https://docs.couchbase.com/mobile/3.2.1/couchbase-lite-c/C/html/modules.html[API&#160;References]
