...
== Index
[.pane__frame--blue]
xref:c:refer-glossary.adoc#a[]  |  xref:B>>  |  <<c:refer-glossary.adoc#c[]  |  xref:c:refer-glossary.adoc#d[]  |  xref:E>>  |  <<F>>  |  <<G>>  |  <<H>>  |  <<c:refer-glossary.adoc#i[]  |  xref:J>>  |  <<K>>  |  <<c:refer-glossary.adoc#l[]  |  xref:M>>  |  <<c:refer-glossary.adoc#n[]  |  xref:O>>  |  <<c:refer-glossary.adoc#p[]  |  xref:Q>>  |  <<c:refer-glossary.adoc#r[]  |  xref:c:refer-glossary.adoc#s[]  |  xref:c:refer-glossary.adoc#t[]  |  <<U>>  |  <<V>>  |  <<W>>  |  <<X>>  |  <<Y>>  |  <<Z>>
...
* _Related Term(s)_: xref:c:refer-glossary.adoc#passive-peer[] xref:c:refer-glossary.adoc#peer-to-peer-sync[]
* _Read More_: xref:c:landing-p2psync.adoc[Peer-to-Peer Sync]
...
[[c:refer-glossary:::checkpoint]]Checkpoint::
...
Back to xref:c:refer-glossary.adoc#index[]
...
// tag::cbl-delta-sync[]
// tag::cbl-delta-sync-def[]
* _Related Term(s)_: xref:c:refer-glossary.adoc#passive-replicator[Passive replicator]
* _Read More_: xref:c:replication.adoc#delta-sync[Delta Sync]
// tag::cbl-delta-sync-full[]
...
* _Related Term(s)_: xref:c:refer-glossary.adoc#active-peer[], xref:c:refer-glossary.adoc#peer-to-peer-sync[]
* _Read More_: xref:c:landing-p2psync.adoc[Peer-to-Peer Sync]
// end::cbl-passive-peer[]
...
* _Related Term(s)_: xref:c:refer-glossary.adoc#active-peer[] xref:c:refer-glossary.adoc#passive-peer[]
* _Read More_: xref:c:landing-p2psync.adoc[Peer-to-Peer Sync]
...
* _Related Term(s)_: xref:c:refer-glossary.adoc#active-peer[] xref:c:refer-glossary.adoc#passive-peer[]
* _Read More_: xref:c:p2psync-websocket.adoc[Peer-to-Peer]
