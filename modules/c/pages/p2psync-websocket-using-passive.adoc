...
:url-api-class-ListenerPasswordAuthenticator: {url-api-references}/group__ListenerPasswordAuthenticator.html
:url-api-class-ListenerCertificateAuthenticator: {url-api-references}/group__ListenerCertificateAuthenticator.html
...
Configure the server (listener) to authenticate the client against a list of one or more certificates provided by the server to the the {url-api-class-ListenerCertificateAuthenticator}[ListenerCertificateAuthenticator].
