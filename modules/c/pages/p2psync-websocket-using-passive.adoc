...
* Basic Authentication -- uses the {url-api-class-ListenerPasswordAuthenticator}[ListenerPasswordAuthenticator] to authenticate the client using the client-supplied username and password (from the http authentication header).
* {url-api-class-ListenerCertificateAuthenticator}[ListenerCertificateAuthenticator] -- which authenticates the client using a client supplied chain of one or more certificates.
...
* A chain of one or more certificates that ends at a certificate in the list of certificates supplied to the constructor for  {url-api-class-ListenerCertificateAuthenticator}[ListenerCertificateAuthenticator] -- see: <<ex-set-cert-auth>>
...
Configure the server (listener) to authenticate the client against a list of one or more certificates provided by the server to the {url-api-class-ListenerCertificateAuthenticator}[ListenerCertificateAuthenticator].
