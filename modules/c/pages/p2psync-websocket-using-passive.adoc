...
:url-api-references-tlsidentity: {url-api-references}/group___t_l_s_identity.html
...
Set the list of local collections using the {url-api-references-urlendpointconfiguration}[URLEndpointListenerConfiguration].
...
Use {url-api-references-urlendpointconfiguration}[URLEndpointListenerConfiguration]'s {url-api-references-urlendpointconfiguration}#a09df56683ec60fadd06b9e7b2c457b36[enableDeltaSync] method to activate or deactivate it.
...
You can use {url-api-references-urlendpointconfiguration}[URLEndpointListenerConfiguration]'s {url-api-references-urlendpointconfiguration}#a6e12a73664e15fbd503be94e82ca8177[disableTLS] method to disable TLS communication if necessary.
...
{url-api-references-urlendpointconfiguration}#a6e12a73664e15fbd503be94e82ca8177[disableTLS] works in conjunction with `TLSIdentity`, to enable developers to define the key and certificate to be used.
...
{url-api-references-urlendpointconfiguration}#a872c060c215290313ab95bb920ad33ae[tlsIdentity] method to configure the TLS Identity used in TLS communication.
...
Alternatively, you can use the {url-api-references-tlsidentity}#ga28cacc360238506e7ea36f058a4bcd23[CBLTLSIdentity_CreateIdentityWithKeyPair()] API with a {url-api-references-tlsidentity}#ga50d0a2acc3f0d3794164edeed66074c0[CBLKeyPair] object created using {url-api-references-tlsidentity}#ga78d47a8c2157dad4347709d1adec6b39[CBLKeyPair_CreateWithExternalKey()].
...
// NOTE: This example uses hardcoded C code. C++ tab to be added after
// engineering provides tagged includes in main.cpp and cbl_cpp.cpp.
...
. Generate the self-signed TLS identity using the {url-api-references-tlsidentity}#ga7b9afa6f5f3167f7a2af08abc7778883[CBLTLSIdentity_CreateIdentity()] function. @/CBLTLSIdentity_CreateIdentity/
...
// NOTE: This is a struct definition showing the C API callback interface.
// It applies to both C and C++ users and does not require a C++ tab.
...
. `externalKey` is an opaque pointer passed to {url-api-references-tlsidentity}#ga78d47a8c2157dad4347709d1adec6b39[CBLKeyPair_CreateWithExternalKey()], typically representing a reference or token used to access the public / private key within the secure storage system. @4
...
Use the
{url-api-references-urlendpointconfiguration}[URLEndpointListenerConfiguration] class's {url-api-references-urlendpointconfiguration}#a68159e04ec97a47fcbe785709ca54b35[authenticator] method to specify how the client-supplied credentials are to be authenticated.
...
// NOTE: The original include tag was broken: [tags="listener-config-client-auth-root, indent=0]"]
// The correct tag is used here. Track the original bug in a separate cleanup ticket.
[tabs]
=====
C::
+
...
[source, c]
----
include::c:example$code_snippets/main.cpp[tags="p2psync-act-tlsid-delete", indent=0]
----
--
...
* On first use -- Bring your own certificate and private key; for example, using the {url-api-references-tlsidentity}#ga7b9afa6f5f3167f7a2af08abc7778883[CBLTLSIdentity_CreateIdentity()] method to add it to the secure storage.
...
Use the Listener's {url-api-references-urlendpointlistener}#ac5cc57610ce3d6a2fb1e891a8f24a448[CBLURLEndpointListener_Status()] property/method to get counts of total and active connections -- see: <<get-connection-counts>>.
