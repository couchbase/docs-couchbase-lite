...
This API uses query statements of the form shown in xref:c:query-n1ql-mobile.adoc#ex-query-form[].
...
We are accessing the current database using the shorthand notation *`_`* -- see the xref:c:query-n1ql-mobile.adoc#lbl-from[] clause for more on data source selection and xref:c:query-n1ql-mobile.adoc#lbl-query-params[] for more on parameterized queries.


[#query-format]
== Query Format

The API uses query statements of the form shown in xref:c:query-n1ql-mobile.adoc#ex-query-form[].
...
You can use the wildcard *** to select all columns -- see xref:c:query-n1ql-mobile.adoc#select-wildcard[]
...
This behavior is inline with that of Couchbase Server {sqlpp} -- see example in xref:c:query-n1ql-mobile.adoc#tbl-selstar[].
...
<.> `JOIN joinclause` -- use this optional argument to link datasources -- see xref:c:query-n1ql-mobile.adoc#lbl-join[]
...
For example to combine airline details with route details, linked by the airline id -- see xref:c:query-n1ql-mobile.adoc#ex-join[].
...
We are also accessing the current database using the shorthand notation *`_`* -- see the xref:c:query-n1ql-mobile.adoc#lbl-from[] clause for more on data source selection and xref:c:query-n1ql-mobile.adoc#lbl-query-params[] for more on parameterized queries.
...
See also -- xref:c:query-n1ql-mobile.adoc#lbl-operators[] for more on building expressions and xref:c:query-n1ql-mobile.adoc#lbl-query-params[] for more on parameterized queries.
...
== Expressions
In this section::
  xref:c:query-n1ql-mobile.adoc#lbl-exp-literals[]{nbsp}{nbsp}|{nbsp}{nbsp}
  xref:c:query-n1ql-mobile.adoc#lbl-exp-ident[]{nbsp}{nbsp}|{nbsp}{nbsp}
  xref:c:query-n1ql-mobile.adoc#lbl-exp-prop[]{nbsp}{nbsp}|{nbsp}{nbsp}
  xref:c:query-n1ql-mobile.adoc#lbl-exp-any[]{nbsp}{nbsp}|{nbsp}{nbsp}
  xref:c:query-n1ql-mobile.adoc#lbl-exp-param[]{nbsp}{nbsp}|{nbsp}{nbsp}
  xref:c:query-n1ql-mobile.adoc#lbl-exp-paren[]

Expressions are references to identifiers that resolve to values.
Categories of expression comprise the elements covered in this section (see above), together with xref:c:query-n1ql-mobile.adoc#lbl-operators[] and xref:c:query-n1ql-mobile.adoc#lbl-functions[], which are covered in their own sections


[#lbl-exp-literals]
=== Literals
xref:c:query-n1ql-mobile.adoc#lbl-lit-bool[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:c:query-n1ql-mobile.adoc#lbl-lit-numbers[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:c:query-n1ql-mobile.adoc#lbl-lit-string[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:c:query-n1ql-mobile.adoc#lbl-lit-null[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:c:query-n1ql-mobile.adoc#lbl-lit-missing[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:c:query-n1ql-mobile.adoc#lbl-lit-array[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:c:query-n1ql-mobile.adoc#lbl-lit-dict[]{nbsp}{nbsp}|{nbsp}{nbsp}
...
== Operators
In this section::
xref:c:query-n1ql-mobile.adoc#lbl-ops-binary[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:c:query-n1ql-mobile.adoc#lbl-ops-unary[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:c:query-n1ql-mobile.adoc#lbl-ops-coll[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:c:query-n1ql-mobile.adoc#lbl-ops-cond[]


[#lbl-ops-binary]
=== Binary Operators
xref:c:query-n1ql-mobile.adoc#lbl-ops-maths[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:c:query-n1ql-mobile.adoc#lbl-comp-ops[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:c:query-n1ql-mobile.adoc#lbl-ops-logical[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:c:query-n1ql-mobile.adoc#lbl-ops-string[]
...
|MATCH
|String matching using FTS see xref:c:query-n1ql-mobile.adoc#lbl-func-fts[]
...
== Functions
In this section::
xref:c:query-n1ql-mobile.adoc#lbl-func-agg[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:c:query-n1ql-mobile.adoc#lbl-func-array[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:c:query-n1ql-mobile.adoc#lbl-func-cond[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:c:query-n1ql-mobile.adoc#lbl-func-date[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:c:query-n1ql-mobile.adoc#lbl-func-fts[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:c:query-n1ql-mobile.adoc#lbl-func-maths[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:c:query-n1ql-mobile.adoc#lbl-func-meta[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:c:query-n1ql-mobile.adoc#lbl-func-pattern[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:c:query-n1ql-mobile.adoc#lbl-func-string[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:c:query-n1ql-mobile.adoc#lbl-func-typecheck[]{nbsp}{nbsp}|{nbsp}{nbsp}
xref:c:query-n1ql-mobile.adoc#lbl-func-typeconv[]
...
To specify substitutable parameters within your query string prefix the name with *`$`*, `$type` -- see: xref:c:query-n1ql-mobile.adoc#ex-sample-params[].
