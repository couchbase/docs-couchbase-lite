...
[#c:query-n1ql-mobile:::introduction]
== Introduction
...
[#c:query-n1ql-mobile:::query-format]
== Query Format
...
| <<c:query-n1ql-mobile:::lbl-unnest>>
...
[#c:query-n1ql-mobile:::select-wildcard]
==== Select Wildcard
...
[#c:query-n1ql-mobile:::datasource]
=== Datasource
...
[#c:query-n1ql-mobile:::arguments-2]
=== Arguments
...
[#c:query-n1ql-mobile:::arguments-3]
=== Arguments
...
You can also use a new type of index, the xref:c:indexing.adoc#array-indexing[Array Index], to allow querying with `UNNEST` more efficiently.

NOTE: Couchbase Lite currently supports inner `UNNEST` only.

[#c:query-n1ql-mobile:::syntax-4]
=== Syntax
...
[#c:query-n1ql-mobile:::examples]
=== Examples

For examples of using Array Indexes in conjunction with `UNNEST`, see xref:c:indexing.adoc#array-indexing[Array Index].

We are also accessing the current database using the shorthand notation *`_`* -- see the <<c:query-n1ql-mobile:::lbl-from>> clause for more on data source selection and <<c:query-n1ql-mobile:::lbl-query-params>> for more on parameterized queries.
...
[#c:query-n1ql-mobile:::arguments-4]
=== Arguments
...
[#c:query-n1ql-mobile:::examples-2]
=== Examples
...
[#c:query-n1ql-mobile:::arguments-5]
=== Arguments
...
[#c:query-n1ql-mobile:::examples-3]
=== Examples
...
[#c:query-n1ql-mobile:::purpose-7]
=== Purpose
Sort query results based on a given expression result.

[#c:query-n1ql-mobile:::syntax-7]
=== Syntax
...
[#c:query-n1ql-mobile:::arguments-6]
=== Arguments
...
[#c:query-n1ql-mobile:::examples-4]
=== Examples
...
[#c:query-n1ql-mobile:::arguments-8]
=== Arguments
...
[#c:query-n1ql-mobile:::examples-6]
=== Examples
...
[#c:query-n1ql-mobile:::lbl-literals]
== Expressions
In this section::
...
[#c:query-n1ql-mobile:::lbl-exp-literals]
=== Literals
...
[#c:query-n1ql-mobile:::lbl-lit-bool]
==== Boolean

[#c:query-n1ql-mobile:::purpose-10]
==== Purpose
Represents a true or false value.

[#c:query-n1ql-mobile:::syntax-10]
==== Syntax

`TRUE | FALSE`

[#c:query-n1ql-mobile:::example-4]
==== Example
...
[#c:query-n1ql-mobile:::lbl-lit-string]
==== String

[#c:query-n1ql-mobile:::purpose-12]
==== Purpose
The string literal represents a string or sequence of characters.


[#c:query-n1ql-mobile:::syntax-12]
==== Syntax
...
[#c:query-n1ql-mobile:::lbl-lit-null]
==== NULL

[#c:query-n1ql-mobile:::purpose-13]
==== Purpose
The literal NULL represents an empty value.

[#c:query-n1ql-mobile:::syntax-13]
==== Syntax
...
[#c:query-n1ql-mobile:::lbl-lit-missing]
==== MISSING

[#c:query-n1ql-mobile:::purpose-14]
==== Purpose
The MISSING literal represents a missing name-value pair in a document.

[#c:query-n1ql-mobile:::syntax-14]
==== Syntax
...
[#c:query-n1ql-mobile:::lbl-lit-array]
==== Array

[#c:query-n1ql-mobile:::purpose-15]
==== Purpose
Represents an Array

[#c:query-n1ql-mobile:::syntax-15]
==== Syntax
...
[#c:query-n1ql-mobile:::lbl-lit-dict]
==== Dictionary

[#c:query-n1ql-mobile:::purpose-16]
==== Purpose
Represents a dictionary literal

[#c:query-n1ql-mobile:::syntax-16]
==== Syntax
...
[#c:query-n1ql-mobile:::example-10]
==== Example
[source,sql]
----
...
[#c:query-n1ql-mobile:::lbl-exp-ident]
=== Identifiers

[#c:query-n1ql-mobile:::purpose-17]
==== Purpose
...
[#c:query-n1ql-mobile:::example-11]
==== Example
...
[#c:query-n1ql-mobile:::lbl-exp-prop]
=== Property Expressions

[#c:query-n1ql-mobile:::purpose-18]
==== Purpose
The property expression is used to reference a property in a document

[#c:query-n1ql-mobile:::syntax-18]
==== Syntax
...
[#c:query-n1ql-mobile:::example-12]
==== Example
...
[#c:query-n1ql-mobile:::lbl-exp-any]
=== Any and Every Expressions

[#c:query-n1ql-mobile:::purpose-19]
==== Purpose
Evaluates expressions over items in an array object.


[#c:query-n1ql-mobile:::syntax-19]
==== Syntax
...
[#c:query-n1ql-mobile:::example-13]
==== Example
...
[#c:query-n1ql-mobile:::lbl-exp-param]
=== Parameter Expressions

[#c:query-n1ql-mobile:::purpose-20]
==== Purpose
...
[#c:query-n1ql-mobile:::examples-7]
==== Examples
...
[#c:query-n1ql-mobile:::lbl-operators]
== Operators
In this section::
...
[#c:query-n1ql-mobile:::lbl-ops-binary]
=== Binary Operators
...
[#c:query-n1ql-mobile:::lbl-ops-maths]
==== Maths
...
[#c:query-n1ql-mobile:::lbl-comp-ops]
==== Comparison Operators

[#c:query-n1ql-mobile:::purpose-22]
==== Purpose
The _comparison operators_ are used in the WHERE statement to specify the condition on which to match documents.

.Comparison Operators
[#tbl-ops-comp]
[ops-comp#c:query-n1ql-mobile:::tbl-ops-comp, cols="^1m,2,2m", options="header"]
|===
...
[#tbl-ops-isnot]
[ops-comp#c:query-n1ql-mobile:::tbl-ops-isnot, cols="^1,^1,^1,^1", options="header"]
|===
...
[#c:query-n1ql-mobile:::lbl-ops-logical]
==== Logical Operators

[#c:query-n1ql-mobile:::purpose-23]
==== Purpose
...
.Logical Operators
[#tbl-ops-logical]
[ops-comp#c:query-n1ql-mobile:::tbl-ops-logical, cols="^1m,2,2m", options="header"]
|===
...
[#c:query-n1ql-mobile:::purpose-24]
==== Purpose
...
[#c:query-n1ql-mobile:::lbl-ops-unary]
=== Unary Operators

[#c:query-n1ql-mobile:::purpose-25]
==== Purpose
...
[#c:query-n1ql-mobile:::lbl-ops-coll]
=== COLLATE Operators

[#c:query-n1ql-mobile:::purpose-26]
==== Purpose
Collate operators specify how the string comparison is conducted.

[#c:query-n1ql-mobile:::usage]
==== Usage
...
[#c:query-n1ql-mobile:::arguments-9]
==== Arguments
...
[#c:query-n1ql-mobile:::example-15]
==== Example
...
[#c:query-n1ql-mobile:::example-16]
==== Example
...
[#c:query-n1ql-mobile:::lbl-functions]
== Functions
In this section::
...
[#c:query-n1ql-mobile:::purpose-28]
=== Purpose

Functions are also expressions.

[#c:query-n1ql-mobile:::syntax-24]
=== Syntax
...
[#c:query-n1ql-mobile:::lbl-func-agg]
...
[#c:query-n1ql-mobile:::lbl-func-array]
=== Array Functions
...
[#c:query-n1ql-mobile:::lbl-func-cond]
...
[#c:query-n1ql-mobile:::lbl-func-date]
...
[#c:query-n1ql-mobile:::lbl-func-fts]
...
[#c:query-n1ql-mobile:::lbl-func-maths]
=== Maths Functions
...
[#c:query-n1ql-mobile:::lbl-func-meta]
=== Metadata Functions
...
[#c:query-n1ql-mobile:::lbl-func-pattern]
...
[#c:query-n1ql-mobile:::lbl-func-string]
=== String Functions
...
[#c:query-n1ql-mobile:::lbl-func-typecheck]
...
[#c:query-n1ql-mobile:::lbl-query-params]
== Query Parameters
...
[#c:query-n1ql-mobile:::related-content]
== Related Content
++++
