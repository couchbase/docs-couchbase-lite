...
// https://docs.couchbase.com/mobile/{major}.{minor}.{maintenance-c}{empty}/couchbase-lite-c/C/html/group__QueryArrayFunction.html[ArrayFunction Collection Operators] are useful to check if a given value is present in an array.
...
[.column]
// [.content]
[discrete#c:query-n1ql-mobile:::-3]
===== {empty}
.Dive Deeper . . .
//* Community
