...
+
Use the API's https://docs.couchbase.com/mobile/{major}.{minor}.{maintenance-c}{empty}/couchbase-lite-c/C/html/group__database.html#ga027d34b2de65b040ecf42a2a83bf6720[CBL_CopyDatabase()] method -- see: xref:c:prebuilt-database.adoc#lbl-code[]; this ensures that a UUID is generated for each copy
+
