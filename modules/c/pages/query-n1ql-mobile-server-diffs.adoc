...
[#c:query-n1ql-mobile-server-diffs:::boolean-logic-rules]
== Boolean Logic Rules
...
[#c:query-n1ql-mobile-server-diffs:::logical-operations]
=== Logical Operations
...
[#c:query-n1ql-mobile-server-diffs:::crud-operations]
== CRUD Operations
{sqlpp} for Mobile only supports Read or Query operations.

{sqlpp} for Server fully supports CRUD operation.

[#c:query-n1ql-mobile-server-diffs:::functions]
== Functions

[#c:query-n1ql-mobile-server-diffs:::division-operator]
=== Division Operator
...
[#c:query-n1ql-mobile-server-diffs:::round-function]
=== Round Function
[,cols="1a,1a", options="header"]
|===
^| {sqlpp} for Server ^| {sqlpp} for Mobile
...
[#c:query-n1ql-mobile-server-diffs:::related-content]
== Related Content
++++
...
[.column#c:query-n1ql-mobile-server-diffs:::-2]
====== {empty}
.Learn more . . .
...
[.column#c:query-n1ql-mobile-server-diffs:::-3]
====== {empty}
.Dive Deeper . . .
