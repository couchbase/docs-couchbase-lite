...
:url-api-method-result-toJSON: {url-api-classes-result-pfx}{url-api-references-method-sep}{api-pfx}QueryResult(im)toJSON[CBLResult.toJSON]
...
:url-api-enum-replicator-activity: {url-api-references-replicator-status}(py)activity[activity enum]

:url-api-enum-replicator-progress: {url-api-references-replicator-status}(py)progress)[progress enum]

:url-api-enum-replicator-error: {url-api-references-replicator-status}(py)error[error enum]
