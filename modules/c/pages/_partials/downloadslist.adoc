...
ifdef::param-version+param-version-hyphenated[]
...
endif::param-version+param-version-hyphenated[]

// If both are definedm render vector search downloads
ifdef::vs-param-version+vs-param-version-hyphenated[]
...
endif::vs-param-version+vs-param-version-hyphenated[]
