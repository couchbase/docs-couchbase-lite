...
[#c:c_fleece:::introduction]
== Introduction

_pass:q,a[pass:q,a[Couchbase{nbsp}Lite]]_ for C makes extensive use of the Fleece C API for accessing document data.
...
.Use FLValue
[#ex-flvalue]
[source#c:c_fleece:::ex-flvalue,c, subs="attributes+, macros+"}]
----
...
.Create an FLString
[#ex-flstr]
[source#c:c_fleece:::ex-flstr,c, subs="attributes+, macros+"}]
----
...
[#c:c_fleece:::flsliceresultflstringresult]
...
[source#c:c_fleece:::ex-flsliceresult,c, subs="attributes+, macros+"}]
----
...
[#ex-flnullslice]
.Test for null slice
[source#c:c_fleece:::ex-flnullslice,c, subs="attributes+, macros+"}]
----
FLValue value = FLDict_Get(props, FLSTR("name”));
FLString name = FLValue_AsString(value);
if (name.buf != NULL) {
...
[#c:c_fleece:::dictionaries]
== Dictionaries

[#c:c_fleece:::immutable]
=== Immutable
...
[source#c:c_fleece:::ex-flget,c, subs="attributes+, macros+"}]
----
...
[source#c:c_fleece:::ex-fliterator,c, subs="attributes+, macros+"}]
----
...
[source#c:c_fleece:::ex-flmutabledict-new,c, subs="attributes+, macros+"}]
----
...
[#c:c_fleece:::lbl-fleece-arrays]
== Arrays

[#c:c_fleece:::immutable-2]
=== Immutable
...
[#ex-flarray-get]
.Use arrays
[source#c:c_fleece:::ex-flarray-get,c, subs="attributes+, macros+"}]
----
...
[source#c:c_fleece:::ex-array-iteration,c, subs="attributes+, macros+"}]
----
...
[source#c:c_fleece:::ex-flmutable-array-append,c, subs="attributes+, macros+"}]
----
...
[#c:c_fleece:::generating-json]
=== Generating JSON
Use FLValue_ToJSON to convert FLValue into JSON string

[#ex-json-from-fleese]
.Convert to JSON
[source#c:c_fleece:::ex-json-from-fleese,c, subs="attributes+, macros+"}]
----
FLDict props = CBLDocument_Properties(doc);
