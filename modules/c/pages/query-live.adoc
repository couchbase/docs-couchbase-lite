...
[source, cpp]
----
include::c:example$code_snippets_cpp/cbl_cpp.cpp[tag=live-query,indent=0]
----
--
=====
====
...
Save the token to detach the listener and stop the query later -- see xref:c:query-live.adoc#ex-qry-stop[]
...
[source, cpp]
----
include::c:example$code_snippets_cpp/cbl_cpp.cpp[tag=stop-live-query,indent=0]
----
--
=====
====
