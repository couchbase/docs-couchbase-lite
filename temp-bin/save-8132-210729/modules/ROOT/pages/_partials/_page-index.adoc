...
:release-notes--xref-list: xref:couchbase-lite:swift:swift-releasenotes.adoc[Swift]  |  xref:couchbase-lite:objc:objc-releasenotes.adoc[Objective-C]  |  xref:couchbase-lite:java:java-releasenotes.adoc[Java]  |  xref:couchbase-lite:android:java-android-releasenotes.adoc[Android (Java)]  |  xref:couchbase-lite:csharp:csharp-releasenotes.adoc[C#.Net]
...
:compatibility--xref-all: {xref-pfx-root}{cbl-pg-compatibility-all}[Compatibility]
...
:databases--xref: {xref-cbl-pfx-database}[Databases]
...
:xref-cbl-pg-dbreplica: {cbl--xref}{dbreplica--page}[Intra-device Data Sync]
...
:refer-glossary--xref: {xref-pfx-root}{cbl-pg-glossary}[Glossary]
...
:release-notes--xref-all: {xref-pfx-root}{cbl-pg-releasenotes-all}[Release Notes]
...
// :compatibility--xref: {xref-pfx-root}{cbl-pg-compatibility}[Compatibility]
//:databases--xref: {cbl--xref}{cbl-pg-database}[Database]
